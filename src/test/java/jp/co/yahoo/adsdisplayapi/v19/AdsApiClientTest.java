...
class AdsApiClientTest {
  ...
  void constructor() {
    ...
    AdsApiClient target = new AdsApiClient(oAuth2TokenService);

    assertEquals(Try.success("Java/jp.co.yahoo.api-ads:ads-display-api-lib:14.0.0-spring6"),
        tryToReadFieldValue(AdsApiClient.class, "USER_AGENT", target)
    );
    assertEquals(Try.success(oAuth2TokenService),
        tryToReadFieldValue(AdsApiClient.class, "oAuth2TokenService", target)
    );
  }
  ...
  void constructorWithRestTemplate() {
    ...
    AdsApiClient target = new AdsApiClient(oAuth2TokenService, restTemplate);
  ...
  void updateParamsForAuth() {
    ...
    AdsApiClient target = new AdsApiClient(this.mockOAuth2TokenService);
