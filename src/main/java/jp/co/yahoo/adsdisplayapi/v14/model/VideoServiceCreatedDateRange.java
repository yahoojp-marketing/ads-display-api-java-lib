 ...
 */
@ApiModel(description = "<div lang=\"ja\"> VideoServiceCreatedDateRangeは、作成日による検索対象期間を表します。 </div> <div lang=\"en\"> VideoServiceCreatedDateRange represents the search target period by the creation date. </div> ")
@JsonPropertyOrder({
