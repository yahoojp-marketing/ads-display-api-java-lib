 ...
 */
@ApiModel(description = "<div lang=\"ja\">AdGroupAdServiceMediaAssetオブジェクトは、レスポンシブディスプレイ広告で指定するメディアアセットを表します。</div> <div lang=\"en\">The AdGroupAdServiceMediaAsset object represents a media asset to specify in Responsive Ads for Display.</div> ")
@JsonPropertyOrder({
