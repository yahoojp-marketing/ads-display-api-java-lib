...
public class EstimatedUserSizeServiceApi {
    ...
    public ResponseEntity<EstimatedUserSizeServiceGetResponse> estimatedUserSizeServiceGetPostWithHttpInfo(EstimatedUserSizeServiceSelector estimatedUserSizeServiceSelector) throws RestClientException {
        Object postBody = estimatedUserSizeServiceSelector;
        ...
        ParameterizedTypeReference<EstimatedUserSizeServiceGetResponse> returnType = new ParameterizedTypeReference<EstimatedUserSizeServiceGetResponse>() {};
        return apiClient.invokeAPI("/EstimatedUserSizeService/get", HttpMethod.POST, Collections.<String, Object>emptyMap(), queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, authNames, returnType);
    }
}
