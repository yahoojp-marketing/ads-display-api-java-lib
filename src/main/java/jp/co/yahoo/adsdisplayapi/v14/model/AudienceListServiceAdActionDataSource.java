...
public class AudienceListServiceAdActionDataSource {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<div lang=\"ja\">広告アクションデータソースのIdです。キャンペーンの場合は1つまで指定できます。</div> <div lang=\"en\">Id of ad action data source. For campaign, the max number of Ids is 1.</div> ")
