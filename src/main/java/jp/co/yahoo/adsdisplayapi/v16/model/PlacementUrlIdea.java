...
public class PlacementUrlIdea {
  ...
  **/
  ...
  public PlacementUrlIdea addSiteCategoryItem(String siteCategoryItem) {
   ...
   /**
   * &lt;div lang&#x3D;\&quot;ja\&quot;&gt;検索カテゴリです。※ 提供を終了しました。&lt;/div&gt; &lt;div lang&#x3D;\&quot;en\&quot;&gt;Search category * Discontinued.&lt;/div&gt; 
   * @return siteCategory
  **/
  @jakarta.annotation.Nullable
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(keyword, siteCategory, searchUrl, adPlaceName, desktopReaches, desktopAdRequests, smartPhoneReaches, smartPhoneAdRequests, tabletReaches, tabletAdRequests);
  }
