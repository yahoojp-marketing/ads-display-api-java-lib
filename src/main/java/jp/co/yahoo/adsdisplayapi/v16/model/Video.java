...
import jp.co.yahoo.adsdisplayapi.v16.model.VideoServiceApprovalStatus;
import jp.co.yahoo.adsdisplayapi.v16.model.VideoServiceProcessStatus;
import jp.co.yahoo.adsdisplayapi.v16.model.VideoServiceSetting;
...
public class Video {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<div lang=\"ja\"> 動画の審査を申し込んだ日です。<br> このフィールドは、レスポンスの際に返却されますが、リクエストの際には無視されます。<br> ※フォーマット: yyyyMMddHHmmss </div> <div lang=\"en\"> The date when you submitted the video for the review appears.<br> Although this field will be returned in the response, it will be ignored on request.<br> *Format: yyyyMMddHHmmss </div> ")
