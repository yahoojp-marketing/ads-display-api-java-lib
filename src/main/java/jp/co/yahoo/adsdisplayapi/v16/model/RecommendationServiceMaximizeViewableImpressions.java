...
import jp.co.yahoo.adsdisplayapi.v16.model.RecommendationServiceMaximizeViewableImpressionsCampaign;
 ...
 */
@ApiModel(description = "<div lang=\"ja\">RecommendationServiceMaximizeViewableImpressionsオブジェクトは、自動入札（ビューアブルインプレッション数の最大化）に適しているキャンペーンに関する最適化提案の情報を表します。</div> <div lang=\"en\">RecommendationServiceMaximizeViewableImpressions object describes recommendation information about the campaign that is suitable for using autobidding (Maximize Vimps).</div> ")
@JsonPropertyOrder({
  RecommendationServiceMaximizeViewableImpressions.JSON_PROPERTY_MAXIMIZE_VIEWABLE_IMPRESSIONS_CAMPAIGN_LIST
})
@JsonTypeName("RecommendationServiceMaximizeViewableImpressions")
...
public class RecommendationServiceMaximizeViewableImpressions {
  ...
  private List<RecommendationServiceMaximizeViewableImpressionsCampaign> maximizeViewableImpressionsCampaignList = null;
