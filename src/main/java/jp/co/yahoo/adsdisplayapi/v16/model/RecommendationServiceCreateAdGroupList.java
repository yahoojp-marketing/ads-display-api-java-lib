 ...
 */
@ApiModel(description = "<div lang=\"ja\">RecommendationServiceCreateAdGroupListオブジェクトは、広告グループの作成に関する最適化提案の詳細情報を表します。</div> <div lang=\"en\">RecommendationServiceCreateAdGroupList object describes detailed information about a recommendation for creating ad groups.</div> ")
@JsonPropertyOrder({
...
@JsonTypeName("RecommendationServiceCreateAdGroupList")
...
public class RecommendationServiceCreateAdGroupList {
  ...
  public RecommendationServiceCreateAdGroupList recommendationId(Long recommendationId) {
  ...
  **/
  ...
  public RecommendationServiceCreateAdGroupList campaignId(Long campaignId) {
  ...
  **/
  ...
  public RecommendationServiceCreateAdGroupList campaignName(String campaignName) {
