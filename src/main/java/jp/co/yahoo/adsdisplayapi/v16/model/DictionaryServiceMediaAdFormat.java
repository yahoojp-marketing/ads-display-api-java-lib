...
public class DictionaryServiceMediaAdFormat {
  ...
  **/
  ...
  @ApiModelProperty(value = "<div lang=\"ja\"> ディスプレイ（画像）広告のフォーマットです。<br> 運用型・予約型で利用できる画像サイズについては、<a href=\"https://ads-help.yahoo-net.jp/s/article/H000044487?language=ja\" target=\"_blank\"/>画像を追加する</a>をご参照ください。 </div> <div lang=\"en\"> Format of display (image) ads.<br> For information on available image sizes for Auction and Guaranteed, please refer to <a href=\"https://ads-help.yahoo-net.jp/s/article/H000044487?language=en_US\" target=\"_blank\">here</a>. </div> ")
