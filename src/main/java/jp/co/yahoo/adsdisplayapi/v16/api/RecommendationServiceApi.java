...
import jp.co.yahoo.adsdisplayapi.v16.model.RecommendationServiceGetResponse;
import jp.co.yahoo.adsdisplayapi.v16.model.RecommendationServiceSelector;
...
@Component("jp.co.yahoo.adsdisplayapi.v16.api.RecommendationServiceApi")
public class RecommendationServiceApi {
    ...
    public ResponseEntity<RecommendationServiceGetResponse> recommendationServiceGetPostWithHttpInfo(Long xZBaseAccountId, RecommendationServiceSelector recommendationServiceSelector) throws RestClientException {
        Object postBody = recommendationServiceSelector;
        ...
        ParameterizedTypeReference<RecommendationServiceGetResponse> returnType = new ParameterizedTypeReference<RecommendationServiceGetResponse>() {};
        return apiClient.invokeAPI("/RecommendationService/get", HttpMethod.POST, Collections.<String, Object>emptyMap(), queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, authNames, returnType);
    }
}
