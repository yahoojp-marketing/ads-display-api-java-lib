...
import jp.co.yahoo.adsdisplayapi.v16.model.AdGroupAdServiceAd;
...
import jp.co.yahoo.adsdisplayapi.v16.model.AdGroupAdServiceLabel;
import jp.co.yahoo.adsdisplayapi.v16.model.AdGroupAdServiceUserStatus;
...
public class AdGroupAd {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<div lang=\"ja\"> メディアIDです。<br> ADDおよびSET時、このフィールドは省略可能となります。<br> ※レスポンシブディスプレイ広告を利用する場合は指定できません。 </div> <div lang=\"en\"> Media ID.<br> This field is optional in ADD and SET operation.<br> *Cannot be specified when using Responsive Ads for Display. </div> ")
