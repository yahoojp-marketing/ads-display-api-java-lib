 ...
 */
@ApiModel(description = "<div lang=\"ja\">RecommendationServiceInsufficientClicksCampaignオブジェクトは、クリック数が少ないキャンペーンに関する最適化提案の詳細情報を表します。</div> <div lang=\"en\">RecommendationServiceInsufficientClicksCampaign object describes detailed information of recommendations about the campaign that need to increase clicks.</div> ")
@JsonPropertyOrder({
...
@JsonTypeName("RecommendationServiceInsufficientClicksCampaign")
