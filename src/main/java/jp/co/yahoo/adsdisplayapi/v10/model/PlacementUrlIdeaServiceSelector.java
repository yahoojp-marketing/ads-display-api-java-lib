...
import jp.co.yahoo.adsdisplayapi.v10.model.PlacementUrlIdeaServiceAdFormatConditions;
...
@JsonPropertyOrder({
  ...
  PlacementUrlIdeaServiceSelector.JSON_PROPERTY_AD_FORMATS,
...
public class PlacementUrlIdeaServiceSelector {
  ...
  public static final String JSON_PROPERTY_AD_FORMATS = "adFormats";
  private List<PlacementUrlIdeaServiceAdFormatConditions> adFormats;
  ...
  **/
  @jakarta.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_AD_FORMATS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
