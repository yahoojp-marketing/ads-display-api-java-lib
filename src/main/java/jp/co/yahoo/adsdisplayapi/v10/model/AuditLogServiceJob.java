...
import jp.co.yahoo.adsdisplayapi.v10.model.AuditLogServiceJobStatus;
import jp.co.yahoo.adsdisplayapi.v10.model.AuditLogServiceLang;
import jp.co.yahoo.adsdisplayapi.v10.model.AuditLogServiceSourceType;
...
public class AuditLogServiceJob {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, auditLogJobEndDate, auditLogJobId, auditLogJobName, auditLogJobStartDate, auditLogJobUserName, campaignIds, dateRange, jobStatus, lang, progress, sourceType);
  }
