...
package jp.co.yahoo.adsdisplayapi.v19.oauth2;
...
public class OAuth2TokenService {
  ...
  private static final String PROP_MAX_RETRIES      = "jp.co.yahoo.adsdisplayapi.oauth2.retry.max_retries";
  ...
  private RetryTemplate retryTemplate = new RetryTemplate(
      RetryPolicy.builder()
          .maxRetries(Long.parseLong(System.getProperty(PROP_MAX_RETRIES, DEFAULT_MAX_RETRIES)))
          .delay(Duration.ofMillis(Long.parseLong(System.getProperty(PROP_INITIAL_INTERVAL, DEFAULT_INITIAL_INTERVAL))))
          .multiplier(Double.parseDouble(System.getProperty(PROP_MULTIPLIER, DEFAULT_MULTIPLIER)))
          .maxDelay(Duration.ofMillis(Long.parseLong(System.getProperty(PROP_MAX_INTERVAL, DEFAULT_MAX_INTERVAL))))
          .build()
  );
  ...
  public OAuth2TokenService(String clientId, String clientSecret, String refreshToken) {
    ...
    String maxAttempts = System.getProperty(PROP_MAX_ATTEMPTS);
    if (maxAttempts != null && !maxAttempts.isEmpty()) {
      log.warn("Deprecated property 'jp.co.yahoo.adsdisplayapi.oauth2.retry.max_attempts' is configured. Use 'jp.co.yahoo.adsdisplayapi.oauth2.retry.max_retries' instead.");
    }
  }
  ...
  private OAuth2AccessTokenResponse getAccessTokenFromAPI() {
    String url = UriComponentsBuilder.fromUriString(this.oAuthTokenUrl)
      ...
      .toUriString();
    return retryTemplate.invoke(() -> restTemplate.getForObject(url, OAuth2AccessTokenResponse.class));
  }
