...
import jp.co.yahoo.adsdisplayapi.v8.model.GuaranteedSimulationServiceReturnValue;
 ...
 */
@JsonPropertyOrder({
  GuaranteedSimulationServiceMutateResponse.JSON_PROPERTY_ERRORS,
  GuaranteedSimulationServiceMutateResponse.JSON_PROPERTY_RID,
  GuaranteedSimulationServiceMutateResponse.JSON_PROPERTY_RVAL
})
@JsonTypeName("GuaranteedSimulationServiceMutateResponse")
...
public class GuaranteedSimulationServiceMutateResponse {
  ...
  private GuaranteedSimulationServiceReturnValue rval;

  public GuaranteedSimulationServiceMutateResponse() { 
  }
