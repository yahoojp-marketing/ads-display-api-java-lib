...
import jp.co.yahoo.adsdisplayapi.v8.model.GuaranteedInventoryServiceDeviceOsType;
...
@JsonPropertyOrder({
  GuaranteedInventoryServiceOsTarget.JSON_PROPERTY_DEVICE_OS_TYPE
})
@JsonTypeName("GuaranteedInventoryServiceOsTarget")
...
public class GuaranteedInventoryServiceOsTarget {
  ...
  private GuaranteedInventoryServiceDeviceOsType deviceOsType;

  public GuaranteedInventoryServiceOsTarget() { 
  }
