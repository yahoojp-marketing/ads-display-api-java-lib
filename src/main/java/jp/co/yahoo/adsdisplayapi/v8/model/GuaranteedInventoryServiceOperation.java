...
@JsonPropertyOrder({
  GuaranteedInventoryServiceOperation.JSON_PROPERTY_ACCOUNT_ID,
  GuaranteedInventoryServiceOperation.JSON_PROPERTY_OPERAND
})
@JsonTypeName("GuaranteedInventoryServiceOperation")
...
public class GuaranteedInventoryServiceOperation {
  ...
  public GuaranteedInventoryServiceOperation() { 
  }
