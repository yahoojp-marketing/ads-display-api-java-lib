...
import jp.co.yahoo.adsdisplayapi.v8.model.GuaranteedSimulationServicePermittedGenderTarget;
...
@JsonPropertyOrder({
  GuaranteedSimulationServicePackagePermittedGenderTarget.JSON_PROPERTY_TARGET_PERMISSION,
  GuaranteedSimulationServicePackagePermittedGenderTarget.JSON_PROPERTY_PERMITTED_TARGETS
})
@JsonTypeName("GuaranteedSimulationServicePackagePermittedGenderTarget")
...
public class GuaranteedSimulationServicePackagePermittedGenderTarget {
  ...
  public GuaranteedSimulationServicePackagePermittedGenderTarget() { 
  }
