...
@JsonPropertyOrder({
  GuaranteedAdGroupAdServiceOperation.JSON_PROPERTY_ACCOUNT_ID,
  GuaranteedAdGroupAdServiceOperation.JSON_PROPERTY_OPERAND
})
@JsonTypeName("GuaranteedAdGroupAdServiceOperation")
...
public class GuaranteedAdGroupAdServiceOperation {
  ...
  public GuaranteedAdGroupAdServiceOperation() { 
  }
