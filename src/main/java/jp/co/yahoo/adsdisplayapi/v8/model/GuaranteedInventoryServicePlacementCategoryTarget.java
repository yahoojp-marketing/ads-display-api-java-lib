...
@JsonPropertyOrder({
  GuaranteedInventoryServicePlacementCategoryTarget.JSON_PROPERTY_PLACEMENT_CATEGORY_LIST_NAME
})
@JsonTypeName("GuaranteedInventoryServicePlacementCategoryTarget")
...
public class GuaranteedInventoryServicePlacementCategoryTarget {
  ...
  public GuaranteedInventoryServicePlacementCategoryTarget() { 
  }
