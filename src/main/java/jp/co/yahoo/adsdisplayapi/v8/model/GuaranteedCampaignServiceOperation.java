...
@JsonPropertyOrder({
  GuaranteedCampaignServiceOperation.JSON_PROPERTY_ACCOUNT_ID,
  GuaranteedCampaignServiceOperation.JSON_PROPERTY_OPERAND
})
@JsonTypeName("GuaranteedCampaignServiceOperation")
...
public class GuaranteedCampaignServiceOperation {
  ...
  public GuaranteedCampaignServiceOperation() { 
  }
