...
import jp.co.yahoo.adsdisplayapi.v8.model.GuaranteedPreviewServiceAdType;
import jp.co.yahoo.adsdisplayapi.v8.model.GuaranteedPreviewServicePanelSwitch;
...
@JsonPropertyOrder({
  ...
  GuaranteedPreviewServiceMaterialMedia.JSON_PROPERTY_VIDEO_SCREENSHOT,
...
public class GuaranteedPreviewServiceMaterialMedia {
  ...
  **/
  ...
  public GuaranteedPreviewServiceMaterialMedia videoScreenshot(List<String> videoScreenshot) {
    
    this.videoScreenshot = videoScreenshot;
    return this;
  }

  public GuaranteedPreviewServiceMaterialMedia addVideoScreenshotItem(String videoScreenshotItem) {
   ...
   /**
   * &lt;div lang&#x3D;\&quot;ja\&quot;&gt; トップページの左右に表示する動画キャプチャーの再生位置です。&lt;br&gt; ※フォーマット：mm:ss.SSS&lt;br&gt; このフィールドは、リクエストの場合は省略可能となります。 &lt;/div&gt; &lt;div lang&#x3D;\&quot;en\&quot;&gt; Video start position for video screenshot that appears on both sides of homepage.&lt;br&gt; ∗ Format: mm:ss.SSS&lt;br&gt; This field is optional in requests. &lt;/div&gt; 
   * @return videoScreenshot
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<div lang=\"ja\"> トップページの左右に表示する動画キャプチャーの再生位置です。<br> ※フォーマット：mm:ss.SSS<br> このフィールドは、リクエストの場合は省略可能となります。 </div> <div lang=\"en\"> Video start position for video screenshot that appears on both sides of homepage.<br> ∗ Format: mm:ss.SSS<br> This field is optional in requests. </div> ")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.adType, guaranteedPreviewServiceMaterialMedia.adType) &&
        ...
        Objects.equals(this.videoScreenshot, guaranteedPreviewServiceMaterialMedia.videoScreenshot) &&
        Objects.equals(this.panels, guaranteedPreviewServiceMaterialMedia.panels);
  }

  @Override
  public int hashCode() {
    return Objects.hash(adType, mediaId, thumbnailMediaId, adLeftSideMediaId, adRightSideMediaId, adCenterMediaId, adShrinkMainMediaId, videoScreenshot, panels);
  }
