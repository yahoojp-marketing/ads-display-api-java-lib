...
@JsonPropertyOrder({
  GuaranteedAdGroupAdServiceTopImpactTheaterVideo.JSON_PROPERTY_DISPLAY_URL,
  GuaranteedAdGroupAdServiceTopImpactTheaterVideo.JSON_PROPERTY_THUMBNAIL_MEDIA_ID,
  GuaranteedAdGroupAdServiceTopImpactTheaterVideo.JSON_PROPERTY_CUSTOM_PARAMETERS,
  GuaranteedAdGroupAdServiceTopImpactTheaterVideo.JSON_PROPERTY_DISPLAY_URL_LEVEL,
  GuaranteedAdGroupAdServiceTopImpactTheaterVideo.JSON_PROPERTY_FINAL_URL,
  GuaranteedAdGroupAdServiceTopImpactTheaterVideo.JSON_PROPERTY_IS_REMOVE_TRACKING_URL,
  GuaranteedAdGroupAdServiceTopImpactTheaterVideo.JSON_PROPERTY_TRACKING_URL,
  GuaranteedAdGroupAdServiceTopImpactTheaterVideo.JSON_PROPERTY_IS_REMOVE_VIDEO10_SEC_BEACON_URLS,
  GuaranteedAdGroupAdServiceTopImpactTheaterVideo.JSON_PROPERTY_IS_REMOVE_VIDEO25_PERCENT_BEACON_URLS,
  GuaranteedAdGroupAdServiceTopImpactTheaterVideo.JSON_PROPERTY_IS_REMOVE_VIDEO3_SEC_BEACON_URLS,
  GuaranteedAdGroupAdServiceTopImpactTheaterVideo.JSON_PROPERTY_IS_REMOVE_VIDEO50_PERCENT_BEACON_URLS,
  GuaranteedAdGroupAdServiceTopImpactTheaterVideo.JSON_PROPERTY_IS_REMOVE_VIDEO75_PERCENT_BEACON_URLS,
  GuaranteedAdGroupAdServiceTopImpactTheaterVideo.JSON_PROPERTY_IS_REMOVE_VIDEO_COMPLETE_BEACON_URLS,
  GuaranteedAdGroupAdServiceTopImpactTheaterVideo.JSON_PROPERTY_IS_REMOVE_VIDEO_START_BEACON_URLS,
  GuaranteedAdGroupAdServiceTopImpactTheaterVideo.JSON_PROPERTY_VIDEO3_SEC_BEACON_URLS,
  GuaranteedAdGroupAdServiceTopImpactTheaterVideo.JSON_PROPERTY_VIDEO25_PERCENT_BEACON_URLS,
  GuaranteedAdGroupAdServiceTopImpactTheaterVideo.JSON_PROPERTY_VIDEO50_PERCENT_BEACON_URLS,
  GuaranteedAdGroupAdServiceTopImpactTheaterVideo.JSON_PROPERTY_VIDEO75_PERCENT_BEACON_URLS,
  GuaranteedAdGroupAdServiceTopImpactTheaterVideo.JSON_PROPERTY_VIDEO10_SEC_BEACON_URLS,
  GuaranteedAdGroupAdServiceTopImpactTheaterVideo.JSON_PROPERTY_VIDEO_COMPLETE_BEACON_URLS,
  GuaranteedAdGroupAdServiceTopImpactTheaterVideo.JSON_PROPERTY_VIDEO_START_BEACON_URLS,
  GuaranteedAdGroupAdServiceTopImpactTheaterVideo.JSON_PROPERTY_AD_LEFT_SIDE_MEDIA_ID,
  GuaranteedAdGroupAdServiceTopImpactTheaterVideo.JSON_PROPERTY_AD_RIGHT_SIDE_MEDIA_ID,
  GuaranteedAdGroupAdServiceTopImpactTheaterVideo.JSON_PROPERTY_AD_CENTER_MEDIA_ID,
  GuaranteedAdGroupAdServiceTopImpactTheaterVideo.JSON_PROPERTY_VIDEO_SCREENSHOT
})
@JsonTypeName("GuaranteedAdGroupAdServiceTopImpactTheaterVideo")
...
public class GuaranteedAdGroupAdServiceTopImpactTheaterVideo {
  ...
  public static final String JSON_PROPERTY_VIDEO_SCREENSHOT = "videoScreenshot";
  private List<String> videoScreenshot = null;

  public GuaranteedAdGroupAdServiceTopImpactTheaterVideo() { 
  }
  ...
  **/
  ...
  public GuaranteedAdGroupAdServiceTopImpactTheaterVideo videoScreenshot(List<String> videoScreenshot) {
    
    this.videoScreenshot = videoScreenshot;
    return this;
  }

  public GuaranteedAdGroupAdServiceTopImpactTheaterVideo addVideoScreenshotItem(String videoScreenshotItem) {
    if (this.videoScreenshot == null) {
      this.videoScreenshot = new ArrayList<>();
    }
    this.videoScreenshot.add(videoScreenshotItem);
    return this;
  }

   /**
   * &lt;div lang&#x3D;\&quot;ja\&quot;&gt; トップページの左右に表示する動画キャプチャーの再生位置です。&lt;br&gt; ※フォーマット：mm:ss.SSS&lt;br&gt; このフィールドは、ADD時は必須となり、SET時は省略可能となります。 &lt;/div&gt; &lt;div lang&#x3D;\&quot;en\&quot;&gt; Video start position for video screenshot that appears on both sides of homepage.&lt;br&gt; ∗ Format: mm:ss.SSS&lt;br&gt; This field is required in ADD operation, and will be optional in SET operation. &lt;/div&gt; 
   * @return videoScreenshot
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<div lang=\"ja\"> トップページの左右に表示する動画キャプチャーの再生位置です。<br> ※フォーマット：mm:ss.SSS<br> このフィールドは、ADD時は必須となり、SET時は省略可能となります。 </div> <div lang=\"en\"> Video start position for video screenshot that appears on both sides of homepage.<br> ∗ Format: mm:ss.SSS<br> This field is required in ADD operation, and will be optional in SET operation. </div> ")
  @JsonProperty(JSON_PROPERTY_VIDEO_SCREENSHOT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public List<String> getVideoScreenshot() {
    return videoScreenshot;
  }
  ...
  @JsonProperty(JSON_PROPERTY_VIDEO_SCREENSHOT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setVideoScreenshot(List<String> videoScreenshot) {
    this.videoScreenshot = videoScreenshot;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.displayUrl, guaranteedAdGroupAdServiceTopImpactTheaterVideo.displayUrl) &&
        ...
        Objects.equals(this.videoScreenshot, guaranteedAdGroupAdServiceTopImpactTheaterVideo.videoScreenshot);
  }
  ...
  public String toString() {
    ...
    sb.append("    videoScreenshot: ").append(toIndentedString(videoScreenshot)).append("\n");
    sb.append("}");
    return sb.toString();
  }
