...
@JsonPropertyOrder({
  GuaranteedInventoryServiceDeviceTarget.JSON_PROPERTY_DEVICE_TYPE
})
@JsonTypeName("GuaranteedInventoryServiceDeviceTarget")
...
public class GuaranteedInventoryServiceDeviceTarget {
  ...
  private GuaranteedInventoryServiceDeviceType deviceType;

  public GuaranteedInventoryServiceDeviceTarget() { 
  }
