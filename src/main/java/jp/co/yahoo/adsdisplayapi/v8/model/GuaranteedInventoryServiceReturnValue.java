...
@JsonPropertyOrder({
  GuaranteedInventoryServiceReturnValue.JSON_PROPERTY_VALUES
})
@JsonTypeName("GuaranteedInventoryServiceReturnValue")
...
public class GuaranteedInventoryServiceReturnValue {
  ...
  public GuaranteedInventoryServiceReturnValue() { 
  }
