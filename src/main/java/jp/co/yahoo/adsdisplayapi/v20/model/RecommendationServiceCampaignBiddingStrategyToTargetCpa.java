...
import jp.co.yahoo.adsdisplayapi.v20.model.RecommendationServiceCampaignBiddingStrategyToTargetCpaCampaign;
...
public class RecommendationServiceCampaignBiddingStrategyToTargetCpa {
  ...
  public RecommendationServiceCampaignBiddingStrategyToTargetCpa campaignBiddingStrategyToTargetCpaCampaignList(@jakarta.annotation.Nullable List<RecommendationServiceCampaignBiddingStrategyToTargetCpaCampaign> campaignBiddingStrategyToTargetCpaCampaignList) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_CAMPAIGN_BIDDING_STRATEGY_TO_TARGET_CPA_CAMPAIGN_LIST, required = false)
  ...
  @JsonProperty(value = JSON_PROPERTY_CAMPAIGN_BIDDING_STRATEGY_TO_TARGET_CPA_CAMPAIGN_LIST, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCampaignBiddingStrategyToTargetCpaCampaignList(@jakarta.annotation.Nullable List<RecommendationServiceCampaignBiddingStrategyToTargetCpaCampaign> campaignBiddingStrategyToTargetCpaCampaignList) {
    this.campaignBiddingStrategyToTargetCpaCampaignList = campaignBiddingStrategyToTargetCpaCampaignList;
  }
