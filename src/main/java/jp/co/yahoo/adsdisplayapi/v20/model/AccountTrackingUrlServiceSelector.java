...
public class AccountTrackingUrlServiceSelector {
  ...
  public AccountTrackingUrlServiceSelector accountId(@jakarta.annotation.Nonnull Long accountId) {
  ...
  public AccountTrackingUrlServiceSelector numberResults(@jakarta.annotation.Nullable Integer numberResults) {
  ...
  public AccountTrackingUrlServiceSelector startIndex(@jakarta.annotation.Nullable Integer startIndex) {
