 ...
 */
@JsonPropertyOrder({
  GuaranteedAdGroupAdServiceBrandPanelTopCover.JSON_PROPERTY_FIXED_POSITION_BANNER_MEDIA_ID,
  GuaranteedAdGroupAdServiceBrandPanelTopCover.JSON_PROPERTY_DISPLAY_URL,
  GuaranteedAdGroupAdServiceBrandPanelTopCover.JSON_PROPERTY_THUMBNAIL_MEDIA_ID,
  GuaranteedAdGroupAdServiceBrandPanelTopCover.JSON_PROPERTY_CUSTOM_PARAMETERS,
  GuaranteedAdGroupAdServiceBrandPanelTopCover.JSON_PROPERTY_DISPLAY_URL_LEVEL,
  GuaranteedAdGroupAdServiceBrandPanelTopCover.JSON_PROPERTY_FINAL_URL,
  GuaranteedAdGroupAdServiceBrandPanelTopCover.JSON_PROPERTY_TRACKING_URL,
  GuaranteedAdGroupAdServiceBrandPanelTopCover.JSON_PROPERTY_VIDEO3_SEC_BEACON_URLS,
  GuaranteedAdGroupAdServiceBrandPanelTopCover.JSON_PROPERTY_VIDEO25_PERCENT_BEACON_URLS,
  GuaranteedAdGroupAdServiceBrandPanelTopCover.JSON_PROPERTY_VIDEO50_PERCENT_BEACON_URLS,
  GuaranteedAdGroupAdServiceBrandPanelTopCover.JSON_PROPERTY_VIDEO75_PERCENT_BEACON_URLS,
  GuaranteedAdGroupAdServiceBrandPanelTopCover.JSON_PROPERTY_VIDEO10_SEC_BEACON_URLS,
  GuaranteedAdGroupAdServiceBrandPanelTopCover.JSON_PROPERTY_VIDEO_COMPLETE_BEACON_URLS,
  GuaranteedAdGroupAdServiceBrandPanelTopCover.JSON_PROPERTY_VIDEO_START_BEACON_URLS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.22.0")
public class GuaranteedAdGroupAdServiceBrandPanelTopCover {
  public static final String JSON_PROPERTY_FIXED_POSITION_BANNER_MEDIA_ID = "fixedPositionBannerMediaId";
  @jakarta.annotation.Nullable
  private Long fixedPositionBannerMediaId;
  ...
  public GuaranteedAdGroupAdServiceBrandPanelTopCover() {
  }

  public GuaranteedAdGroupAdServiceBrandPanelTopCover fixedPositionBannerMediaId(@jakarta.annotation.Nullable Long fixedPositionBannerMediaId) {
    
    this.fixedPositionBannerMediaId = fixedPositionBannerMediaId;
    return this;
  }

  /**
   * &lt;div lang&#x3D;\&quot;ja\&quot;&gt; 追従バナー画像IDです。&lt;br&gt; このフィールドは、レスポンスの際に返却されますが、リクエストの際には無視されます。 &lt;/div&gt; &lt;div lang&#x3D;\&quot;en\&quot;&gt; Fixed-position banner image ID.&lt;br&gt; This field will be returned in the response, it will be ignored on input. &lt;/div&gt; 
   * @return fixedPositionBannerMediaId
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_FIXED_POSITION_BANNER_MEDIA_ID, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Long getFixedPositionBannerMediaId() {
    return fixedPositionBannerMediaId;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_FIXED_POSITION_BANNER_MEDIA_ID, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFixedPositionBannerMediaId(@jakarta.annotation.Nullable Long fixedPositionBannerMediaId) {
    this.fixedPositionBannerMediaId = fixedPositionBannerMediaId;
  }

  public GuaranteedAdGroupAdServiceBrandPanelTopCover displayUrl(@jakarta.annotation.Nullable String displayUrl) {
  ...
  public GuaranteedAdGroupAdServiceBrandPanelTopCover thumbnailMediaId(@jakarta.annotation.Nullable Long thumbnailMediaId) {
  ...
  public GuaranteedAdGroupAdServiceBrandPanelTopCover customParameters(@jakarta.annotation.Nullable GuaranteedAdGroupAdServiceCustomParameters customParameters) {
  ...
  public GuaranteedAdGroupAdServiceBrandPanelTopCover displayUrlLevel(@jakarta.annotation.Nullable GuaranteedAdGroupAdServiceDisplayUrlLevel displayUrlLevel) {
  ...
  public GuaranteedAdGroupAdServiceBrandPanelTopCover finalUrl(@jakarta.annotation.Nullable String finalUrl) {
  ...
  public GuaranteedAdGroupAdServiceBrandPanelTopCover trackingUrl(@jakarta.annotation.Nullable String trackingUrl) {
  ...
  public GuaranteedAdGroupAdServiceBrandPanelTopCover video3SecBeaconUrls(@jakarta.annotation.Nullable List<String> video3SecBeaconUrls) {
    
    this.video3SecBeaconUrls = video3SecBeaconUrls;
    return this;
  }

  public GuaranteedAdGroupAdServiceBrandPanelTopCover addVideo3SecBeaconUrlsItem(String video3SecBeaconUrlsItem) {
  ...
  public GuaranteedAdGroupAdServiceBrandPanelTopCover video25PercentBeaconUrls(@jakarta.annotation.Nullable List<String> video25PercentBeaconUrls) {
    
    this.video25PercentBeaconUrls = video25PercentBeaconUrls;
    return this;
  }

  public GuaranteedAdGroupAdServiceBrandPanelTopCover addVideo25PercentBeaconUrlsItem(String video25PercentBeaconUrlsItem) {
  ...
  public GuaranteedAdGroupAdServiceBrandPanelTopCover video50PercentBeaconUrls(@jakarta.annotation.Nullable List<String> video50PercentBeaconUrls) {
    
    this.video50PercentBeaconUrls = video50PercentBeaconUrls;
    return this;
  }

  public GuaranteedAdGroupAdServiceBrandPanelTopCover addVideo50PercentBeaconUrlsItem(String video50PercentBeaconUrlsItem) {
  ...
  public GuaranteedAdGroupAdServiceBrandPanelTopCover video75PercentBeaconUrls(@jakarta.annotation.Nullable List<String> video75PercentBeaconUrls) {
    
    this.video75PercentBeaconUrls = video75PercentBeaconUrls;
    return this;
  }

  public GuaranteedAdGroupAdServiceBrandPanelTopCover addVideo75PercentBeaconUrlsItem(String video75PercentBeaconUrlsItem) {
  ...
  public GuaranteedAdGroupAdServiceBrandPanelTopCover video10SecBeaconUrls(@jakarta.annotation.Nullable List<String> video10SecBeaconUrls) {
    
    this.video10SecBeaconUrls = video10SecBeaconUrls;
    return this;
  }

  public GuaranteedAdGroupAdServiceBrandPanelTopCover addVideo10SecBeaconUrlsItem(String video10SecBeaconUrlsItem) {
  ...
  public GuaranteedAdGroupAdServiceBrandPanelTopCover videoCompleteBeaconUrls(@jakarta.annotation.Nullable List<String> videoCompleteBeaconUrls) {
    
    this.videoCompleteBeaconUrls = videoCompleteBeaconUrls;
    return this;
  }

  public GuaranteedAdGroupAdServiceBrandPanelTopCover addVideoCompleteBeaconUrlsItem(String videoCompleteBeaconUrlsItem) {
  ...
  public GuaranteedAdGroupAdServiceBrandPanelTopCover videoStartBeaconUrls(@jakarta.annotation.Nullable List<String> videoStartBeaconUrls) {
    
    this.videoStartBeaconUrls = videoStartBeaconUrls;
    return this;
  }

  public GuaranteedAdGroupAdServiceBrandPanelTopCover addVideoStartBeaconUrlsItem(String videoStartBeaconUrlsItem) {
  ...
  public boolean equals(Object o) {
    ...
    GuaranteedAdGroupAdServiceBrandPanelTopCover guaranteedAdGroupAdServiceBrandPanelTopCover = (GuaranteedAdGroupAdServiceBrandPanelTopCover) o;
    return Objects.equals(this.fixedPositionBannerMediaId, guaranteedAdGroupAdServiceBrandPanelTopCover.fixedPositionBannerMediaId) &&
        Objects.equals(this.displayUrl, guaranteedAdGroupAdServiceBrandPanelTopCover.displayUrl) &&
        Objects.equals(this.thumbnailMediaId, guaranteedAdGroupAdServiceBrandPanelTopCover.thumbnailMediaId) &&
        Objects.equals(this.customParameters, guaranteedAdGroupAdServiceBrandPanelTopCover.customParameters) &&
        Objects.equals(this.displayUrlLevel, guaranteedAdGroupAdServiceBrandPanelTopCover.displayUrlLevel) &&
        Objects.equals(this.finalUrl, guaranteedAdGroupAdServiceBrandPanelTopCover.finalUrl) &&
        Objects.equals(this.trackingUrl, guaranteedAdGroupAdServiceBrandPanelTopCover.trackingUrl) &&
        Objects.equals(this.video3SecBeaconUrls, guaranteedAdGroupAdServiceBrandPanelTopCover.video3SecBeaconUrls) &&
        Objects.equals(this.video25PercentBeaconUrls, guaranteedAdGroupAdServiceBrandPanelTopCover.video25PercentBeaconUrls) &&
        Objects.equals(this.video50PercentBeaconUrls, guaranteedAdGroupAdServiceBrandPanelTopCover.video50PercentBeaconUrls) &&
        Objects.equals(this.video75PercentBeaconUrls, guaranteedAdGroupAdServiceBrandPanelTopCover.video75PercentBeaconUrls) &&
        Objects.equals(this.video10SecBeaconUrls, guaranteedAdGroupAdServiceBrandPanelTopCover.video10SecBeaconUrls) &&
        Objects.equals(this.videoCompleteBeaconUrls, guaranteedAdGroupAdServiceBrandPanelTopCover.videoCompleteBeaconUrls) &&
        Objects.equals(this.videoStartBeaconUrls, guaranteedAdGroupAdServiceBrandPanelTopCover.videoStartBeaconUrls);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fixedPositionBannerMediaId, displayUrl, thumbnailMediaId, customParameters, displayUrlLevel, finalUrl, trackingUrl, video3SecBeaconUrls, video25PercentBeaconUrls, video50PercentBeaconUrls, video75PercentBeaconUrls, video10SecBeaconUrls, videoCompleteBeaconUrls, videoStartBeaconUrls);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GuaranteedAdGroupAdServiceBrandPanelTopCover {\n");
    sb.append("    fixedPositionBannerMediaId: ").append(toIndentedString(fixedPositionBannerMediaId)).append("\n");
