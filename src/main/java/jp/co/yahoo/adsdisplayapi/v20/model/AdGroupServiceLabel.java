...
public class AdGroupServiceLabel {
  ...
  public AdGroupServiceLabel color(@jakarta.annotation.Nullable String color) {
  ...
  public AdGroupServiceLabel description(@jakarta.annotation.Nullable String description) {
  ...
  public AdGroupServiceLabel labelId(@jakarta.annotation.Nullable Long labelId) {
  ...
  public AdGroupServiceLabel labelName(@jakarta.annotation.Nullable String labelName) {
