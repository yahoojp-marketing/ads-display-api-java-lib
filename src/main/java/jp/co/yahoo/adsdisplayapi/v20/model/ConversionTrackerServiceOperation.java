...
import jp.co.yahoo.adsdisplayapi.v20.model.ConversionTracker;
...
public class ConversionTrackerServiceOperation {
  ...
  public ConversionTrackerServiceOperation accountId(@jakarta.annotation.Nonnull Long accountId) {
  ...
  public ConversionTrackerServiceOperation operand(@jakarta.annotation.Nonnull List<ConversionTracker> operand) {
  ...
  @JsonProperty(value = JSON_PROPERTY_OPERAND, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setOperand(@jakarta.annotation.Nonnull List<ConversionTracker> operand) {
    this.operand = operand;
  }
