...
import jp.co.yahoo.adsdisplayapi.v20.model.AdGroupTargetServiceDeviceAppType;
...
public class AdGroupTargetServiceAppTarget {
  ...
  public AdGroupTargetServiceAppTarget deviceAppType(@jakarta.annotation.Nullable AdGroupTargetServiceDeviceAppType deviceAppType) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DEVICE_APP_TYPE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDeviceAppType(@jakarta.annotation.Nullable AdGroupTargetServiceDeviceAppType deviceAppType) {
    this.deviceAppType = deviceAppType;
  }
