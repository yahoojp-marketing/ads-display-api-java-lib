...
import jp.co.yahoo.adsdisplayapi.v20.model.AdGroup;
...
public class AdGroupServiceValue {
  ...
  public AdGroupServiceValue adGroup(@jakarta.annotation.Nullable AdGroup adGroup) {
  ...
  @JsonProperty(value = JSON_PROPERTY_AD_GROUP, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAdGroup(@jakarta.annotation.Nullable AdGroup adGroup) {
    this.adGroup = adGroup;
  }

  public AdGroupServiceValue errors(@jakarta.annotation.Nullable List<Error> errors) {
  ...
  public AdGroupServiceValue operationSucceeded(@jakarta.annotation.Nullable Boolean operationSucceeded) {
