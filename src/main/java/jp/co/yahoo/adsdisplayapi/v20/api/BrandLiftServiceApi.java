...
import jp.co.yahoo.adsdisplayapi.v20.model.BrandLiftServiceGetResponse;
import jp.co.yahoo.adsdisplayapi.v20.model.BrandLiftServiceSelector;
...
@Component("jp.co.yahoo.adsdisplayapi.v20.api.BrandLiftServiceApi")
public class BrandLiftServiceApi extends BaseApi {

    public BrandLiftServiceApi() {
        super(new ApiClient());
    }

    @Autowired
    public BrandLiftServiceApi(ApiClient apiClient) {
        super(apiClient);
    }
     ...
     * @param brandLiftServiceSelector  (optional)
     * @return BrandLiftServiceGetResponse
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public BrandLiftServiceGetResponse brandLiftServiceGetPost(Long xZBaseAccountId, BrandLiftServiceSelector brandLiftServiceSelector) throws RestClientException {
        return brandLiftServiceGetPostWithHttpInfo(xZBaseAccountId, brandLiftServiceSelector).getBody();
    }
     ...
     * @param xZBaseAccountId &lt;div lang&#x3D;\&quot;ja\&quot;&gt;アカウントIDを指定してください。&lt;/div&gt; &lt;div lang&#x3D;\&quot;en\&quot;&gt;Specify Account ID.&lt;/div&gt;  (required)
     * @param brandLiftServiceSelector  (optional)
     * @return ResponseEntity&lt;BrandLiftServiceGetResponse&gt;
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<BrandLiftServiceGetResponse> brandLiftServiceGetPostWithHttpInfo(Long xZBaseAccountId, BrandLiftServiceSelector brandLiftServiceSelector) throws RestClientException {
        Object localVarPostBody = brandLiftServiceSelector;
        
        // verify the required parameter 'xZBaseAccountId' is set
        if (xZBaseAccountId == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'xZBaseAccountId' when calling brandLiftServiceGetPost");
        }
        ...
        ParameterizedTypeReference<BrandLiftServiceGetResponse> localReturnType = new ParameterizedTypeReference<BrandLiftServiceGetResponse>() {};
        return apiClient.invokeAPI("/BrandLiftService/get", HttpMethod.POST, Collections.<String, Object>emptyMap(), localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localReturnType);
    }
