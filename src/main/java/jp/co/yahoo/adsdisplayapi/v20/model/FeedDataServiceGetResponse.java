...
import jp.co.yahoo.adsdisplayapi.v20.model.FeedDataServicePage;
...
public class FeedDataServiceGetResponse {
  ...
  public FeedDataServiceGetResponse errors(@jakarta.annotation.Nullable List<Error> errors) {
  ...
  public FeedDataServiceGetResponse rid(@jakarta.annotation.Nullable String rid) {
  ...
  public FeedDataServiceGetResponse rval(@jakarta.annotation.Nullable FeedDataServicePage rval) {
  ...
  @JsonProperty(value = JSON_PROPERTY_RVAL, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRval(@jakarta.annotation.Nullable FeedDataServicePage rval) {
    this.rval = rval;
  }
