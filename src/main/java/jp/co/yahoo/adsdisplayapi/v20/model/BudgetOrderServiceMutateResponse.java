...
import jp.co.yahoo.adsdisplayapi.v20.model.BudgetOrderServiceReturnValue;
...
public class BudgetOrderServiceMutateResponse {
  ...
  public BudgetOrderServiceMutateResponse errors(@jakarta.annotation.Nullable List<Error> errors) {
  ...
  public BudgetOrderServiceMutateResponse rid(@jakarta.annotation.Nullable String rid) {
  ...
  public BudgetOrderServiceMutateResponse rval(@jakarta.annotation.Nullable BudgetOrderServiceReturnValue rval) {
  ...
  @JsonProperty(value = JSON_PROPERTY_RVAL, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRval(@jakarta.annotation.Nullable BudgetOrderServiceReturnValue rval) {
    this.rval = rval;
  }
