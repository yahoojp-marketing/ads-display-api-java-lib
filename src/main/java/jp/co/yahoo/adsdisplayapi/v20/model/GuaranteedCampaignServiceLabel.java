 ...
 */
@JsonPropertyOrder({
  GuaranteedCampaignServiceLabel.JSON_PROPERTY_COLOR,
  GuaranteedCampaignServiceLabel.JSON_PROPERTY_DESCRIPTION,
  GuaranteedCampaignServiceLabel.JSON_PROPERTY_LABEL_ID,
  GuaranteedCampaignServiceLabel.JSON_PROPERTY_LABEL_NAME
})
...
public class GuaranteedCampaignServiceLabel {
  ...
  public GuaranteedCampaignServiceLabel() {
  }

  public GuaranteedCampaignServiceLabel color(@jakarta.annotation.Nullable String color) {
  ...
  public GuaranteedCampaignServiceLabel description(@jakarta.annotation.Nullable String description) {
  ...
  public GuaranteedCampaignServiceLabel labelId(@jakarta.annotation.Nullable Long labelId) {
  ...
  public GuaranteedCampaignServiceLabel labelName(@jakarta.annotation.Nullable String labelName) {
