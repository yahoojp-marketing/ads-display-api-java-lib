...
public class AdGroupServiceOperation {
  ...
  public AdGroupServiceOperation accountId(@jakarta.annotation.Nonnull Long accountId) {
  ...
  public AdGroupServiceOperation operand(@jakarta.annotation.Nonnull List<AdGroup> operand) {
  ...
  @JsonProperty(value = JSON_PROPERTY_OPERAND, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setOperand(@jakarta.annotation.Nonnull List<AdGroup> operand) {
    this.operand = operand;
  }
