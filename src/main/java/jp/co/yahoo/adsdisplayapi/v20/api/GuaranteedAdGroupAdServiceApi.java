...
import jp.co.yahoo.adsdisplayapi.v20.model.GuaranteedAdGroupAdServiceGetResponse;
import jp.co.yahoo.adsdisplayapi.v20.model.GuaranteedAdGroupAdServiceSelector;
...
@Component("jp.co.yahoo.adsdisplayapi.v20.api.GuaranteedAdGroupAdServiceApi")
public class GuaranteedAdGroupAdServiceApi extends BaseApi {

    public GuaranteedAdGroupAdServiceApi() {
        super(new ApiClient());
    }

    @Autowired
    public GuaranteedAdGroupAdServiceApi(ApiClient apiClient) {
        super(apiClient);
    }
     ...
     * @param guaranteedAdGroupAdServiceSelector  (optional)
     * @return GuaranteedAdGroupAdServiceGetResponse
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public GuaranteedAdGroupAdServiceGetResponse guaranteedAdGroupAdServiceGetPost(Long xZBaseAccountId, GuaranteedAdGroupAdServiceSelector guaranteedAdGroupAdServiceSelector) throws RestClientException {
        return guaranteedAdGroupAdServiceGetPostWithHttpInfo(xZBaseAccountId, guaranteedAdGroupAdServiceSelector).getBody();
    }
     ...
     * @param xZBaseAccountId &lt;div lang&#x3D;\&quot;ja\&quot;&gt;アカウントIDを指定してください。&lt;/div&gt; &lt;div lang&#x3D;\&quot;en\&quot;&gt;Specify Account ID.&lt;/div&gt;  (required)
     * @param guaranteedAdGroupAdServiceSelector  (optional)
     * @return ResponseEntity&lt;GuaranteedAdGroupAdServiceGetResponse&gt;
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<GuaranteedAdGroupAdServiceGetResponse> guaranteedAdGroupAdServiceGetPostWithHttpInfo(Long xZBaseAccountId, GuaranteedAdGroupAdServiceSelector guaranteedAdGroupAdServiceSelector) throws RestClientException {
        Object localVarPostBody = guaranteedAdGroupAdServiceSelector;
        
        // verify the required parameter 'xZBaseAccountId' is set
        if (xZBaseAccountId == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'xZBaseAccountId' when calling guaranteedAdGroupAdServiceGetPost");
        }
        ...
        ParameterizedTypeReference<GuaranteedAdGroupAdServiceGetResponse> localReturnType = new ParameterizedTypeReference<GuaranteedAdGroupAdServiceGetResponse>() {};
        return apiClient.invokeAPI("/GuaranteedAdGroupAdService/get", HttpMethod.POST, Collections.<String, Object>emptyMap(), localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localReturnType);
    }
