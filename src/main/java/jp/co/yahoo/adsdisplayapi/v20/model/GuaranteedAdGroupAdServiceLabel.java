...
public class GuaranteedAdGroupAdServiceLabel {
  ...
  public GuaranteedAdGroupAdServiceLabel color(@jakarta.annotation.Nullable String color) {
  ...
  public GuaranteedAdGroupAdServiceLabel description(@jakarta.annotation.Nullable String description) {
  ...
  public GuaranteedAdGroupAdServiceLabel labelId(@jakarta.annotation.Nullable Long labelId) {
  ...
  public GuaranteedAdGroupAdServiceLabel labelName(@jakarta.annotation.Nullable String labelName) {
