...
import jp.co.yahoo.adsdisplayapi.v20.model.AccountTrackingUrlServiceValue;
...
public class AccountTrackingUrlServicePage {
  ...
  public AccountTrackingUrlServicePage totalNumEntries(@jakarta.annotation.Nullable Integer totalNumEntries) {
  ...
  public AccountTrackingUrlServicePage values(@jakarta.annotation.Nullable AccountTrackingUrlServiceValue values) {
  ...
  @JsonProperty(value = JSON_PROPERTY_VALUES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setValues(@jakarta.annotation.Nullable AccountTrackingUrlServiceValue values) {
    this.values = values;
  }
