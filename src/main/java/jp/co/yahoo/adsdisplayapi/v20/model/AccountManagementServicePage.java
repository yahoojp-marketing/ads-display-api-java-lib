...
import jp.co.yahoo.adsdisplayapi.v20.model.AccountManagementServiceValue;
...
public class AccountManagementServicePage {
  ...
  public AccountManagementServicePage totalNumEntries(@jakarta.annotation.Nullable Integer totalNumEntries) {
  ...
  public AccountManagementServicePage values(@jakarta.annotation.Nullable List<AccountManagementServiceValue> values) {
  ...
  @JsonProperty(value = JSON_PROPERTY_VALUES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setValues(@jakarta.annotation.Nullable List<AccountManagementServiceValue> values) {
    this.values = values;
  }
