...
import jp.co.yahoo.adsdisplayapi.v20.model.StatsServicePeriod;
import jp.co.yahoo.adsdisplayapi.v20.model.StatsServiceValue;
...
public class StatsServicePage {
  ...
  public StatsServicePage period(@jakarta.annotation.Nullable StatsServicePeriod period) {
  ...
  @JsonProperty(value = JSON_PROPERTY_PERIOD, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPeriod(@jakarta.annotation.Nullable StatsServicePeriod period) {
    this.period = period;
  }

  public StatsServicePage totalNumEntries(@jakarta.annotation.Nullable Integer totalNumEntries) {
  ...
  public StatsServicePage values(@jakarta.annotation.Nullable List<StatsServiceValue> values) {
  ...
  @JsonProperty(value = JSON_PROPERTY_VALUES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setValues(@jakarta.annotation.Nullable List<StatsServiceValue> values) {
    this.values = values;
  }
