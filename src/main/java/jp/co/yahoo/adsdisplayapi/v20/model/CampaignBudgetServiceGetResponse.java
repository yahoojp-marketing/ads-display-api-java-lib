...
import jp.co.yahoo.adsdisplayapi.v20.model.CampaignBudgetServicePage;
...
public class CampaignBudgetServiceGetResponse {
  ...
  public CampaignBudgetServiceGetResponse errors(@jakarta.annotation.Nullable List<Error> errors) {
  ...
  public CampaignBudgetServiceGetResponse rid(@jakarta.annotation.Nullable String rid) {
  ...
  public CampaignBudgetServiceGetResponse rval(@jakarta.annotation.Nullable CampaignBudgetServicePage rval) {
  ...
  @JsonProperty(value = JSON_PROPERTY_RVAL, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRval(@jakarta.annotation.Nullable CampaignBudgetServicePage rval) {
    this.rval = rval;
  }
