package jp.co.yahoo.adsdisplayapi.v20.api;

import jp.co.yahoo.adsdisplayapi.v20.ApiClient;
import jp.co.yahoo.adsdisplayapi.v20.BaseApi;

import jp.co.yahoo.adsdisplayapi.v20.model.StatsServiceGetResponse;
import jp.co.yahoo.adsdisplayapi.v20.model.StatsServiceSelector;
...
@Component("jp.co.yahoo.adsdisplayapi.v20.api.StatsServiceApi")
public class StatsServiceApi extends BaseApi {

    public StatsServiceApi() {
        super(new ApiClient());
    }

    @Autowired
    public StatsServiceApi(ApiClient apiClient) {
        super(apiClient);
    }
     ...
     * @param xZBaseAccountId &lt;div lang&#x3D;\&quot;ja\&quot;&gt;アカウントIDを指定してください。&lt;/div&gt; &lt;div lang&#x3D;\&quot;en\&quot;&gt;Specify Account ID.&lt;/div&gt;  (required)
     * @param statsServiceSelector  (optional)
     * @return ResponseEntity&lt;StatsServiceGetResponse&gt;
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<StatsServiceGetResponse> statsServiceGetPostWithHttpInfo(Long xZBaseAccountId, StatsServiceSelector statsServiceSelector) throws RestClientException {
        Object localVarPostBody = statsServiceSelector;
        
        // verify the required parameter 'xZBaseAccountId' is set
        if (xZBaseAccountId == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'xZBaseAccountId' when calling statsServiceGetPost");
        }
        ...
        ParameterizedTypeReference<StatsServiceGetResponse> localReturnType = new ParameterizedTypeReference<StatsServiceGetResponse>() {};
        return apiClient.invokeAPI("/StatsService/get", HttpMethod.POST, Collections.<String, Object>emptyMap(), localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localReturnType);
    }
