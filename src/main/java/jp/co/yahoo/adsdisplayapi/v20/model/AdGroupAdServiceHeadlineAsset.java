...
public class AdGroupAdServiceHeadlineAsset {
  ...
  public AdGroupAdServiceHeadlineAsset text(@jakarta.annotation.Nullable String text) {
  ...
  public AdGroupAdServiceHeadlineAsset approvalStatus(@jakarta.annotation.Nullable AdGroupAdServiceApprovalStatus approvalStatus) {
  ...
  public AdGroupAdServiceHeadlineAsset disapprovalReasonCodes(@jakarta.annotation.Nullable List<String> disapprovalReasonCodes) {
