...
import jp.co.yahoo.adsdisplayapi.v20.model.RecommendationServiceGetResponse;
import jp.co.yahoo.adsdisplayapi.v20.model.RecommendationServiceSelector;
...
@Component("jp.co.yahoo.adsdisplayapi.v20.api.RecommendationServiceApi")
public class RecommendationServiceApi extends BaseApi {

    public RecommendationServiceApi() {
        super(new ApiClient());
    }

    @Autowired
    public RecommendationServiceApi(ApiClient apiClient) {
        super(apiClient);
    }
     ...
     * @param recommendationServiceSelector  (optional)
     * @return RecommendationServiceGetResponse
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public RecommendationServiceGetResponse recommendationServiceGetPost(Long xZBaseAccountId, RecommendationServiceSelector recommendationServiceSelector) throws RestClientException {
        return recommendationServiceGetPostWithHttpInfo(xZBaseAccountId, recommendationServiceSelector).getBody();
    }
     ...
     * @param xZBaseAccountId &lt;div lang&#x3D;\&quot;ja\&quot;&gt;アカウントIDを指定してください。&lt;/div&gt; &lt;div lang&#x3D;\&quot;en\&quot;&gt;Specify Account ID.&lt;/div&gt;  (required)
     * @param recommendationServiceSelector  (optional)
     * @return ResponseEntity&lt;RecommendationServiceGetResponse&gt;
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<RecommendationServiceGetResponse> recommendationServiceGetPostWithHttpInfo(Long xZBaseAccountId, RecommendationServiceSelector recommendationServiceSelector) throws RestClientException {
        Object localVarPostBody = recommendationServiceSelector;
        
        // verify the required parameter 'xZBaseAccountId' is set
        if (xZBaseAccountId == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'xZBaseAccountId' when calling recommendationServiceGetPost");
        }
        ...
        ParameterizedTypeReference<RecommendationServiceGetResponse> localReturnType = new ParameterizedTypeReference<RecommendationServiceGetResponse>() {};
        return apiClient.invokeAPI("/RecommendationService/get", HttpMethod.POST, Collections.<String, Object>emptyMap(), localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localReturnType);
    }
