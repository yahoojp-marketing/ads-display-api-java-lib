...
import jp.co.yahoo.adsdisplayapi.v20.model.Balance;
...
public class BalanceServiceValue {
  ...
  public BalanceServiceValue balance(@jakarta.annotation.Nullable Balance balance) {
  ...
  @JsonProperty(value = JSON_PROPERTY_BALANCE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setBalance(@jakarta.annotation.Nullable Balance balance) {
    this.balance = balance;
  }

  public BalanceServiceValue errors(@jakarta.annotation.Nullable List<Error> errors) {
  ...
  public BalanceServiceValue operationSucceeded(@jakarta.annotation.Nullable Boolean operationSucceeded) {
