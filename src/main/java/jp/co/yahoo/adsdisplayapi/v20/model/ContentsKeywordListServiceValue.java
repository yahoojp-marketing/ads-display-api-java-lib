...
import jp.co.yahoo.adsdisplayapi.v20.model.ContentsKeywordList;
...
public class ContentsKeywordListServiceValue {
  ...
  public ContentsKeywordListServiceValue errors(@jakarta.annotation.Nullable List<Error> errors) {
  ...
  public ContentsKeywordListServiceValue operationSucceeded(@jakarta.annotation.Nullable Boolean operationSucceeded) {
  ...
  public ContentsKeywordListServiceValue contentsKeywordList(@jakarta.annotation.Nullable ContentsKeywordList contentsKeywordList) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_CONTENTS_KEYWORD_LIST, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_CONTENTS_KEYWORD_LIST, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setContentsKeywordList(@jakarta.annotation.Nullable ContentsKeywordList contentsKeywordList) {
    this.contentsKeywordList = contentsKeywordList;
  }
