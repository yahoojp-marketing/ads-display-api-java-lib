...
public class AccountServiceOperation {
  ...
  public AccountServiceOperation accountId(@jakarta.annotation.Nonnull Long accountId) {
  ...
  public AccountServiceOperation operand(@jakarta.annotation.Nonnull List<Account> operand) {
  ...
  @JsonProperty(value = JSON_PROPERTY_OPERAND, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setOperand(@jakarta.annotation.Nonnull List<Account> operand) {
    this.operand = operand;
  }
