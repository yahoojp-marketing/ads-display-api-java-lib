...
import jp.co.yahoo.adsdisplayapi.v20.model.AdGroupServiceReturnValue;
...
public class AdGroupServiceMutateResponse {
  ...
  public AdGroupServiceMutateResponse errors(@jakarta.annotation.Nullable List<Error> errors) {
  ...
  public AdGroupServiceMutateResponse rid(@jakarta.annotation.Nullable String rid) {
  ...
  public AdGroupServiceMutateResponse rval(@jakarta.annotation.Nullable AdGroupServiceReturnValue rval) {
  ...
  @JsonProperty(value = JSON_PROPERTY_RVAL, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRval(@jakarta.annotation.Nullable AdGroupServiceReturnValue rval) {
    this.rval = rval;
  }
