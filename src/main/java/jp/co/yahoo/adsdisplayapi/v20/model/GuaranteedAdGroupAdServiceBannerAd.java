 ...
 */
@JsonPropertyOrder({
  GuaranteedAdGroupAdServiceBannerAd.JSON_PROPERTY_DISPLAY_URL,
  GuaranteedAdGroupAdServiceBannerAd.JSON_PROPERTY_THUMBNAIL_MEDIA_ID,
  GuaranteedAdGroupAdServiceBannerAd.JSON_PROPERTY_CUSTOM_PARAMETERS,
  GuaranteedAdGroupAdServiceBannerAd.JSON_PROPERTY_DISPLAY_URL_LEVEL,
  GuaranteedAdGroupAdServiceBannerAd.JSON_PROPERTY_FINAL_URL,
  GuaranteedAdGroupAdServiceBannerAd.JSON_PROPERTY_SMARTPHONE_FINAL_URL,
  GuaranteedAdGroupAdServiceBannerAd.JSON_PROPERTY_TRACKING_URL,
  GuaranteedAdGroupAdServiceBannerAd.JSON_PROPERTY_VIDEO10_SEC_BEACON_URLS,
  GuaranteedAdGroupAdServiceBannerAd.JSON_PROPERTY_VIDEO25_PERCENT_BEACON_URLS,
  GuaranteedAdGroupAdServiceBannerAd.JSON_PROPERTY_VIDEO3_SEC_BEACON_URLS,
  GuaranteedAdGroupAdServiceBannerAd.JSON_PROPERTY_VIDEO50_PERCENT_BEACON_URLS,
  GuaranteedAdGroupAdServiceBannerAd.JSON_PROPERTY_VIDEO75_PERCENT_BEACON_URLS,
  GuaranteedAdGroupAdServiceBannerAd.JSON_PROPERTY_VIDEO_COMPLETE_BEACON_URLS,
  GuaranteedAdGroupAdServiceBannerAd.JSON_PROPERTY_VIDEO_START_BEACON_URLS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.22.0")
public class GuaranteedAdGroupAdServiceBannerAd {
  ...
  public GuaranteedAdGroupAdServiceBannerAd() {
  }

  public GuaranteedAdGroupAdServiceBannerAd displayUrl(@jakarta.annotation.Nullable String displayUrl) {
  ...
  public GuaranteedAdGroupAdServiceBannerAd thumbnailMediaId(@jakarta.annotation.Nullable Long thumbnailMediaId) {
  ...
  public GuaranteedAdGroupAdServiceBannerAd customParameters(@jakarta.annotation.Nullable GuaranteedAdGroupAdServiceCustomParameters customParameters) {
  ...
  public GuaranteedAdGroupAdServiceBannerAd displayUrlLevel(@jakarta.annotation.Nullable GuaranteedAdGroupAdServiceDisplayUrlLevel displayUrlLevel) {
  ...
  public GuaranteedAdGroupAdServiceBannerAd finalUrl(@jakarta.annotation.Nullable String finalUrl) {
  ...
  public GuaranteedAdGroupAdServiceBannerAd smartphoneFinalUrl(@jakarta.annotation.Nullable String smartphoneFinalUrl) {
  ...
  public GuaranteedAdGroupAdServiceBannerAd trackingUrl(@jakarta.annotation.Nullable String trackingUrl) {
  ...
  public GuaranteedAdGroupAdServiceBannerAd video10SecBeaconUrls(@jakarta.annotation.Nullable List<String> video10SecBeaconUrls) {
    
    this.video10SecBeaconUrls = video10SecBeaconUrls;
    return this;
  }

  public GuaranteedAdGroupAdServiceBannerAd addVideo10SecBeaconUrlsItem(String video10SecBeaconUrlsItem) {
  ...
  public GuaranteedAdGroupAdServiceBannerAd video25PercentBeaconUrls(@jakarta.annotation.Nullable List<String> video25PercentBeaconUrls) {
    
    this.video25PercentBeaconUrls = video25PercentBeaconUrls;
    return this;
  }

  public GuaranteedAdGroupAdServiceBannerAd addVideo25PercentBeaconUrlsItem(String video25PercentBeaconUrlsItem) {
  ...
  public GuaranteedAdGroupAdServiceBannerAd video3SecBeaconUrls(@jakarta.annotation.Nullable List<String> video3SecBeaconUrls) {
    
    this.video3SecBeaconUrls = video3SecBeaconUrls;
    return this;
  }

  public GuaranteedAdGroupAdServiceBannerAd addVideo3SecBeaconUrlsItem(String video3SecBeaconUrlsItem) {
  ...
  public GuaranteedAdGroupAdServiceBannerAd video50PercentBeaconUrls(@jakarta.annotation.Nullable List<String> video50PercentBeaconUrls) {
    
    this.video50PercentBeaconUrls = video50PercentBeaconUrls;
    return this;
  }

  public GuaranteedAdGroupAdServiceBannerAd addVideo50PercentBeaconUrlsItem(String video50PercentBeaconUrlsItem) {
  ...
  public GuaranteedAdGroupAdServiceBannerAd video75PercentBeaconUrls(@jakarta.annotation.Nullable List<String> video75PercentBeaconUrls) {
    
    this.video75PercentBeaconUrls = video75PercentBeaconUrls;
    return this;
  }

  public GuaranteedAdGroupAdServiceBannerAd addVideo75PercentBeaconUrlsItem(String video75PercentBeaconUrlsItem) {
  ...
  public GuaranteedAdGroupAdServiceBannerAd videoCompleteBeaconUrls(@jakarta.annotation.Nullable List<String> videoCompleteBeaconUrls) {
    
    this.videoCompleteBeaconUrls = videoCompleteBeaconUrls;
    return this;
  }

  public GuaranteedAdGroupAdServiceBannerAd addVideoCompleteBeaconUrlsItem(String videoCompleteBeaconUrlsItem) {
  ...
  public GuaranteedAdGroupAdServiceBannerAd videoStartBeaconUrls(@jakarta.annotation.Nullable List<String> videoStartBeaconUrls) {
    
    this.videoStartBeaconUrls = videoStartBeaconUrls;
    return this;
  }

  public GuaranteedAdGroupAdServiceBannerAd addVideoStartBeaconUrlsItem(String videoStartBeaconUrlsItem) {
  ...
  public boolean equals(Object o) {
    ...
    GuaranteedAdGroupAdServiceBannerAd guaranteedAdGroupAdServiceBannerAd = (GuaranteedAdGroupAdServiceBannerAd) o;
    return Objects.equals(this.displayUrl, guaranteedAdGroupAdServiceBannerAd.displayUrl) &&
        Objects.equals(this.thumbnailMediaId, guaranteedAdGroupAdServiceBannerAd.thumbnailMediaId) &&
        Objects.equals(this.customParameters, guaranteedAdGroupAdServiceBannerAd.customParameters) &&
        Objects.equals(this.displayUrlLevel, guaranteedAdGroupAdServiceBannerAd.displayUrlLevel) &&
        Objects.equals(this.finalUrl, guaranteedAdGroupAdServiceBannerAd.finalUrl) &&
        Objects.equals(this.smartphoneFinalUrl, guaranteedAdGroupAdServiceBannerAd.smartphoneFinalUrl) &&
        Objects.equals(this.trackingUrl, guaranteedAdGroupAdServiceBannerAd.trackingUrl) &&
        Objects.equals(this.video10SecBeaconUrls, guaranteedAdGroupAdServiceBannerAd.video10SecBeaconUrls) &&
        Objects.equals(this.video25PercentBeaconUrls, guaranteedAdGroupAdServiceBannerAd.video25PercentBeaconUrls) &&
        Objects.equals(this.video3SecBeaconUrls, guaranteedAdGroupAdServiceBannerAd.video3SecBeaconUrls) &&
        Objects.equals(this.video50PercentBeaconUrls, guaranteedAdGroupAdServiceBannerAd.video50PercentBeaconUrls) &&
        Objects.equals(this.video75PercentBeaconUrls, guaranteedAdGroupAdServiceBannerAd.video75PercentBeaconUrls) &&
        Objects.equals(this.videoCompleteBeaconUrls, guaranteedAdGroupAdServiceBannerAd.videoCompleteBeaconUrls) &&
        Objects.equals(this.videoStartBeaconUrls, guaranteedAdGroupAdServiceBannerAd.videoStartBeaconUrls);
  }

  @Override
  public int hashCode() {
    return Objects.hash(displayUrl, thumbnailMediaId, customParameters, displayUrlLevel, finalUrl, smartphoneFinalUrl, trackingUrl, video10SecBeaconUrls, video25PercentBeaconUrls, video3SecBeaconUrls, video50PercentBeaconUrls, video75PercentBeaconUrls, videoCompleteBeaconUrls, videoStartBeaconUrls);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GuaranteedAdGroupAdServiceBannerAd {\n");
