...
import jp.co.yahoo.adsdisplayapi.v20.model.AccountServiceValue;
...
public class AccountServicePage {
  ...
  public AccountServicePage authorizationBusinessId(@jakarta.annotation.Nullable String authorizationBusinessId) {
  ...
  public AccountServicePage totalNumEntries(@jakarta.annotation.Nullable Integer totalNumEntries) {
  ...
  public AccountServicePage values(@jakarta.annotation.Nullable List<AccountServiceValue> values) {
  ...
  @JsonProperty(value = JSON_PROPERTY_VALUES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setValues(@jakarta.annotation.Nullable List<AccountServiceValue> values) {
    this.values = values;
  }
