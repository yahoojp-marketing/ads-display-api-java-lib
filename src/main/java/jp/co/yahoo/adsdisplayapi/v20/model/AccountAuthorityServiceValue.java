...
import jp.co.yahoo.adsdisplayapi.v20.model.AccountAuthority;
...
public class AccountAuthorityServiceValue {
  ...
  public AccountAuthorityServiceValue accountAuthority(@jakarta.annotation.Nullable AccountAuthority accountAuthority) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_ACCOUNT_AUTHORITY, required = false)
  ...
  @JsonProperty(value = JSON_PROPERTY_ACCOUNT_AUTHORITY, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAccountAuthority(@jakarta.annotation.Nullable AccountAuthority accountAuthority) {
    this.accountAuthority = accountAuthority;
  }

  public AccountAuthorityServiceValue errors(@jakarta.annotation.Nullable List<Error> errors) {
  ...
  public AccountAuthorityServiceValue operationSucceeded(@jakarta.annotation.Nullable Boolean operationSucceeded) {
