...
import jp.co.yahoo.adsdisplayapi.v20.model.VideoServiceValue;
...
public class VideoServicePage {
  ...
  public VideoServicePage totalNumEntries(@jakarta.annotation.Nullable Integer totalNumEntries) {
  ...
  public VideoServicePage values(@jakarta.annotation.Nullable List<VideoServiceValue> values) {
  ...
  @JsonProperty(value = JSON_PROPERTY_VALUES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setValues(@jakarta.annotation.Nullable List<VideoServiceValue> values) {
    this.values = values;
  }
