...
import jp.co.yahoo.adsdisplayapi.v20.model.FeedFtp;
...
public class FeedFtpServiceValue {
  ...
  public FeedFtpServiceValue errors(@jakarta.annotation.Nullable List<Error> errors) {
  ...
  public FeedFtpServiceValue feedFtp(@jakarta.annotation.Nullable FeedFtp feedFtp) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_FEED_FTP, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_FEED_FTP, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFeedFtp(@jakarta.annotation.Nullable FeedFtp feedFtp) {
    this.feedFtp = feedFtp;
  }

  public FeedFtpServiceValue operationSucceeded(@jakarta.annotation.Nullable Boolean operationSucceeded) {
