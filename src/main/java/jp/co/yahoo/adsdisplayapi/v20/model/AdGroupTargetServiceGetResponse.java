...
import jp.co.yahoo.adsdisplayapi.v20.model.AdGroupTargetServicePage;
...
public class AdGroupTargetServiceGetResponse {
  ...
  public AdGroupTargetServiceGetResponse errors(@jakarta.annotation.Nullable List<Error> errors) {
  ...
  public AdGroupTargetServiceGetResponse rid(@jakarta.annotation.Nullable String rid) {
  ...
  public AdGroupTargetServiceGetResponse rval(@jakarta.annotation.Nullable AdGroupTargetServicePage rval) {
  ...
  @JsonProperty(value = JSON_PROPERTY_RVAL, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRval(@jakarta.annotation.Nullable AdGroupTargetServicePage rval) {
    this.rval = rval;
  }
