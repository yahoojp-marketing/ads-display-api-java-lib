...
import jp.co.yahoo.adsdisplayapi.v20.model.ContentsKeywordIdea;
...
public class ContentsKeywordIdeaServiceValue {
  ...
  public ContentsKeywordIdeaServiceValue errors(@jakarta.annotation.Nullable List<Error> errors) {
  ...
  public ContentsKeywordIdeaServiceValue operationSucceeded(@jakarta.annotation.Nullable Boolean operationSucceeded) {
  ...
  public ContentsKeywordIdeaServiceValue contentsKeywordIdea(@jakarta.annotation.Nullable ContentsKeywordIdea contentsKeywordIdea) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_CONTENTS_KEYWORD_IDEA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_CONTENTS_KEYWORD_IDEA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setContentsKeywordIdea(@jakarta.annotation.Nullable ContentsKeywordIdea contentsKeywordIdea) {
    this.contentsKeywordIdea = contentsKeywordIdea;
  }
