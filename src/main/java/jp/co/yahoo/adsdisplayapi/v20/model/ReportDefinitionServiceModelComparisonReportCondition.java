...
import jp.co.yahoo.adsdisplayapi.v20.model.ReportDefinitionServiceAttributionModel;
import jp.co.yahoo.adsdisplayapi.v20.model.ReportDefinitionServiceIncludeVideoInteractionFlg;
import jp.co.yahoo.adsdisplayapi.v20.model.ReportDefinitionServiceIncludeViewInteractionFlg;
...
public class ReportDefinitionServiceModelComparisonReportCondition {
  ...
  public ReportDefinitionServiceModelComparisonReportCondition lookbackWindow(@jakarta.annotation.Nullable Long lookbackWindow) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_LOOKBACK_WINDOW, required = false)
  ...
  @JsonProperty(value = JSON_PROPERTY_LOOKBACK_WINDOW, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setLookbackWindow(@jakarta.annotation.Nullable Long lookbackWindow) {
    this.lookbackWindow = lookbackWindow;
  }

  public ReportDefinitionServiceModelComparisonReportCondition includeViewInteraction(@jakarta.annotation.Nullable ReportDefinitionServiceIncludeViewInteractionFlg includeViewInteraction) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_INCLUDE_VIEW_INTERACTION, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_INCLUDE_VIEW_INTERACTION, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIncludeViewInteraction(@jakarta.annotation.Nullable ReportDefinitionServiceIncludeViewInteractionFlg includeViewInteraction) {
    this.includeViewInteraction = includeViewInteraction;
  }

  public ReportDefinitionServiceModelComparisonReportCondition includeVideoInteraction(@jakarta.annotation.Nullable ReportDefinitionServiceIncludeVideoInteractionFlg includeVideoInteraction) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_INCLUDE_VIDEO_INTERACTION, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_INCLUDE_VIDEO_INTERACTION, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIncludeVideoInteraction(@jakarta.annotation.Nullable ReportDefinitionServiceIncludeVideoInteractionFlg includeVideoInteraction) {
    this.includeVideoInteraction = includeVideoInteraction;
  }

  public ReportDefinitionServiceModelComparisonReportCondition baseModel(@jakarta.annotation.Nullable ReportDefinitionServiceAttributionModel baseModel) {
  ...
  @JsonProperty(value = JSON_PROPERTY_BASE_MODEL, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setBaseModel(@jakarta.annotation.Nullable ReportDefinitionServiceAttributionModel baseModel) {
    this.baseModel = baseModel;
  }

  public ReportDefinitionServiceModelComparisonReportCondition comparativeModel(@jakarta.annotation.Nullable ReportDefinitionServiceAttributionModel comparativeModel) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_COMPARATIVE_MODEL, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_COMPARATIVE_MODEL, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setComparativeModel(@jakarta.annotation.Nullable ReportDefinitionServiceAttributionModel comparativeModel) {
    this.comparativeModel = comparativeModel;
  }
