...
import jp.co.yahoo.adsdisplayapi.v20.model.BiddingStrategy;
...
public class BiddingStrategyServiceValue {
  ...
  public BiddingStrategyServiceValue biddingStrategy(@jakarta.annotation.Nullable BiddingStrategy biddingStrategy) {
  ...
  @JsonProperty(value = JSON_PROPERTY_BIDDING_STRATEGY, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setBiddingStrategy(@jakarta.annotation.Nullable BiddingStrategy biddingStrategy) {
    this.biddingStrategy = biddingStrategy;
  }

  public BiddingStrategyServiceValue errors(@jakarta.annotation.Nullable List<Error> errors) {
  ...
  public BiddingStrategyServiceValue operationSucceeded(@jakarta.annotation.Nullable Boolean operationSucceeded) {
