...
public class FeedFtpServiceOperation {
  ...
  public FeedFtpServiceOperation accountId(@jakarta.annotation.Nonnull Long accountId) {
  ...
  public FeedFtpServiceOperation operand(@jakarta.annotation.Nonnull List<FeedFtp> operand) {
  ...
  @JsonProperty(value = JSON_PROPERTY_OPERAND, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setOperand(@jakarta.annotation.Nonnull List<FeedFtp> operand) {
    this.operand = operand;
  }
