...
import jp.co.yahoo.adsdisplayapi.v20.model.AdGroupLabel;
...
public class AdGroupLabelServiceValue {
  ...
  public AdGroupLabelServiceValue adGroupLabel(@jakarta.annotation.Nullable AdGroupLabel adGroupLabel) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_AD_GROUP_LABEL, required = false)
  ...
  @JsonProperty(value = JSON_PROPERTY_AD_GROUP_LABEL, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAdGroupLabel(@jakarta.annotation.Nullable AdGroupLabel adGroupLabel) {
    this.adGroupLabel = adGroupLabel;
  }

  public AdGroupLabelServiceValue errors(@jakarta.annotation.Nullable List<Error> errors) {
  ...
  public AdGroupLabelServiceValue operationSucceeded(@jakarta.annotation.Nullable Boolean operationSucceeded) {
