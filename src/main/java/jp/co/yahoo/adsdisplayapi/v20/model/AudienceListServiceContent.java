...
import jp.co.yahoo.adsdisplayapi.v20.model.AudienceListServiceAdActionUsersAudienceList;
import jp.co.yahoo.adsdisplayapi.v20.model.AudienceListServiceAdvancedSegmentsAudienceList;
import jp.co.yahoo.adsdisplayapi.v20.model.AudienceListServiceAppUserAudienceList;
import jp.co.yahoo.adsdisplayapi.v20.model.AudienceListServiceBusinessManagerAudienceList;
import jp.co.yahoo.adsdisplayapi.v20.model.AudienceListServiceCombinationAudienceList;
import jp.co.yahoo.adsdisplayapi.v20.model.AudienceListServiceCustomerDataAudienceList;
import jp.co.yahoo.adsdisplayapi.v20.model.AudienceListServiceLineOaBlockAudienceList;
import jp.co.yahoo.adsdisplayapi.v20.model.AudienceListServiceLineOaFriendAudienceList;
import jp.co.yahoo.adsdisplayapi.v20.model.AudienceListServiceMigratedLineAudienceList;
import jp.co.yahoo.adsdisplayapi.v20.model.AudienceListServiceOfferedByLyAudienceList;
import jp.co.yahoo.adsdisplayapi.v20.model.AudienceListServiceSimilarityAudienceList;
import jp.co.yahoo.adsdisplayapi.v20.model.AudienceListServiceType;
import jp.co.yahoo.adsdisplayapi.v20.model.AudienceListServiceWebsiteVisitorsAudienceList;
import jp.co.yahoo.adsdisplayapi.v20.model.AudienceListServiceYahooJapanAudienceDiscoveryAudienceList;
...
@JsonPropertyOrder({
  ...
  AudienceListServiceContent.JSON_PROPERTY_OFFERED_BY_LY_AUDIENCE_LIST,
  AudienceListServiceContent.JSON_PROPERTY_MIGRATED_LINE_AUDIENCE_LIST,
...
public class AudienceListServiceContent {
  ...
  public static final String JSON_PROPERTY_OFFERED_BY_LY_AUDIENCE_LIST = "offeredByLyAudienceList";
  @jakarta.annotation.Nullable
  private AudienceListServiceOfferedByLyAudienceList offeredByLyAudienceList;

  public static final String JSON_PROPERTY_MIGRATED_LINE_AUDIENCE_LIST = "migratedLineAudienceList";
  @jakarta.annotation.Nullable
  private AudienceListServiceMigratedLineAudienceList migratedLineAudienceList;
  ...
  public AudienceListServiceContent offeredByLyAudienceList(@jakarta.annotation.Nullable AudienceListServiceOfferedByLyAudienceList offeredByLyAudienceList) {
    
    this.offeredByLyAudienceList = offeredByLyAudienceList;
    return this;
  }

  /**
   * Get offeredByLyAudienceList
   * @return offeredByLyAudienceList
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_OFFERED_BY_LY_AUDIENCE_LIST, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public AudienceListServiceOfferedByLyAudienceList getOfferedByLyAudienceList() {
    return offeredByLyAudienceList;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_OFFERED_BY_LY_AUDIENCE_LIST, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setOfferedByLyAudienceList(@jakarta.annotation.Nullable AudienceListServiceOfferedByLyAudienceList offeredByLyAudienceList) {
    this.offeredByLyAudienceList = offeredByLyAudienceList;
  }

  public AudienceListServiceContent migratedLineAudienceList(@jakarta.annotation.Nullable AudienceListServiceMigratedLineAudienceList migratedLineAudienceList) {
    
    this.migratedLineAudienceList = migratedLineAudienceList;
    return this;
  }

  /**
   * Get migratedLineAudienceList
   * @return migratedLineAudienceList
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_MIGRATED_LINE_AUDIENCE_LIST, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public AudienceListServiceMigratedLineAudienceList getMigratedLineAudienceList() {
    return migratedLineAudienceList;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_MIGRATED_LINE_AUDIENCE_LIST, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMigratedLineAudienceList(@jakarta.annotation.Nullable AudienceListServiceMigratedLineAudienceList migratedLineAudienceList) {
    this.migratedLineAudienceList = migratedLineAudienceList;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.combinationAudienceList, audienceListServiceContent.combinationAudienceList) &&
        ...
        Objects.equals(this.offeredByLyAudienceList, audienceListServiceContent.offeredByLyAudienceList) &&
        Objects.equals(this.migratedLineAudienceList, audienceListServiceContent.migratedLineAudienceList) &&
  ...
  public String toString() {
    ...
    sb.append("    offeredByLyAudienceList: ").append(toIndentedString(offeredByLyAudienceList)).append("\n");
    sb.append("    migratedLineAudienceList: ").append(toIndentedString(migratedLineAudienceList)).append("\n");
