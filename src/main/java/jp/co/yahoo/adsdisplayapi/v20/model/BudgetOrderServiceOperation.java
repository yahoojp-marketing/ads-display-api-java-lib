...
public class BudgetOrderServiceOperation {
  ...
  public BudgetOrderServiceOperation accountId(@jakarta.annotation.Nonnull Long accountId) {
  ...
  public BudgetOrderServiceOperation operand(@jakarta.annotation.Nonnull List<BudgetOrder> operand) {
  ...
  @JsonProperty(value = JSON_PROPERTY_OPERAND, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setOperand(@jakarta.annotation.Nonnull List<BudgetOrder> operand) {
    this.operand = operand;
  }
