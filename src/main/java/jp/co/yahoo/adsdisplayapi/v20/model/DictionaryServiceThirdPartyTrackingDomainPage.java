...
import jp.co.yahoo.adsdisplayapi.v20.model.DictionaryServiceThirdPartyTrackingDomainValue;
...
public class DictionaryServiceThirdPartyTrackingDomainPage {
  ...
  public DictionaryServiceThirdPartyTrackingDomainPage totalNumEntries(@jakarta.annotation.Nullable Integer totalNumEntries) {
  ...
  public DictionaryServiceThirdPartyTrackingDomainPage values(@jakarta.annotation.Nullable List<DictionaryServiceThirdPartyTrackingDomainValue> values) {
  ...
  @JsonProperty(value = JSON_PROPERTY_VALUES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setValues(@jakarta.annotation.Nullable List<DictionaryServiceThirdPartyTrackingDomainValue> values) {
    this.values = values;
  }
