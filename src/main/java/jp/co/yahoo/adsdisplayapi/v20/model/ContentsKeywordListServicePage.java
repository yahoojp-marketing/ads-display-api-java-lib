...
public class ContentsKeywordListServicePage {
  ...
  public ContentsKeywordListServicePage totalNumEntries(@jakarta.annotation.Nullable Integer totalNumEntries) {
  ...
  public ContentsKeywordListServicePage values(@jakarta.annotation.Nullable List<ContentsKeywordListServiceValue> values) {
