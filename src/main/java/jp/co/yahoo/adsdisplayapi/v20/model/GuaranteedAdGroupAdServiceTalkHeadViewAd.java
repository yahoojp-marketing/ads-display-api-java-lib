...
import jp.co.yahoo.adsdisplayapi.v20.model.GuaranteedAdGroupAdServiceButtonText;
...
@JsonPropertyOrder({
  ...
  GuaranteedAdGroupAdServiceTalkHeadViewAd.JSON_PROPERTY_BUTTON_TEXT,
  GuaranteedAdGroupAdServiceTalkHeadViewAd.JSON_PROPERTY_THUMBNAIL_MEDIA_ID,
  GuaranteedAdGroupAdServiceTalkHeadViewAd.JSON_PROPERTY_VIDEO3_SEC_BEACON_URLS,
  GuaranteedAdGroupAdServiceTalkHeadViewAd.JSON_PROPERTY_VIDEO25_PERCENT_BEACON_URLS,
  GuaranteedAdGroupAdServiceTalkHeadViewAd.JSON_PROPERTY_VIDEO50_PERCENT_BEACON_URLS,
  GuaranteedAdGroupAdServiceTalkHeadViewAd.JSON_PROPERTY_VIDEO75_PERCENT_BEACON_URLS,
  GuaranteedAdGroupAdServiceTalkHeadViewAd.JSON_PROPERTY_VIDEO10_SEC_BEACON_URLS,
  GuaranteedAdGroupAdServiceTalkHeadViewAd.JSON_PROPERTY_VIDEO_COMPLETE_BEACON_URLS,
  GuaranteedAdGroupAdServiceTalkHeadViewAd.JSON_PROPERTY_VIDEO_START_BEACON_URLS
})
...
public class GuaranteedAdGroupAdServiceTalkHeadViewAd {
  ...
  @jakarta.annotation.Nullable
  private GuaranteedAdGroupAdServiceButtonText buttonText;
  ...
  public GuaranteedAdGroupAdServiceTalkHeadViewAd smartphoneFinalUrl(@jakarta.annotation.Nullable String smartphoneFinalUrl) {
  ...
  public GuaranteedAdGroupAdServiceTalkHeadViewAd buttonText(@jakarta.annotation.Nullable GuaranteedAdGroupAdServiceButtonText buttonText) {
  ...
  public GuaranteedAdGroupAdServiceButtonText getButtonText() {
    return buttonText;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_BUTTON_TEXT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setButtonText(@jakarta.annotation.Nullable GuaranteedAdGroupAdServiceButtonText buttonText) {
    this.buttonText = buttonText;
  }

  public GuaranteedAdGroupAdServiceTalkHeadViewAd thumbnailMediaId(@jakarta.annotation.Nullable Long thumbnailMediaId) {
  ...
  public GuaranteedAdGroupAdServiceTalkHeadViewAd video3SecBeaconUrls(@jakarta.annotation.Nullable List<String> video3SecBeaconUrls) {
    
    this.video3SecBeaconUrls = video3SecBeaconUrls;
    return this;
  }

  public GuaranteedAdGroupAdServiceTalkHeadViewAd addVideo3SecBeaconUrlsItem(String video3SecBeaconUrlsItem) {
  ...
  public GuaranteedAdGroupAdServiceTalkHeadViewAd video25PercentBeaconUrls(@jakarta.annotation.Nullable List<String> video25PercentBeaconUrls) {
    
    this.video25PercentBeaconUrls = video25PercentBeaconUrls;
    return this;
  }

  public GuaranteedAdGroupAdServiceTalkHeadViewAd addVideo25PercentBeaconUrlsItem(String video25PercentBeaconUrlsItem) {
  ...
  public GuaranteedAdGroupAdServiceTalkHeadViewAd video50PercentBeaconUrls(@jakarta.annotation.Nullable List<String> video50PercentBeaconUrls) {
    
    this.video50PercentBeaconUrls = video50PercentBeaconUrls;
    return this;
  }

  public GuaranteedAdGroupAdServiceTalkHeadViewAd addVideo50PercentBeaconUrlsItem(String video50PercentBeaconUrlsItem) {
  ...
  public GuaranteedAdGroupAdServiceTalkHeadViewAd video75PercentBeaconUrls(@jakarta.annotation.Nullable List<String> video75PercentBeaconUrls) {
    
    this.video75PercentBeaconUrls = video75PercentBeaconUrls;
    return this;
  }

  public GuaranteedAdGroupAdServiceTalkHeadViewAd addVideo75PercentBeaconUrlsItem(String video75PercentBeaconUrlsItem) {
  ...
  public GuaranteedAdGroupAdServiceTalkHeadViewAd video10SecBeaconUrls(@jakarta.annotation.Nullable List<String> video10SecBeaconUrls) {
    
    this.video10SecBeaconUrls = video10SecBeaconUrls;
    return this;
  }

  public GuaranteedAdGroupAdServiceTalkHeadViewAd addVideo10SecBeaconUrlsItem(String video10SecBeaconUrlsItem) {
  ...
  public GuaranteedAdGroupAdServiceTalkHeadViewAd videoCompleteBeaconUrls(@jakarta.annotation.Nullable List<String> videoCompleteBeaconUrls) {
    
    this.videoCompleteBeaconUrls = videoCompleteBeaconUrls;
    return this;
  }

  public GuaranteedAdGroupAdServiceTalkHeadViewAd addVideoCompleteBeaconUrlsItem(String videoCompleteBeaconUrlsItem) {
  ...
  public GuaranteedAdGroupAdServiceTalkHeadViewAd videoStartBeaconUrls(@jakarta.annotation.Nullable List<String> videoStartBeaconUrls) {
    
    this.videoStartBeaconUrls = videoStartBeaconUrls;
    return this;
  }

  public GuaranteedAdGroupAdServiceTalkHeadViewAd addVideoStartBeaconUrlsItem(String videoStartBeaconUrlsItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.customParameters, guaranteedAdGroupAdServiceTalkHeadViewAd.customParameters) &&
        ...
        Objects.equals(this.buttonText, guaranteedAdGroupAdServiceTalkHeadViewAd.buttonText) &&
        Objects.equals(this.thumbnailMediaId, guaranteedAdGroupAdServiceTalkHeadViewAd.thumbnailMediaId) &&
        Objects.equals(this.video3SecBeaconUrls, guaranteedAdGroupAdServiceTalkHeadViewAd.video3SecBeaconUrls) &&
        Objects.equals(this.video25PercentBeaconUrls, guaranteedAdGroupAdServiceTalkHeadViewAd.video25PercentBeaconUrls) &&
        Objects.equals(this.video50PercentBeaconUrls, guaranteedAdGroupAdServiceTalkHeadViewAd.video50PercentBeaconUrls) &&
        Objects.equals(this.video75PercentBeaconUrls, guaranteedAdGroupAdServiceTalkHeadViewAd.video75PercentBeaconUrls) &&
        Objects.equals(this.video10SecBeaconUrls, guaranteedAdGroupAdServiceTalkHeadViewAd.video10SecBeaconUrls) &&
        Objects.equals(this.videoCompleteBeaconUrls, guaranteedAdGroupAdServiceTalkHeadViewAd.videoCompleteBeaconUrls) &&
        Objects.equals(this.videoStartBeaconUrls, guaranteedAdGroupAdServiceTalkHeadViewAd.videoStartBeaconUrls);
  }

  @Override
  public int hashCode() {
    return Objects.hash(customParameters, displayUrl, displayUrlLevel, finalUrl, smartphoneFinalUrl, trackingUrl, buttonText, thumbnailMediaId, video3SecBeaconUrls, video25PercentBeaconUrls, video50PercentBeaconUrls, video75PercentBeaconUrls, video10SecBeaconUrls, videoCompleteBeaconUrls, videoStartBeaconUrls);
  }
