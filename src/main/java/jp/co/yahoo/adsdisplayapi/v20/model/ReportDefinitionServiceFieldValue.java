...
import jp.co.yahoo.adsdisplayapi.v20.model.ReportDefinitionServiceFieldAttribute;
...
public class ReportDefinitionServiceFieldValue {
  ...
  @jakarta.annotation.Nullable
  private List<ReportDefinitionServiceFieldAttribute> fields;
  ...
  public ReportDefinitionServiceFieldValue errors(@jakarta.annotation.Nullable List<Error> errors) {
  ...
  public ReportDefinitionServiceFieldValue fields(@jakarta.annotation.Nullable List<ReportDefinitionServiceFieldAttribute> fields) {
  ...
  @JsonProperty(value = JSON_PROPERTY_FIELDS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFields(@jakarta.annotation.Nullable List<ReportDefinitionServiceFieldAttribute> fields) {
    this.fields = fields;
  }

  public ReportDefinitionServiceFieldValue operationSucceeded(@jakarta.annotation.Nullable Boolean operationSucceeded) {
