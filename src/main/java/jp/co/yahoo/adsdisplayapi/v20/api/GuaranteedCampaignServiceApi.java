...
import jp.co.yahoo.adsdisplayapi.v20.model.GuaranteedCampaignServiceGetResponse;
import jp.co.yahoo.adsdisplayapi.v20.model.GuaranteedCampaignServiceSelector;
...
@Component("jp.co.yahoo.adsdisplayapi.v20.api.GuaranteedCampaignServiceApi")
public class GuaranteedCampaignServiceApi extends BaseApi {
     ...
     * @param guaranteedCampaignServiceSelector  (optional)
     * @return GuaranteedCampaignServiceGetResponse
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public GuaranteedCampaignServiceGetResponse guaranteedCampaignServiceGetPost(Long xZBaseAccountId, GuaranteedCampaignServiceSelector guaranteedCampaignServiceSelector) throws RestClientException {
        return guaranteedCampaignServiceGetPostWithHttpInfo(xZBaseAccountId, guaranteedCampaignServiceSelector).getBody();
    }
     ...
     * @param xZBaseAccountId &lt;div lang&#x3D;\&quot;ja\&quot;&gt;アカウントIDを指定してください。&lt;/div&gt; &lt;div lang&#x3D;\&quot;en\&quot;&gt;Specify Account ID.&lt;/div&gt;  (required)
     * @param guaranteedCampaignServiceSelector  (optional)
     * @return ResponseEntity&lt;GuaranteedCampaignServiceGetResponse&gt;
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<GuaranteedCampaignServiceGetResponse> guaranteedCampaignServiceGetPostWithHttpInfo(Long xZBaseAccountId, GuaranteedCampaignServiceSelector guaranteedCampaignServiceSelector) throws RestClientException {
        Object localVarPostBody = guaranteedCampaignServiceSelector;
        
        // verify the required parameter 'xZBaseAccountId' is set
        if (xZBaseAccountId == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'xZBaseAccountId' when calling guaranteedCampaignServiceGetPost");
        }
