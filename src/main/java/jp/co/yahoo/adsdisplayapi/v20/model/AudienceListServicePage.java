...
import jp.co.yahoo.adsdisplayapi.v20.model.AudienceListServiceValue;
...
public class AudienceListServicePage {
  ...
  public AudienceListServicePage totalNumEntries(@jakarta.annotation.Nullable Integer totalNumEntries) {
  ...
  public AudienceListServicePage values(@jakarta.annotation.Nullable List<AudienceListServiceValue> values) {
  ...
  @JsonProperty(value = JSON_PROPERTY_VALUES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setValues(@jakarta.annotation.Nullable List<AudienceListServiceValue> values) {
    this.values = values;
  }
