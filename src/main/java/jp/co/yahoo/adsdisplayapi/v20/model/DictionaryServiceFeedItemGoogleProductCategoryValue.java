...
import jp.co.yahoo.adsdisplayapi.v20.model.DictionaryServiceFeedItemGoogleProductCategory;
...
public class DictionaryServiceFeedItemGoogleProductCategoryValue {
  ...
  public DictionaryServiceFeedItemGoogleProductCategoryValue errors(@jakarta.annotation.Nullable List<Error> errors) {
  ...
  public DictionaryServiceFeedItemGoogleProductCategoryValue feedItemGoogleProductCategory(@jakarta.annotation.Nullable DictionaryServiceFeedItemGoogleProductCategory feedItemGoogleProductCategory) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_FEED_ITEM_GOOGLE_PRODUCT_CATEGORY, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_FEED_ITEM_GOOGLE_PRODUCT_CATEGORY, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFeedItemGoogleProductCategory(@jakarta.annotation.Nullable DictionaryServiceFeedItemGoogleProductCategory feedItemGoogleProductCategory) {
    this.feedItemGoogleProductCategory = feedItemGoogleProductCategory;
  }

  public DictionaryServiceFeedItemGoogleProductCategoryValue operationSucceeded(@jakarta.annotation.Nullable Boolean operationSucceeded) {
