...
import jp.co.yahoo.adsdisplayapi.v20.model.AccountLink;
...
public class AccountLinkServiceValue {
  ...
  public AccountLinkServiceValue accountLink(@jakarta.annotation.Nullable AccountLink accountLink) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_ACCOUNT_LINK, required = false)
  ...
  @JsonProperty(value = JSON_PROPERTY_ACCOUNT_LINK, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAccountLink(@jakarta.annotation.Nullable AccountLink accountLink) {
    this.accountLink = accountLink;
  }

  public AccountLinkServiceValue errors(@jakarta.annotation.Nullable List<Error> errors) {
  ...
  public AccountLinkServiceValue operationSucceeded(@jakarta.annotation.Nullable Boolean operationSucceeded) {
