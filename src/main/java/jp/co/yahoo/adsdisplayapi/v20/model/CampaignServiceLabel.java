...
public class CampaignServiceLabel {
  ...
  public CampaignServiceLabel color(@jakarta.annotation.Nullable String color) {
  ...
  public CampaignServiceLabel description(@jakarta.annotation.Nullable String description) {
  ...
  public CampaignServiceLabel labelId(@jakarta.annotation.Nullable Long labelId) {
  ...
  public CampaignServiceLabel labelName(@jakarta.annotation.Nullable String labelName) {
