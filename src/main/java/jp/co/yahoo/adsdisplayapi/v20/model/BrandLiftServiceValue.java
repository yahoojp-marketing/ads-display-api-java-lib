...
import jp.co.yahoo.adsdisplayapi.v20.model.BrandLift;
...
public class BrandLiftServiceValue {
  ...
  public BrandLiftServiceValue brandLift(@jakarta.annotation.Nullable BrandLift brandLift) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_BRAND_LIFT, required = false)
  ...
  @JsonProperty(value = JSON_PROPERTY_BRAND_LIFT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setBrandLift(@jakarta.annotation.Nullable BrandLift brandLift) {
    this.brandLift = brandLift;
  }

  public BrandLiftServiceValue errors(@jakarta.annotation.Nullable List<Error> errors) {
  ...
  public BrandLiftServiceValue operationSucceeded(@jakarta.annotation.Nullable Boolean operationSucceeded) {
