...
import jp.co.yahoo.adsdisplayapi.v20.model.AdGroupAdServiceAdType;
import jp.co.yahoo.adsdisplayapi.v20.model.AdGroupAdServiceBannerAd;
import jp.co.yahoo.adsdisplayapi.v20.model.AdGroupAdServiceCarouselAd;
import jp.co.yahoo.adsdisplayapi.v20.model.AdGroupAdServiceCarouselGainFriendsAd;
import jp.co.yahoo.adsdisplayapi.v20.model.AdGroupAdServiceCustomParameters;
import jp.co.yahoo.adsdisplayapi.v20.model.AdGroupAdServiceDisplayUrlLevel;
import jp.co.yahoo.adsdisplayapi.v20.model.AdGroupAdServiceDynamicDisplayAd;
import jp.co.yahoo.adsdisplayapi.v20.model.AdGroupAdServiceInstreamAd;
import jp.co.yahoo.adsdisplayapi.v20.model.AdGroupAdServiceIsRemoveFlg;
import jp.co.yahoo.adsdisplayapi.v20.model.AdGroupAdServiceMainMediaFormat;
import jp.co.yahoo.adsdisplayapi.v20.model.AdGroupAdServiceResponsiveAd;
import jp.co.yahoo.adsdisplayapi.v20.model.AdGroupAdServiceResponsiveGainFriendsAd;
import jp.co.yahoo.adsdisplayapi.v20.model.AdGroupAdServiceResponsiveThankyouPageAd;
import jp.co.yahoo.adsdisplayapi.v20.model.AdGroupAdServiceResponsiveThankyouPageListAd;
import jp.co.yahoo.adsdisplayapi.v20.model.AdGroupAdServiceTextAd;
...
@JsonPropertyOrder({
  ...
  AdGroupAdServiceAd.JSON_PROPERTY_RESPONSIVE_THANKYOU_PAGE_AD,
  AdGroupAdServiceAd.JSON_PROPERTY_RESPONSIVE_THANKYOU_PAGE_LIST_AD,
...
public class AdGroupAdServiceAd {
  ...
  public static final String JSON_PROPERTY_RESPONSIVE_THANKYOU_PAGE_AD = "responsiveThankyouPageAd";
  @jakarta.annotation.Nullable
  private AdGroupAdServiceResponsiveThankyouPageAd responsiveThankyouPageAd;

  public static final String JSON_PROPERTY_RESPONSIVE_THANKYOU_PAGE_LIST_AD = "responsiveThankyouPageListAd";
  @jakarta.annotation.Nullable
  private AdGroupAdServiceResponsiveThankyouPageListAd responsiveThankyouPageListAd;
  ...
  public AdGroupAdServiceAd responsiveThankyouPageAd(@jakarta.annotation.Nullable AdGroupAdServiceResponsiveThankyouPageAd responsiveThankyouPageAd) {
    
    this.responsiveThankyouPageAd = responsiveThankyouPageAd;
    return this;
  }

  /**
   * Get responsiveThankyouPageAd
   * @return responsiveThankyouPageAd
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_RESPONSIVE_THANKYOU_PAGE_AD, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public AdGroupAdServiceResponsiveThankyouPageAd getResponsiveThankyouPageAd() {
    return responsiveThankyouPageAd;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_RESPONSIVE_THANKYOU_PAGE_AD, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponsiveThankyouPageAd(@jakarta.annotation.Nullable AdGroupAdServiceResponsiveThankyouPageAd responsiveThankyouPageAd) {
    this.responsiveThankyouPageAd = responsiveThankyouPageAd;
  }

  public AdGroupAdServiceAd responsiveThankyouPageListAd(@jakarta.annotation.Nullable AdGroupAdServiceResponsiveThankyouPageListAd responsiveThankyouPageListAd) {
    
    this.responsiveThankyouPageListAd = responsiveThankyouPageListAd;
    return this;
  }

  /**
   * Get responsiveThankyouPageListAd
   * @return responsiveThankyouPageListAd
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_RESPONSIVE_THANKYOU_PAGE_LIST_AD, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public AdGroupAdServiceResponsiveThankyouPageListAd getResponsiveThankyouPageListAd() {
    return responsiveThankyouPageListAd;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_RESPONSIVE_THANKYOU_PAGE_LIST_AD, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponsiveThankyouPageListAd(@jakarta.annotation.Nullable AdGroupAdServiceResponsiveThankyouPageListAd responsiveThankyouPageListAd) {
    this.responsiveThankyouPageListAd = responsiveThankyouPageListAd;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.adType, adGroupAdServiceAd.adType) &&
        ...
        Objects.equals(this.responsiveThankyouPageAd, adGroupAdServiceAd.responsiveThankyouPageAd) &&
        Objects.equals(this.responsiveThankyouPageListAd, adGroupAdServiceAd.responsiveThankyouPageListAd) &&
  ...
  public String toString() {
    ...
    sb.append("    responsiveThankyouPageAd: ").append(toIndentedString(responsiveThankyouPageAd)).append("\n");
    sb.append("    responsiveThankyouPageListAd: ").append(toIndentedString(responsiveThankyouPageListAd)).append("\n");
