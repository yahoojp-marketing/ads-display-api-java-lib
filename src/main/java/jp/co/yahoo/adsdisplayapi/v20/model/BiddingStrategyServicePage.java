...
public class BiddingStrategyServicePage {
  ...
  public BiddingStrategyServicePage totalNumEntries(@jakarta.annotation.Nullable Integer totalNumEntries) {
  ...
  public BiddingStrategyServicePage values(@jakarta.annotation.Nullable List<BiddingStrategyServiceValue> values) {
