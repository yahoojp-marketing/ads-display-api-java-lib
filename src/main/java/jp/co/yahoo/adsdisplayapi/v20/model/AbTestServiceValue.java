...
public class AbTestServiceValue {
  ...
  public AbTestServiceValue abTest(@jakarta.annotation.Nullable AbTest abTest) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_AB_TEST, required = false)
  ...
  @JsonProperty(value = JSON_PROPERTY_AB_TEST, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAbTest(@jakarta.annotation.Nullable AbTest abTest) {
    this.abTest = abTest;
  }

  public AbTestServiceValue errors(@jakarta.annotation.Nullable List<Error> errors) {
  ...
  public AbTestServiceValue operationSucceeded(@jakarta.annotation.Nullable Boolean operationSucceeded) {
