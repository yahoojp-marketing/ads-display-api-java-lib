...
import jp.co.yahoo.adsdisplayapi.v20.model.ContentsKeywordListServicePage;
...
public class ContentsKeywordListServiceGetResponse {
  ...
  public ContentsKeywordListServiceGetResponse errors(@jakarta.annotation.Nullable List<Error> errors) {
  ...
  public ContentsKeywordListServiceGetResponse rid(@jakarta.annotation.Nullable String rid) {
  ...
  public ContentsKeywordListServiceGetResponse rval(@jakarta.annotation.Nullable ContentsKeywordListServicePage rval) {
  ...
  @JsonProperty(value = JSON_PROPERTY_RVAL, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRval(@jakarta.annotation.Nullable ContentsKeywordListServicePage rval) {
    this.rval = rval;
  }
