...
import jp.co.yahoo.adsdisplayapi.v20.model.TrackingTagServiceGetResponse;
import jp.co.yahoo.adsdisplayapi.v20.model.TrackingTagServiceSelector;
...
@Component("jp.co.yahoo.adsdisplayapi.v20.api.TrackingTagServiceApi")
public class TrackingTagServiceApi extends BaseApi {

    public TrackingTagServiceApi() {
        super(new ApiClient());
    }

    @Autowired
    public TrackingTagServiceApi(ApiClient apiClient) {
        super(apiClient);
    }
     ...
     * @param trackingTagServiceSelector  (optional)
     * @return TrackingTagServiceGetResponse
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public TrackingTagServiceGetResponse trackingTagServiceGetPost(Long xZBaseAccountId, TrackingTagServiceSelector trackingTagServiceSelector) throws RestClientException {
        return trackingTagServiceGetPostWithHttpInfo(xZBaseAccountId, trackingTagServiceSelector).getBody();
    }
     ...
     * @param xZBaseAccountId &lt;div lang&#x3D;\&quot;ja\&quot;&gt;アカウントIDを指定してください。&lt;/div&gt; &lt;div lang&#x3D;\&quot;en\&quot;&gt;Specify Account ID.&lt;/div&gt;  (required)
     * @param trackingTagServiceSelector  (optional)
     * @return ResponseEntity&lt;TrackingTagServiceGetResponse&gt;
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<TrackingTagServiceGetResponse> trackingTagServiceGetPostWithHttpInfo(Long xZBaseAccountId, TrackingTagServiceSelector trackingTagServiceSelector) throws RestClientException {
        Object localVarPostBody = trackingTagServiceSelector;
        
        // verify the required parameter 'xZBaseAccountId' is set
        if (xZBaseAccountId == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'xZBaseAccountId' when calling trackingTagServiceGetPost");
        }
        ...
        ParameterizedTypeReference<TrackingTagServiceGetResponse> localReturnType = new ParameterizedTypeReference<TrackingTagServiceGetResponse>() {};
        return apiClient.invokeAPI("/TrackingTagService/get", HttpMethod.POST, Collections.<String, Object>emptyMap(), localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localReturnType);
    }
