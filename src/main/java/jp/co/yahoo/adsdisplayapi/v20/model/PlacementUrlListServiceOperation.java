...
import jp.co.yahoo.adsdisplayapi.v20.model.PlacementUrlList;
...
public class PlacementUrlListServiceOperation {
  ...
  public PlacementUrlListServiceOperation accountId(@jakarta.annotation.Nonnull Long accountId) {
  ...
  public PlacementUrlListServiceOperation operand(@jakarta.annotation.Nonnull List<PlacementUrlList> operand) {
  ...
  @JsonProperty(value = JSON_PROPERTY_OPERAND, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setOperand(@jakarta.annotation.Nonnull List<PlacementUrlList> operand) {
    this.operand = operand;
  }
