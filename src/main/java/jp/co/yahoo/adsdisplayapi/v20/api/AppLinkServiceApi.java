...
import jp.co.yahoo.adsdisplayapi.v20.model.AppLinkServiceGetResponse;
import jp.co.yahoo.adsdisplayapi.v20.model.AppLinkServiceSelector;
...
@Component("jp.co.yahoo.adsdisplayapi.v20.api.AppLinkServiceApi")
public class AppLinkServiceApi extends BaseApi {
    ...
    public ResponseEntity<AppLinkServiceGetResponse> appLinkServiceGetPostWithHttpInfo(Long xZBaseAccountId, AppLinkServiceSelector appLinkServiceSelector) throws RestClientException {
        Object localVarPostBody = appLinkServiceSelector;
        ...
        ParameterizedTypeReference<AppLinkServiceGetResponse> localReturnType = new ParameterizedTypeReference<AppLinkServiceGetResponse>() {};
        return apiClient.invokeAPI("/AppLinkService/get", HttpMethod.POST, Collections.<String, Object>emptyMap(), localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localReturnType);
    }
