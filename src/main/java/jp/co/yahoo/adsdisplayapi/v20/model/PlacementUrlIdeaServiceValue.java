...
import jp.co.yahoo.adsdisplayapi.v20.model.PlacementUrlIdea;
...
public class PlacementUrlIdeaServiceValue {
  ...
  public PlacementUrlIdeaServiceValue errors(@jakarta.annotation.Nullable List<Error> errors) {
  ...
  public PlacementUrlIdeaServiceValue operationSucceeded(@jakarta.annotation.Nullable Boolean operationSucceeded) {
  ...
  public PlacementUrlIdeaServiceValue placementUrlIdea(@jakarta.annotation.Nullable PlacementUrlIdea placementUrlIdea) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_PLACEMENT_URL_IDEA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_PLACEMENT_URL_IDEA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPlacementUrlIdea(@jakarta.annotation.Nullable PlacementUrlIdea placementUrlIdea) {
    this.placementUrlIdea = placementUrlIdea;
  }
