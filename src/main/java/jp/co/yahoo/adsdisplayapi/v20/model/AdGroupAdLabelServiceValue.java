...
import jp.co.yahoo.adsdisplayapi.v20.model.AdGroupAdLabel;
...
public class AdGroupAdLabelServiceValue {
  ...
  public AdGroupAdLabelServiceValue adGroupAdLabel(@jakarta.annotation.Nullable AdGroupAdLabel adGroupAdLabel) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_AD_GROUP_AD_LABEL, required = false)
  ...
  @JsonProperty(value = JSON_PROPERTY_AD_GROUP_AD_LABEL, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAdGroupAdLabel(@jakarta.annotation.Nullable AdGroupAdLabel adGroupAdLabel) {
    this.adGroupAdLabel = adGroupAdLabel;
  }

  public AdGroupAdLabelServiceValue errors(@jakarta.annotation.Nullable List<Error> errors) {
  ...
  public AdGroupAdLabelServiceValue operationSucceeded(@jakarta.annotation.Nullable Boolean operationSucceeded) {
