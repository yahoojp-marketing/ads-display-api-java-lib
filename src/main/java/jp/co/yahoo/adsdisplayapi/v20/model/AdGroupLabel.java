...
public class AdGroupLabel {
  ...
  public AdGroupLabel accountId(@jakarta.annotation.Nullable Long accountId) {
  ...
  public AdGroupLabel adGroupId(@jakarta.annotation.Nullable Long adGroupId) {
  ...
  public AdGroupLabel campaignId(@jakarta.annotation.Nullable Long campaignId) {
  ...
  public AdGroupLabel labelId(@jakarta.annotation.Nullable Long labelId) {
