...
import jp.co.yahoo.adsdisplayapi.v20.model.BudgetOrderServiceValue;
...
public class BudgetOrderServicePage {
  ...
  public BudgetOrderServicePage totalNumEntries(@jakarta.annotation.Nullable Integer totalNumEntries) {
  ...
  public BudgetOrderServicePage values(@jakarta.annotation.Nullable List<BudgetOrderServiceValue> values) {
  ...
  @JsonProperty(value = JSON_PROPERTY_VALUES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setValues(@jakarta.annotation.Nullable List<BudgetOrderServiceValue> values) {
    this.values = values;
  }
