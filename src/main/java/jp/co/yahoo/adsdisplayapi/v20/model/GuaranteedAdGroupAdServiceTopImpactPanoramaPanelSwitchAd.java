...
import jp.co.yahoo.adsdisplayapi.v20.model.GuaranteedAdGroupAdServiceTopImpactPanoramaPanelSwitch;
...
public class GuaranteedAdGroupAdServiceTopImpactPanoramaPanelSwitchAd {
  ...
  @jakarta.annotation.Nullable
  private List<GuaranteedAdGroupAdServiceTopImpactPanoramaPanelSwitch> panels;
  ...
  public GuaranteedAdGroupAdServiceTopImpactPanoramaPanelSwitchAd adShrinkMainMediaId(@jakarta.annotation.Nullable Long adShrinkMainMediaId) {
  ...
  public GuaranteedAdGroupAdServiceTopImpactPanoramaPanelSwitchAd panels(@jakarta.annotation.Nullable List<GuaranteedAdGroupAdServiceTopImpactPanoramaPanelSwitch> panels) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_PANELS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_PANELS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPanels(@jakarta.annotation.Nullable List<GuaranteedAdGroupAdServiceTopImpactPanoramaPanelSwitch> panels) {
    this.panels = panels;
  }

  public GuaranteedAdGroupAdServiceTopImpactPanoramaPanelSwitchAd finalUrl(@jakarta.annotation.Nullable String finalUrl) {
  ...
  public GuaranteedAdGroupAdServiceTopImpactPanoramaPanelSwitchAd displayUrlLevel(@jakarta.annotation.Nullable GuaranteedAdGroupAdServiceDisplayUrlLevel displayUrlLevel) {
  ...
  public GuaranteedAdGroupAdServiceTopImpactPanoramaPanelSwitchAd customParameters(@jakarta.annotation.Nullable GuaranteedAdGroupAdServiceCustomParameters customParameters) {
  ...
  public GuaranteedAdGroupAdServiceTopImpactPanoramaPanelSwitchAd trackingUrl(@jakarta.annotation.Nullable String trackingUrl) {
