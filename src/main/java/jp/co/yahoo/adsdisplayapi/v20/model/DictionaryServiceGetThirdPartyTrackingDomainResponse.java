...
import jp.co.yahoo.adsdisplayapi.v20.model.DictionaryServiceThirdPartyTrackingDomainPage;
...
public class DictionaryServiceGetThirdPartyTrackingDomainResponse {
  ...
  public DictionaryServiceGetThirdPartyTrackingDomainResponse errors(@jakarta.annotation.Nullable List<Error> errors) {
  ...
  public DictionaryServiceGetThirdPartyTrackingDomainResponse rid(@jakarta.annotation.Nullable String rid) {
  ...
  public DictionaryServiceGetThirdPartyTrackingDomainResponse rval(@jakarta.annotation.Nullable DictionaryServiceThirdPartyTrackingDomainPage rval) {
  ...
  @JsonProperty(value = JSON_PROPERTY_RVAL, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRval(@jakarta.annotation.Nullable DictionaryServiceThirdPartyTrackingDomainPage rval) {
    this.rval = rval;
  }
