...
public class MediaServiceValue {
  ...
  public MediaServiceValue errors(@jakarta.annotation.Nullable List<Error> errors) {
  ...
  public MediaServiceValue operationSucceeded(@jakarta.annotation.Nullable Boolean operationSucceeded) {
  ...
  public MediaServiceValue mediaRecord(@jakarta.annotation.Nullable MediaServiceRecord mediaRecord) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_MEDIA_RECORD, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_MEDIA_RECORD, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMediaRecord(@jakarta.annotation.Nullable MediaServiceRecord mediaRecord) {
    this.mediaRecord = mediaRecord;
  }
