...
import jp.co.yahoo.adsdisplayapi.v20.model.AccountServiceReturnValue;
...
public class AccountServiceMutateResponse {
  ...
  public AccountServiceMutateResponse errors(@jakarta.annotation.Nullable List<Error> errors) {
  ...
  public AccountServiceMutateResponse rid(@jakarta.annotation.Nullable String rid) {
  ...
  public AccountServiceMutateResponse rval(@jakarta.annotation.Nullable AccountServiceReturnValue rval) {
  ...
  @JsonProperty(value = JSON_PROPERTY_RVAL, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRval(@jakarta.annotation.Nullable AccountServiceReturnValue rval) {
    this.rval = rval;
  }
