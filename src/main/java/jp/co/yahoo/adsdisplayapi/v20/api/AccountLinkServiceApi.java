...
import jp.co.yahoo.adsdisplayapi.v20.model.AccountLinkServiceGetResponse;
import jp.co.yahoo.adsdisplayapi.v20.model.AccountLinkServiceSelector;
...
@Component("jp.co.yahoo.adsdisplayapi.v20.api.AccountLinkServiceApi")
public class AccountLinkServiceApi extends BaseApi {

    public AccountLinkServiceApi() {
        super(new ApiClient());
    }

    @Autowired
    public AccountLinkServiceApi(ApiClient apiClient) {
        super(apiClient);
    }
     ...
     * @param accountLinkServiceSelector  (optional)
     * @return AccountLinkServiceGetResponse
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public AccountLinkServiceGetResponse accountLinkServiceGetPost(Long xZBaseAccountId, AccountLinkServiceSelector accountLinkServiceSelector) throws RestClientException {
        return accountLinkServiceGetPostWithHttpInfo(xZBaseAccountId, accountLinkServiceSelector).getBody();
    }
     ...
     * @param xZBaseAccountId &lt;div lang&#x3D;\&quot;ja\&quot;&gt;アカウントIDを指定してください。&lt;/div&gt; &lt;div lang&#x3D;\&quot;en\&quot;&gt;Specify Account ID.&lt;/div&gt;  (required)
     * @param accountLinkServiceSelector  (optional)
     * @return ResponseEntity&lt;AccountLinkServiceGetResponse&gt;
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<AccountLinkServiceGetResponse> accountLinkServiceGetPostWithHttpInfo(Long xZBaseAccountId, AccountLinkServiceSelector accountLinkServiceSelector) throws RestClientException {
        Object localVarPostBody = accountLinkServiceSelector;
        
        // verify the required parameter 'xZBaseAccountId' is set
        if (xZBaseAccountId == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'xZBaseAccountId' when calling accountLinkServiceGetPost");
        }
        ...
        ParameterizedTypeReference<AccountLinkServiceGetResponse> localReturnType = new ParameterizedTypeReference<AccountLinkServiceGetResponse>() {};
        return apiClient.invokeAPI("/AccountLinkService/get", HttpMethod.POST, Collections.<String, Object>emptyMap(), localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localReturnType);
    }
