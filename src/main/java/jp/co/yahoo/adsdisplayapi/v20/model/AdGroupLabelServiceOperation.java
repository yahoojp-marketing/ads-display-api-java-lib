...
public class AdGroupLabelServiceOperation {
  ...
  public AdGroupLabelServiceOperation accountId(@jakarta.annotation.Nonnull Long accountId) {
  ...
  public AdGroupLabelServiceOperation operand(@jakarta.annotation.Nonnull List<AdGroupLabel> operand) {
  ...
  @JsonProperty(value = JSON_PROPERTY_OPERAND, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setOperand(@jakarta.annotation.Nonnull List<AdGroupLabel> operand) {
    this.operand = operand;
  }
