...
import jp.co.yahoo.adsdisplayapi.v20.model.RetargetingTagServiceReturnValue;
...
public class RetargetingTagServiceMutateResponse {
  ...
  public RetargetingTagServiceMutateResponse errors(@jakarta.annotation.Nullable List<Error> errors) {
  ...
  public RetargetingTagServiceMutateResponse rid(@jakarta.annotation.Nullable String rid) {
  ...
  public RetargetingTagServiceMutateResponse rval(@jakarta.annotation.Nullable RetargetingTagServiceReturnValue rval) {
  ...
  @JsonProperty(value = JSON_PROPERTY_RVAL, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRval(@jakarta.annotation.Nullable RetargetingTagServiceReturnValue rval) {
    this.rval = rval;
  }
