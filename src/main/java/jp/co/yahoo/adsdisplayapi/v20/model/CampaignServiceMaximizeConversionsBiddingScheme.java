...
import jp.co.yahoo.adsdisplayapi.v20.model.CampaignServiceSkanTcpaTargetType;
...
public class CampaignServiceMaximizeConversionsBiddingScheme {
  ...
  public CampaignServiceMaximizeConversionsBiddingScheme targetCpa(@jakarta.annotation.Nullable Long targetCpa) {
  ...
  public CampaignServiceMaximizeConversionsBiddingScheme skanTcpaTargetType(@jakarta.annotation.Nullable CampaignServiceSkanTcpaTargetType skanTcpaTargetType) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_SKAN_TCPA_TARGET_TYPE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_SKAN_TCPA_TARGET_TYPE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSkanTcpaTargetType(@jakarta.annotation.Nullable CampaignServiceSkanTcpaTargetType skanTcpaTargetType) {
    this.skanTcpaTargetType = skanTcpaTargetType;
  }
