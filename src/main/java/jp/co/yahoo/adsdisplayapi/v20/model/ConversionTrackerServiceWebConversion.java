...
import jp.co.yahoo.adsdisplayapi.v20.model.ConversionTrackerServiceWebConversionSnippet;
...
public class ConversionTrackerServiceWebConversion {
  ...
  public ConversionTrackerServiceWebConversion snippet(@jakarta.annotation.Nullable List<ConversionTrackerServiceWebConversionSnippet> snippet) {
  ...
  @JsonProperty(value = JSON_PROPERTY_SNIPPET, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSnippet(@jakarta.annotation.Nullable List<ConversionTrackerServiceWebConversionSnippet> snippet) {
    this.snippet = snippet;
  }
