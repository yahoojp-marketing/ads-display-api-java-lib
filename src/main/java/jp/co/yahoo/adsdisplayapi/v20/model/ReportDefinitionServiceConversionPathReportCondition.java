...
import jp.co.yahoo.adsdisplayapi.v20.model.ReportDefinitionServiceConversionPathFilter;
...
public class ReportDefinitionServiceConversionPathReportCondition {
  ...
  public ReportDefinitionServiceConversionPathReportCondition lookbackWindow(@jakarta.annotation.Nullable Long lookbackWindow) {
  ...
  public ReportDefinitionServiceConversionPathReportCondition includeViewInteraction(@jakarta.annotation.Nullable ReportDefinitionServiceIncludeViewInteractionFlg includeViewInteraction) {
  ...
  public ReportDefinitionServiceConversionPathReportCondition conversionPathFilters(@jakarta.annotation.Nullable List<ReportDefinitionServiceConversionPathFilter> conversionPathFilters) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_CONVERSION_PATH_FILTERS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_CONVERSION_PATH_FILTERS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setConversionPathFilters(@jakarta.annotation.Nullable List<ReportDefinitionServiceConversionPathFilter> conversionPathFilters) {
    this.conversionPathFilters = conversionPathFilters;
  }
