...
public class AccountAuthorityServiceSelector {
  ...
  public AccountAuthorityServiceSelector accountIds(@jakarta.annotation.Nonnull List<Long> accountIds) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ACCOUNT_IDS, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setAccountIds(@jakarta.annotation.Nonnull List<Long> accountIds) {
    this.accountIds = accountIds;
  }

  public AccountAuthorityServiceSelector numberResults(@jakarta.annotation.Nullable Integer numberResults) {
  ...
  public AccountAuthorityServiceSelector startIndex(@jakarta.annotation.Nullable Integer startIndex) {
