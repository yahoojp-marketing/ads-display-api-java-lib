...
public class AdGroupTargetServiceValue {
  ...
  public AdGroupTargetServiceValue adGroupTargetList(@jakarta.annotation.Nullable AdGroupTarget adGroupTargetList) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_AD_GROUP_TARGET_LIST, required = false)
  ...
  @JsonProperty(value = JSON_PROPERTY_AD_GROUP_TARGET_LIST, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAdGroupTargetList(@jakarta.annotation.Nullable AdGroupTarget adGroupTargetList) {
    this.adGroupTargetList = adGroupTargetList;
  }

  public AdGroupTargetServiceValue errors(@jakarta.annotation.Nullable List<Error> errors) {
  ...
  public AdGroupTargetServiceValue operationSucceeded(@jakarta.annotation.Nullable Boolean operationSucceeded) {
