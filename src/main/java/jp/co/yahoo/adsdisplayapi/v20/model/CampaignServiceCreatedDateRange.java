...
public class CampaignServiceCreatedDateRange {
  ...
  public CampaignServiceCreatedDateRange startDate(@jakarta.annotation.Nullable String startDate) {
  ...
  public CampaignServiceCreatedDateRange endDate(@jakarta.annotation.Nullable String endDate) {
