...
import jp.co.yahoo.adsdisplayapi.v20.model.EstimatedUserSize;
...
public class EstimatedUserSizeServiceValue {
  ...
  public EstimatedUserSizeServiceValue errors(@jakarta.annotation.Nullable List<Error> errors) {
  ...
  public EstimatedUserSizeServiceValue estimatedUserSize(@jakarta.annotation.Nullable EstimatedUserSize estimatedUserSize) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ESTIMATED_USER_SIZE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEstimatedUserSize(@jakarta.annotation.Nullable EstimatedUserSize estimatedUserSize) {
    this.estimatedUserSize = estimatedUserSize;
  }

  public EstimatedUserSizeServiceValue operationSucceeded(@jakarta.annotation.Nullable Boolean operationSucceeded) {
