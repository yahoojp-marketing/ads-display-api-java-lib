...
public class ConversionGroupServiceValue {
  ...
  public ConversionGroupServiceValue conversionGroup(@jakarta.annotation.Nullable ConversionGroup conversionGroup) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_CONVERSION_GROUP, required = false)
  ...
  @JsonProperty(value = JSON_PROPERTY_CONVERSION_GROUP, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setConversionGroup(@jakarta.annotation.Nullable ConversionGroup conversionGroup) {
    this.conversionGroup = conversionGroup;
  }

  public ConversionGroupServiceValue errors(@jakarta.annotation.Nullable List<Error> errors) {
  ...
  public ConversionGroupServiceValue operationSucceeded(@jakarta.annotation.Nullable Boolean operationSucceeded) {
