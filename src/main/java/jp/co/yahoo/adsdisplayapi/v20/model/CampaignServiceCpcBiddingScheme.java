...
import jp.co.yahoo.adsdisplayapi.v20.model.CampaignServiceEnhancedCpcEnabled;
...
public class CampaignServiceCpcBiddingScheme {
  ...
  public CampaignServiceCpcBiddingScheme cpc(@jakarta.annotation.Nullable Long cpc) {
  ...
  public CampaignServiceCpcBiddingScheme enhancedCpcEnabled(@jakarta.annotation.Nullable CampaignServiceEnhancedCpcEnabled enhancedCpcEnabled) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENHANCED_CPC_ENABLED, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEnhancedCpcEnabled(@jakarta.annotation.Nullable CampaignServiceEnhancedCpcEnabled enhancedCpcEnabled) {
    this.enhancedCpcEnabled = enhancedCpcEnabled;
  }
