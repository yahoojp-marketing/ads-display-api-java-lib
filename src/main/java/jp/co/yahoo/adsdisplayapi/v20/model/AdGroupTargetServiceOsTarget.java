...
import jp.co.yahoo.adsdisplayapi.v20.model.AdGroupTargetServiceDeviceOsType;
...
public class AdGroupTargetServiceOsTarget {
  ...
  public AdGroupTargetServiceOsTarget deviceOsType(@jakarta.annotation.Nullable AdGroupTargetServiceDeviceOsType deviceOsType) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DEVICE_OS_TYPE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDeviceOsType(@jakarta.annotation.Nullable AdGroupTargetServiceDeviceOsType deviceOsType) {
    this.deviceOsType = deviceOsType;
  }
