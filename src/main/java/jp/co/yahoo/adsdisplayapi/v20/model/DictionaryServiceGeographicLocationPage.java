...
import jp.co.yahoo.adsdisplayapi.v20.model.DictionaryServiceGeographicLocationValue;
...
public class DictionaryServiceGeographicLocationPage {
  ...
  public DictionaryServiceGeographicLocationPage totalNumEntries(@jakarta.annotation.Nullable Integer totalNumEntries) {
  ...
  public DictionaryServiceGeographicLocationPage values(@jakarta.annotation.Nullable List<DictionaryServiceGeographicLocationValue> values) {
  ...
  @JsonProperty(value = JSON_PROPERTY_VALUES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setValues(@jakarta.annotation.Nullable List<DictionaryServiceGeographicLocationValue> values) {
    this.values = values;
  }
