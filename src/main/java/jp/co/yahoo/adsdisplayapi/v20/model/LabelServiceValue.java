...
import jp.co.yahoo.adsdisplayapi.v20.model.Label;
...
public class LabelServiceValue {
  ...
  public LabelServiceValue errors(@jakarta.annotation.Nullable List<Error> errors) {
  ...
  public LabelServiceValue label(@jakarta.annotation.Nullable Label label) {
  ...
  @JsonProperty(value = JSON_PROPERTY_LABEL, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setLabel(@jakarta.annotation.Nullable Label label) {
    this.label = label;
  }

  public LabelServiceValue operationSucceeded(@jakarta.annotation.Nullable Boolean operationSucceeded) {
