...
public class BudgetOrderServiceSelector {
  ...
  public BudgetOrderServiceSelector accountIds(@jakarta.annotation.Nonnull List<Long> accountIds) {
  ...
  public BudgetOrderServiceSelector numberResults(@jakarta.annotation.Nullable Integer numberResults) {
  ...
  public BudgetOrderServiceSelector startIndex(@jakarta.annotation.Nullable Integer startIndex) {
