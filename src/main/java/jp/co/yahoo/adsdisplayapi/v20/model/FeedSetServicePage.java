...
import jp.co.yahoo.adsdisplayapi.v20.model.FeedSetServiceValue;
...
public class FeedSetServicePage {
  ...
  public FeedSetServicePage totalNumEntries(@jakarta.annotation.Nullable Integer totalNumEntries) {
  ...
  public FeedSetServicePage values(@jakarta.annotation.Nullable List<FeedSetServiceValue> values) {
  ...
  @JsonProperty(value = JSON_PROPERTY_VALUES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setValues(@jakarta.annotation.Nullable List<FeedSetServiceValue> values) {
    this.values = values;
  }
