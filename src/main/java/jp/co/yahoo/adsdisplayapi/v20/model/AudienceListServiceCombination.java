...
import jp.co.yahoo.adsdisplayapi.v20.model.AudienceListServiceData;
import jp.co.yahoo.adsdisplayapi.v20.model.AudienceListServiceLogicalOperator;
...
public class AudienceListServiceCombination {
  ...
  public AudienceListServiceCombination logicalOperator(@jakarta.annotation.Nullable AudienceListServiceLogicalOperator logicalOperator) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_LOGICAL_OPERATOR, required = false)
  ...
  @JsonProperty(value = JSON_PROPERTY_LOGICAL_OPERATOR, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setLogicalOperator(@jakarta.annotation.Nullable AudienceListServiceLogicalOperator logicalOperator) {
    this.logicalOperator = logicalOperator;
  }

  public AudienceListServiceCombination audienceLists(@jakarta.annotation.Nullable List<AudienceListServiceData> audienceLists) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_AUDIENCE_LISTS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_AUDIENCE_LISTS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAudienceLists(@jakarta.annotation.Nullable List<AudienceListServiceData> audienceLists) {
    this.audienceLists = audienceLists;
  }
