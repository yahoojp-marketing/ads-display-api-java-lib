...
public class AuditLogServiceDateRange {
  ...
  public AuditLogServiceDateRange endDate(@jakarta.annotation.Nullable String endDate) {
  ...
  public AuditLogServiceDateRange startDate(@jakarta.annotation.Nullable String startDate) {
