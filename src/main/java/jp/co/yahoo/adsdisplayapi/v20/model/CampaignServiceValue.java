...
public class CampaignServiceValue {
  ...
  public CampaignServiceValue campaign(@jakarta.annotation.Nullable Campaign campaign) {
  ...
  public CampaignServiceValue errors(@jakarta.annotation.Nullable List<Error> errors) {
  ...
  public CampaignServiceValue operationSucceeded(@jakarta.annotation.Nullable Boolean operationSucceeded) {
