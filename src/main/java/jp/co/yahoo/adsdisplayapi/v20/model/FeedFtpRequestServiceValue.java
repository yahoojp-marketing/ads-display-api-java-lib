...
public class FeedFtpRequestServiceValue {
  ...
  public FeedFtpRequestServiceValue errors(@jakarta.annotation.Nullable List<Error> errors) {
  ...
  public FeedFtpRequestServiceValue feedFtpRequest(@jakarta.annotation.Nullable FeedFtpRequest feedFtpRequest) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_FEED_FTP_REQUEST, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_FEED_FTP_REQUEST, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFeedFtpRequest(@jakarta.annotation.Nullable FeedFtpRequest feedFtpRequest) {
    this.feedFtpRequest = feedFtpRequest;
  }

  public FeedFtpRequestServiceValue operationSucceeded(@jakarta.annotation.Nullable Boolean operationSucceeded) {
