...
public class AccountManagementServiceOperation {
  ...
  public AccountManagementServiceOperation accountId(@jakarta.annotation.Nullable Long accountId) {
  ...
  public AccountManagementServiceOperation operand(@jakarta.annotation.Nonnull List<AccountManagement> operand) {
  ...
  @JsonProperty(value = JSON_PROPERTY_OPERAND, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setOperand(@jakarta.annotation.Nonnull List<AccountManagement> operand) {
    this.operand = operand;
  }
