...
import jp.co.yahoo.adsdisplayapi.v20.model.ConversionTrackerServiceAdvancedMatchingEnabled;
import jp.co.yahoo.adsdisplayapi.v20.model.ConversionTrackerServiceAppConversion;
...
import jp.co.yahoo.adsdisplayapi.v20.model.ConversionTrackerServiceIsPreviousConversion;
import jp.co.yahoo.adsdisplayapi.v20.model.ConversionTrackerServiceStatus;
import jp.co.yahoo.adsdisplayapi.v20.model.ConversionTrackerServiceTrackingTagConversion;
import jp.co.yahoo.adsdisplayapi.v20.model.ConversionTrackerServiceType;
import jp.co.yahoo.adsdisplayapi.v20.model.ConversionTrackerServiceWebConversion;
...
@JsonPropertyOrder({
  ...
  ConversionTracker.JSON_PROPERTY_TRACKING_TAG_CONVERSION
})
...
public class ConversionTracker {
  ...
  @jakarta.annotation.Nullable
  private Double userRevenueValue;
  ...
  public static final String JSON_PROPERTY_TRACKING_TAG_CONVERSION = "trackingTagConversion";
  @jakarta.annotation.Nullable
  private ConversionTrackerServiceTrackingTagConversion trackingTagConversion;
  ...
  /**
   * &lt;div lang&#x3D;\&quot;ja\&quot;&gt; 計測期間（単位：日）です。&lt;br&gt; ※1～90の範囲内で指定可能です。&lt;br&gt; このフィールドは、リクエストの場合は省略可能です。ADD時のデフォルト設定値は30となります。またリクエスト時、ConversionTrackerServiceTypeがSB_SVM_CONVERSIONの場合、このフィールドは無視されます。 &lt;/div&gt; &lt;div lang&#x3D;\&quot;en\&quot;&gt; Counting period (unit: day).&lt;br&gt; ∗ Can be specified within the range of 1 to 90 days.&lt;br&gt; This field is optional in requests. The default value in ADD operation will be 30. When ConversionTrackerServiceType is SB_SVM_CONVERSION, this field will be ignored on request. &lt;/div&gt; 
  ...
  public ConversionTracker userRevenueValue(@jakarta.annotation.Nullable Double userRevenueValue) {
  ...
  public Double getUserRevenueValue() {
    return userRevenueValue;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_USER_REVENUE_VALUE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setUserRevenueValue(@jakarta.annotation.Nullable Double userRevenueValue) {
    this.userRevenueValue = userRevenueValue;
  }
  ...
  public ConversionTracker trackingTagConversion(@jakarta.annotation.Nullable ConversionTrackerServiceTrackingTagConversion trackingTagConversion) {
    
    this.trackingTagConversion = trackingTagConversion;
    return this;
  }

  /**
   * Get trackingTagConversion
   * @return trackingTagConversion
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_TRACKING_TAG_CONVERSION, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public ConversionTrackerServiceTrackingTagConversion getTrackingTagConversion() {
    return trackingTagConversion;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_TRACKING_TAG_CONVERSION, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTrackingTagConversion(@jakarta.annotation.Nullable ConversionTrackerServiceTrackingTagConversion trackingTagConversion) {
    this.trackingTagConversion = trackingTagConversion;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, conversionTracker.accountId) &&
        ...
        Objects.equals(this.trackingTagConversion, conversionTracker.trackingTagConversion);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, allConversionValue, allConversions, viewThroughConversions, appConversion, category, conversionTrackerId, conversionTrackerName, conversionTrackerType, conversionValue, conversionValueViaAdClick, conversions, conversionsViaAdClick, countingType, crossDeviceConversions, excludeFromBidding, measurementPeriod, measurementPeriodView, mostRecentConversionDate, status, userRevenueValue, webConversion, isPreviousConversion, advancedMatchingEnabled, trackingTagConversion);
  }
  ...
  public String toString() {
    ...
    sb.append("    trackingTagConversion: ").append(toIndentedString(trackingTagConversion)).append("\n");
    sb.append("}");
    return sb.toString();
  }
