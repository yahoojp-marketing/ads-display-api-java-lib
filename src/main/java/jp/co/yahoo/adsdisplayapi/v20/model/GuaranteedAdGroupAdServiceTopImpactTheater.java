 ...
 */
@JsonPropertyOrder({
  GuaranteedAdGroupAdServiceTopImpactTheater.JSON_PROPERTY_DISPLAY_URL,
  GuaranteedAdGroupAdServiceTopImpactTheater.JSON_PROPERTY_THUMBNAIL_MEDIA_ID,
  GuaranteedAdGroupAdServiceTopImpactTheater.JSON_PROPERTY_CUSTOM_PARAMETERS,
  GuaranteedAdGroupAdServiceTopImpactTheater.JSON_PROPERTY_DISPLAY_URL_LEVEL,
  GuaranteedAdGroupAdServiceTopImpactTheater.JSON_PROPERTY_FINAL_URL,
  GuaranteedAdGroupAdServiceTopImpactTheater.JSON_PROPERTY_TRACKING_URL,
  GuaranteedAdGroupAdServiceTopImpactTheater.JSON_PROPERTY_VIDEO3_SEC_BEACON_URLS,
  GuaranteedAdGroupAdServiceTopImpactTheater.JSON_PROPERTY_VIDEO25_PERCENT_BEACON_URLS,
  GuaranteedAdGroupAdServiceTopImpactTheater.JSON_PROPERTY_VIDEO50_PERCENT_BEACON_URLS,
  GuaranteedAdGroupAdServiceTopImpactTheater.JSON_PROPERTY_VIDEO75_PERCENT_BEACON_URLS,
  GuaranteedAdGroupAdServiceTopImpactTheater.JSON_PROPERTY_VIDEO10_SEC_BEACON_URLS,
  GuaranteedAdGroupAdServiceTopImpactTheater.JSON_PROPERTY_VIDEO_COMPLETE_BEACON_URLS,
  GuaranteedAdGroupAdServiceTopImpactTheater.JSON_PROPERTY_VIDEO_START_BEACON_URLS,
  GuaranteedAdGroupAdServiceTopImpactTheater.JSON_PROPERTY_AD_LEFT_SIDE_MEDIA_ID,
  GuaranteedAdGroupAdServiceTopImpactTheater.JSON_PROPERTY_AD_RIGHT_SIDE_MEDIA_ID,
  GuaranteedAdGroupAdServiceTopImpactTheater.JSON_PROPERTY_AD_CENTER_MEDIA_ID,
  GuaranteedAdGroupAdServiceTopImpactTheater.JSON_PROPERTY_VIDEO_SCREENSHOT
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.22.0")
public class GuaranteedAdGroupAdServiceTopImpactTheater {
  ...
  public GuaranteedAdGroupAdServiceTopImpactTheater() {
  }

  public GuaranteedAdGroupAdServiceTopImpactTheater displayUrl(@jakarta.annotation.Nullable String displayUrl) {
  ...
  public GuaranteedAdGroupAdServiceTopImpactTheater thumbnailMediaId(@jakarta.annotation.Nullable Long thumbnailMediaId) {
  ...
  public GuaranteedAdGroupAdServiceTopImpactTheater customParameters(@jakarta.annotation.Nullable GuaranteedAdGroupAdServiceCustomParameters customParameters) {
  ...
  public GuaranteedAdGroupAdServiceTopImpactTheater displayUrlLevel(@jakarta.annotation.Nullable GuaranteedAdGroupAdServiceDisplayUrlLevel displayUrlLevel) {
  ...
  public GuaranteedAdGroupAdServiceTopImpactTheater finalUrl(@jakarta.annotation.Nullable String finalUrl) {
  ...
  public GuaranteedAdGroupAdServiceTopImpactTheater trackingUrl(@jakarta.annotation.Nullable String trackingUrl) {
  ...
  public GuaranteedAdGroupAdServiceTopImpactTheater video3SecBeaconUrls(@jakarta.annotation.Nullable List<String> video3SecBeaconUrls) {
    
    this.video3SecBeaconUrls = video3SecBeaconUrls;
    return this;
  }

  public GuaranteedAdGroupAdServiceTopImpactTheater addVideo3SecBeaconUrlsItem(String video3SecBeaconUrlsItem) {
  ...
  public GuaranteedAdGroupAdServiceTopImpactTheater video25PercentBeaconUrls(@jakarta.annotation.Nullable List<String> video25PercentBeaconUrls) {
    
    this.video25PercentBeaconUrls = video25PercentBeaconUrls;
    return this;
  }

  public GuaranteedAdGroupAdServiceTopImpactTheater addVideo25PercentBeaconUrlsItem(String video25PercentBeaconUrlsItem) {
  ...
  public GuaranteedAdGroupAdServiceTopImpactTheater video50PercentBeaconUrls(@jakarta.annotation.Nullable List<String> video50PercentBeaconUrls) {
    
    this.video50PercentBeaconUrls = video50PercentBeaconUrls;
    return this;
  }

  public GuaranteedAdGroupAdServiceTopImpactTheater addVideo50PercentBeaconUrlsItem(String video50PercentBeaconUrlsItem) {
  ...
  public GuaranteedAdGroupAdServiceTopImpactTheater video75PercentBeaconUrls(@jakarta.annotation.Nullable List<String> video75PercentBeaconUrls) {
    
    this.video75PercentBeaconUrls = video75PercentBeaconUrls;
    return this;
  }

  public GuaranteedAdGroupAdServiceTopImpactTheater addVideo75PercentBeaconUrlsItem(String video75PercentBeaconUrlsItem) {
  ...
  public GuaranteedAdGroupAdServiceTopImpactTheater video10SecBeaconUrls(@jakarta.annotation.Nullable List<String> video10SecBeaconUrls) {
    
    this.video10SecBeaconUrls = video10SecBeaconUrls;
    return this;
  }

  public GuaranteedAdGroupAdServiceTopImpactTheater addVideo10SecBeaconUrlsItem(String video10SecBeaconUrlsItem) {
  ...
  public GuaranteedAdGroupAdServiceTopImpactTheater videoCompleteBeaconUrls(@jakarta.annotation.Nullable List<String> videoCompleteBeaconUrls) {
    
    this.videoCompleteBeaconUrls = videoCompleteBeaconUrls;
    return this;
  }

  public GuaranteedAdGroupAdServiceTopImpactTheater addVideoCompleteBeaconUrlsItem(String videoCompleteBeaconUrlsItem) {
  ...
  public GuaranteedAdGroupAdServiceTopImpactTheater videoStartBeaconUrls(@jakarta.annotation.Nullable List<String> videoStartBeaconUrls) {
    
    this.videoStartBeaconUrls = videoStartBeaconUrls;
    return this;
  }

  public GuaranteedAdGroupAdServiceTopImpactTheater addVideoStartBeaconUrlsItem(String videoStartBeaconUrlsItem) {
  ...
  public GuaranteedAdGroupAdServiceTopImpactTheater adLeftSideMediaId(@jakarta.annotation.Nullable Long adLeftSideMediaId) {
  ...
  public GuaranteedAdGroupAdServiceTopImpactTheater adRightSideMediaId(@jakarta.annotation.Nullable Long adRightSideMediaId) {
  ...
  public GuaranteedAdGroupAdServiceTopImpactTheater adCenterMediaId(@jakarta.annotation.Nullable Long adCenterMediaId) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_AD_CENTER_MEDIA_ID, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_AD_CENTER_MEDIA_ID, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAdCenterMediaId(@jakarta.annotation.Nullable Long adCenterMediaId) {
    this.adCenterMediaId = adCenterMediaId;
  }

  public GuaranteedAdGroupAdServiceTopImpactTheater videoScreenshot(@jakarta.annotation.Nullable List<String> videoScreenshot) {
    
    this.videoScreenshot = videoScreenshot;
    return this;
  }

  public GuaranteedAdGroupAdServiceTopImpactTheater addVideoScreenshotItem(String videoScreenshotItem) {
  ...
  @JsonProperty(value = JSON_PROPERTY_VIDEO_SCREENSHOT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setVideoScreenshot(@jakarta.annotation.Nullable List<String> videoScreenshot) {
    this.videoScreenshot = videoScreenshot;
  }
  ...
  public boolean equals(Object o) {
    ...
    GuaranteedAdGroupAdServiceTopImpactTheater guaranteedAdGroupAdServiceTopImpactTheater = (GuaranteedAdGroupAdServiceTopImpactTheater) o;
    return Objects.equals(this.displayUrl, guaranteedAdGroupAdServiceTopImpactTheater.displayUrl) &&
        Objects.equals(this.thumbnailMediaId, guaranteedAdGroupAdServiceTopImpactTheater.thumbnailMediaId) &&
        Objects.equals(this.customParameters, guaranteedAdGroupAdServiceTopImpactTheater.customParameters) &&
        Objects.equals(this.displayUrlLevel, guaranteedAdGroupAdServiceTopImpactTheater.displayUrlLevel) &&
        Objects.equals(this.finalUrl, guaranteedAdGroupAdServiceTopImpactTheater.finalUrl) &&
        Objects.equals(this.trackingUrl, guaranteedAdGroupAdServiceTopImpactTheater.trackingUrl) &&
        Objects.equals(this.video3SecBeaconUrls, guaranteedAdGroupAdServiceTopImpactTheater.video3SecBeaconUrls) &&
        Objects.equals(this.video25PercentBeaconUrls, guaranteedAdGroupAdServiceTopImpactTheater.video25PercentBeaconUrls) &&
        Objects.equals(this.video50PercentBeaconUrls, guaranteedAdGroupAdServiceTopImpactTheater.video50PercentBeaconUrls) &&
        Objects.equals(this.video75PercentBeaconUrls, guaranteedAdGroupAdServiceTopImpactTheater.video75PercentBeaconUrls) &&
        Objects.equals(this.video10SecBeaconUrls, guaranteedAdGroupAdServiceTopImpactTheater.video10SecBeaconUrls) &&
        Objects.equals(this.videoCompleteBeaconUrls, guaranteedAdGroupAdServiceTopImpactTheater.videoCompleteBeaconUrls) &&
        Objects.equals(this.videoStartBeaconUrls, guaranteedAdGroupAdServiceTopImpactTheater.videoStartBeaconUrls) &&
        Objects.equals(this.adLeftSideMediaId, guaranteedAdGroupAdServiceTopImpactTheater.adLeftSideMediaId) &&
        Objects.equals(this.adRightSideMediaId, guaranteedAdGroupAdServiceTopImpactTheater.adRightSideMediaId) &&
        Objects.equals(this.adCenterMediaId, guaranteedAdGroupAdServiceTopImpactTheater.adCenterMediaId) &&
        Objects.equals(this.videoScreenshot, guaranteedAdGroupAdServiceTopImpactTheater.videoScreenshot);
  }
  ...
  public String toString() {
    ...
    sb.append("class GuaranteedAdGroupAdServiceTopImpactTheater {\n");
