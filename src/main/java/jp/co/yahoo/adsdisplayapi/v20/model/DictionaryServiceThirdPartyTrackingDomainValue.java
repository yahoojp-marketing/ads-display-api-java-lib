...
import jp.co.yahoo.adsdisplayapi.v20.model.DictionaryServiceThirdPartyTrackingDomain;
...
public class DictionaryServiceThirdPartyTrackingDomainValue {
  ...
  public DictionaryServiceThirdPartyTrackingDomainValue errors(@jakarta.annotation.Nullable List<Error> errors) {
  ...
  public DictionaryServiceThirdPartyTrackingDomainValue operationSucceeded(@jakarta.annotation.Nullable Boolean operationSucceeded) {
  ...
  public DictionaryServiceThirdPartyTrackingDomainValue thirdPartyTrackingDomain(@jakarta.annotation.Nullable List<DictionaryServiceThirdPartyTrackingDomain> thirdPartyTrackingDomain) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_THIRD_PARTY_TRACKING_DOMAIN, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_THIRD_PARTY_TRACKING_DOMAIN, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setThirdPartyTrackingDomain(@jakarta.annotation.Nullable List<DictionaryServiceThirdPartyTrackingDomain> thirdPartyTrackingDomain) {
    this.thirdPartyTrackingDomain = thirdPartyTrackingDomain;
  }
