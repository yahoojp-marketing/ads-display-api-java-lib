...
import jp.co.yahoo.adsdisplayapi.v20.model.GuaranteedAdGroupServiceGetResponse;
import jp.co.yahoo.adsdisplayapi.v20.model.GuaranteedAdGroupServiceSelector;
...
@Component("jp.co.yahoo.adsdisplayapi.v20.api.GuaranteedAdGroupServiceApi")
public class GuaranteedAdGroupServiceApi extends BaseApi {

    public GuaranteedAdGroupServiceApi() {
        super(new ApiClient());
    }

    @Autowired
    public GuaranteedAdGroupServiceApi(ApiClient apiClient) {
        super(apiClient);
    }
     ...
     * @param guaranteedAdGroupServiceSelector  (optional)
     * @return GuaranteedAdGroupServiceGetResponse
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public GuaranteedAdGroupServiceGetResponse guaranteedAdGroupServiceGetPost(Long xZBaseAccountId, GuaranteedAdGroupServiceSelector guaranteedAdGroupServiceSelector) throws RestClientException {
        return guaranteedAdGroupServiceGetPostWithHttpInfo(xZBaseAccountId, guaranteedAdGroupServiceSelector).getBody();
    }
     ...
     * @param xZBaseAccountId &lt;div lang&#x3D;\&quot;ja\&quot;&gt;アカウントIDを指定してください。&lt;/div&gt; &lt;div lang&#x3D;\&quot;en\&quot;&gt;Specify Account ID.&lt;/div&gt;  (required)
     * @param guaranteedAdGroupServiceSelector  (optional)
     * @return ResponseEntity&lt;GuaranteedAdGroupServiceGetResponse&gt;
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<GuaranteedAdGroupServiceGetResponse> guaranteedAdGroupServiceGetPostWithHttpInfo(Long xZBaseAccountId, GuaranteedAdGroupServiceSelector guaranteedAdGroupServiceSelector) throws RestClientException {
        Object localVarPostBody = guaranteedAdGroupServiceSelector;
        
        // verify the required parameter 'xZBaseAccountId' is set
        if (xZBaseAccountId == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'xZBaseAccountId' when calling guaranteedAdGroupServiceGetPost");
        }
        ...
        ParameterizedTypeReference<GuaranteedAdGroupServiceGetResponse> localReturnType = new ParameterizedTypeReference<GuaranteedAdGroupServiceGetResponse>() {};
        return apiClient.invokeAPI("/GuaranteedAdGroupService/get", HttpMethod.POST, Collections.<String, Object>emptyMap(), localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localReturnType);
    }
