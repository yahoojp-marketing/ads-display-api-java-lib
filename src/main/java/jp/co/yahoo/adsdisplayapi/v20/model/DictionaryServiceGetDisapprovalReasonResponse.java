...
import jp.co.yahoo.adsdisplayapi.v20.model.DictionaryServiceDisapprovalReasonPage;
...
public class DictionaryServiceGetDisapprovalReasonResponse {
  ...
  public DictionaryServiceGetDisapprovalReasonResponse errors(@jakarta.annotation.Nullable List<Error> errors) {
  ...
  public DictionaryServiceGetDisapprovalReasonResponse rid(@jakarta.annotation.Nullable String rid) {
  ...
  public DictionaryServiceGetDisapprovalReasonResponse rval(@jakarta.annotation.Nullable DictionaryServiceDisapprovalReasonPage rval) {
  ...
  @JsonProperty(value = JSON_PROPERTY_RVAL, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRval(@jakarta.annotation.Nullable DictionaryServiceDisapprovalReasonPage rval) {
    this.rval = rval;
  }
