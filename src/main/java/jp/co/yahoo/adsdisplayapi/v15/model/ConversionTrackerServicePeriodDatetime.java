 ...
 */
@ApiModel(description = "<div lang=\"ja\">ConversionTrackerServicePeriodDatetimeオブジェクトは、統計情報の処理を開始/完了した日です。</div> <div lang=\"en\">ConversionTrackerServicePeriodDatetime object describes date when stats information processing started or completed.</div> ")
@JsonPropertyOrder({
