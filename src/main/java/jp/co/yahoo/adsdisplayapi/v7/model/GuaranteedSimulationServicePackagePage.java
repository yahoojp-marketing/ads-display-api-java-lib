...
@JsonPropertyOrder({
  GuaranteedSimulationServicePackagePage.JSON_PROPERTY_TOTAL_NUM_ENTRIES,
  GuaranteedSimulationServicePackagePage.JSON_PROPERTY_VALUES
})
@JsonTypeName("GuaranteedSimulationServicePackagePage")
...
public class GuaranteedSimulationServicePackagePage {
  ...
  public GuaranteedSimulationServicePackagePage() { 
  }
