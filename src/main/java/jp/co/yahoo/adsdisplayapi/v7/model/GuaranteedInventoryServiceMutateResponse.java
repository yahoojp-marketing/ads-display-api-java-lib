 ...
 */
@JsonPropertyOrder({
  GuaranteedInventoryServiceMutateResponse.JSON_PROPERTY_ERRORS,
  GuaranteedInventoryServiceMutateResponse.JSON_PROPERTY_RID,
  GuaranteedInventoryServiceMutateResponse.JSON_PROPERTY_RVAL
})
@JsonTypeName("GuaranteedInventoryServiceMutateResponse")
...
public class GuaranteedInventoryServiceMutateResponse {
  ...
  private GuaranteedInventoryServiceReturnValue rval;

  public GuaranteedInventoryServiceMutateResponse() { 
  }
