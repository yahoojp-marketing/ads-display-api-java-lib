...
@JsonPropertyOrder({
  GuaranteedReservationServiceReturnValue.JSON_PROPERTY_VALUES
})
@JsonTypeName("GuaranteedReservationServiceReturnValue")
...
public class GuaranteedReservationServiceReturnValue {
  ...
  public GuaranteedReservationServiceReturnValue() { 
  }
