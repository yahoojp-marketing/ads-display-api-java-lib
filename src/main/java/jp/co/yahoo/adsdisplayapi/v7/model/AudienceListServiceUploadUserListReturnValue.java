...
public class AudienceListServiceUploadUserListReturnValue   {
  ...
  public AudienceListServiceUploadUserListReturnValue addValuesItem(AudienceListServiceUploadUserListValue valuesItem) {
    if (this.values == null) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    AudienceListServiceUploadUserListReturnValue audienceListServiceUploadUserListReturnValue = (AudienceListServiceUploadUserListReturnValue) o;
    return Objects.equals(this.values, audienceListServiceUploadUserListReturnValue.values);
  }
  ...
  public String toString() {
    ...
    sb.append("class AudienceListServiceUploadUserListReturnValue {\n");
