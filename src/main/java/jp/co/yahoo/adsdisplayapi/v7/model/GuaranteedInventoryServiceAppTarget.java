...
@JsonPropertyOrder({
  GuaranteedInventoryServiceAppTarget.JSON_PROPERTY_DEVICE_APP_TYPE
})
@JsonTypeName("GuaranteedInventoryServiceAppTarget")
...
public class GuaranteedInventoryServiceAppTarget {
  ...
  private GuaranteedInventoryServiceDeviceAppType deviceAppType;

  public GuaranteedInventoryServiceAppTarget() { 
  }
