...
public enum GuaranteedSimulationServiceAdType {
  ...
  GuaranteedSimulationServiceAdType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static GuaranteedSimulationServiceAdType fromValue(String value) {
    for (GuaranteedSimulationServiceAdType b : GuaranteedSimulationServiceAdType.values()) {
