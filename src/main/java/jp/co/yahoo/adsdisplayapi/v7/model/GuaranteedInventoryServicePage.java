...
@JsonPropertyOrder({
  GuaranteedInventoryServicePage.JSON_PROPERTY_TOTAL_NUM_ENTRIES,
  GuaranteedInventoryServicePage.JSON_PROPERTY_VALUES
})
@JsonTypeName("GuaranteedInventoryServicePage")
...
public class GuaranteedInventoryServicePage {
  ...
  public GuaranteedInventoryServicePage() { 
  }
