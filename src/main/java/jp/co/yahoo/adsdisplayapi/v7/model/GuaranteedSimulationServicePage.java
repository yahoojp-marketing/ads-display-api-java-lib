...
@JsonPropertyOrder({
  GuaranteedSimulationServicePage.JSON_PROPERTY_TOTAL_NUM_ENTRIES,
  GuaranteedSimulationServicePage.JSON_PROPERTY_VALUES
})
@JsonTypeName("GuaranteedSimulationServicePage")
...
public class GuaranteedSimulationServicePage {
  ...
  public GuaranteedSimulationServicePage() { 
  }
