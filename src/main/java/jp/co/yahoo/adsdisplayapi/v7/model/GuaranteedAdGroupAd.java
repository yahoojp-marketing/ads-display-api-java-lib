...
import jp.co.yahoo.adsdisplayapi.v7.model.GuaranteedAdGroupAdLandingPageStatus;
import jp.co.yahoo.adsdisplayapi.v7.model.GuaranteedAdGroupAdServiceAd;
import jp.co.yahoo.adsdisplayapi.v7.model.GuaranteedAdGroupAdServiceAdStyle;
import jp.co.yahoo.adsdisplayapi.v7.model.GuaranteedAdGroupAdServiceApprovalStatus;
import jp.co.yahoo.adsdisplayapi.v7.model.GuaranteedAdGroupAdServiceIsRemoveFlg;
import jp.co.yahoo.adsdisplayapi.v7.model.GuaranteedAdGroupAdServiceLabel;
import jp.co.yahoo.adsdisplayapi.v7.model.GuaranteedAdGroupAdServiceUserStatus;
...
public class GuaranteedAdGroupAd   {
  ...
  */
  ...
  /**
   * <div lang=\"ja\"> リンク先更新予定日時です。<br> SET時は、finalUrlを指定した場合のみ指定できます。<br> ※フォーマット：yyyyMMddHHmm<br> ※landingPageStatusがSPECIFIED_UPDATE_SCHEDULED_TIMEの場合は必須です。  </div> <div lang=\"en\"> The scheduled update date and time for the landing page.<br> *In SET operation, it can be specified only when finalUrl is specified.<br> *format: yyyyMMddHHmm<br> ∗If landingPageStatus is SPECIFIED_UPDATE_SCHEDULED_TIME, this field is required. </div> 
   * @return landingPageUpdateScheduledTime
  */
  @ApiModelProperty(value = "<div lang=\"ja\"> リンク先更新予定日時です。<br> SET時は、finalUrlを指定した場合のみ指定できます。<br> ※フォーマット：yyyyMMddHHmm<br> ※landingPageStatusがSPECIFIED_UPDATE_SCHEDULED_TIMEの場合は必須です。  </div> <div lang=\"en\"> The scheduled update date and time for the landing page.<br> *In SET operation, it can be specified only when finalUrl is specified.<br> *format: yyyyMMddHHmm<br> ∗If landingPageStatus is SPECIFIED_UPDATE_SCHEDULED_TIME, this field is required. </div> ")
