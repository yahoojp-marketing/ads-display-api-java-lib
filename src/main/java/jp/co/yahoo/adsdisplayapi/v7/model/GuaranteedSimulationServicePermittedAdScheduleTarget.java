...
@JsonPropertyOrder({
  GuaranteedSimulationServicePermittedAdScheduleTarget.JSON_PROPERTY_TARGET_ID,
  GuaranteedSimulationServicePermittedAdScheduleTarget.JSON_PROPERTY_DAY_OF_WEEK,
  GuaranteedSimulationServicePermittedAdScheduleTarget.JSON_PROPERTY_END_HOUR,
  GuaranteedSimulationServicePermittedAdScheduleTarget.JSON_PROPERTY_START_HOUR,
  GuaranteedSimulationServicePermittedAdScheduleTarget.JSON_PROPERTY_PRICE
})
@JsonTypeName("GuaranteedSimulationServicePermittedAdScheduleTarget")
...
public class GuaranteedSimulationServicePermittedAdScheduleTarget {
  ...
  public GuaranteedSimulationServicePermittedAdScheduleTarget() { 
  }
