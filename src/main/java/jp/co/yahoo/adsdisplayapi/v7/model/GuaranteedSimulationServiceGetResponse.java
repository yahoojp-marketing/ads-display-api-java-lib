 ...
 */
@JsonPropertyOrder({
  GuaranteedSimulationServiceGetResponse.JSON_PROPERTY_ERRORS,
  GuaranteedSimulationServiceGetResponse.JSON_PROPERTY_RID,
  GuaranteedSimulationServiceGetResponse.JSON_PROPERTY_RVAL
})
@JsonTypeName("GuaranteedSimulationServiceGetResponse")
...
public class GuaranteedSimulationServiceGetResponse {
  ...
  private GuaranteedSimulationServicePage rval;

  public GuaranteedSimulationServiceGetResponse() { 
  }
