...
import jp.co.yahoo.adsdisplayapi.v7.model.MediaServiceReturnValue;
...
public class MediaServiceMutateResponse   {
  ...
  @JsonProperty("rval")
  private MediaServiceReturnValue rval = null;
  ...
  */
  ...
  public MediaServiceReturnValue getRval() {
    return rval;
  }

  public void setRval(MediaServiceReturnValue rval) {
    this.rval = rval;
  }
