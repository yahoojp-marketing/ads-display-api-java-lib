 ...
 */
@ApiModel(description = "<div lang=\"ja\">EstimatedUserSizeServiceValueオブジェクトは、操作結果を含む推定ユーザサイズの情報を表します。</div> <div lang=\"en\">EstimatedUserSizeServiceValue object describes estimated user size information including its operation results.</div> ")
@JsonPropertyOrder({
...
@JsonTypeName("EstimatedUserSizeServiceValue")
