 ...
 */
@ApiModel(description = "<div lang=\"ja\">AdGroupAdServiceDescriptionAssetオブジェクトは、レスポンシブディスプレイ広告で指定する説明文のアセットを表します。</div> <div lang=\"en\">The AdGroupAdServiceDescriptionAsset object represents a description asset to specify in Responsive Ads for Display.</div> ")
@JsonPropertyOrder({
