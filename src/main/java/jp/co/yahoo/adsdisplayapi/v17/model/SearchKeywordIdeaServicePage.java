...
import jp.co.yahoo.adsdisplayapi.v17.model.SearchKeywordIdeaServiceValue;
...
public class SearchKeywordIdeaServicePage {
  ...
  public SearchKeywordIdeaServicePage totalNumEntries(@jakarta.annotation.Nullable Integer totalNumEntries) {
  ...
  public SearchKeywordIdeaServicePage values(@jakarta.annotation.Nullable List<SearchKeywordIdeaServiceValue> values) {
  ...
  @JsonProperty(value = JSON_PROPERTY_VALUES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setValues(@jakarta.annotation.Nullable List<SearchKeywordIdeaServiceValue> values) {
    this.values = values;
  }
