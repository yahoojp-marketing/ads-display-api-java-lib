...
import jp.co.yahoo.adsdisplayapi.v17.model.SearchKeywordIdeaServicePage;
 ...
 */
@JsonPropertyOrder({
  SearchKeywordIdeaServiceGetResponse.JSON_PROPERTY_ERRORS,
  SearchKeywordIdeaServiceGetResponse.JSON_PROPERTY_RID,
  SearchKeywordIdeaServiceGetResponse.JSON_PROPERTY_RVAL
})
...
public class SearchKeywordIdeaServiceGetResponse {
  ...
  @jakarta.annotation.Nullable
  private SearchKeywordIdeaServicePage rval;

  public SearchKeywordIdeaServiceGetResponse() {
  }

  public SearchKeywordIdeaServiceGetResponse errors(@jakarta.annotation.Nullable List<Error> errors) {
  ...
  public SearchKeywordIdeaServiceGetResponse rid(@jakarta.annotation.Nullable String rid) {
  ...
  public SearchKeywordIdeaServiceGetResponse rval(@jakarta.annotation.Nullable SearchKeywordIdeaServicePage rval) {
  ...
  @JsonProperty(value = JSON_PROPERTY_RVAL, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRval(@jakarta.annotation.Nullable SearchKeywordIdeaServicePage rval) {
    this.rval = rval;
  }
