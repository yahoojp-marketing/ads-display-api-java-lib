 ...
 */
@ApiModel(description = "<div lang=\"ja\">RecommendationServiceInsufficientVideoViewsCampaignオブジェクトは、動画再生数が少ないキャンペーンに関する最適化提案の詳細情報を表します。</div> <div lang=\"en\">RecommendationServiceInsufficientVideoViewsCampaign object describes detailed information of Recommendations about the campaign that need to increase video views.</div> ")
@JsonPropertyOrder({
...
@JsonTypeName("RecommendationServiceInsufficientVideoViewsCampaign")
