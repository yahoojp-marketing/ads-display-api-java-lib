...
import jp.co.yahoo.adsdisplayapi.v17.model.SearchKeywordListServiceValue;
...
public class SearchKeywordListServicePage {
  ...
  public SearchKeywordListServicePage totalNumEntries(@jakarta.annotation.Nullable Integer totalNumEntries) {
  ...
  public SearchKeywordListServicePage values(@jakarta.annotation.Nullable List<SearchKeywordListServiceValue> values) {
  ...
  @JsonProperty(value = JSON_PROPERTY_VALUES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setValues(@jakarta.annotation.Nullable List<SearchKeywordListServiceValue> values) {
    this.values = values;
  }
