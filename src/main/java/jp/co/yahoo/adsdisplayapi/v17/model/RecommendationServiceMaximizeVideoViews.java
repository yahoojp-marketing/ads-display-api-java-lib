 ...
 */
@ApiModel(description = "<div lang=\"ja\">RecommendationServiceMaximizeVideoViewsオブジェクトは、自動入札（動画再生数の最大化）に適しているキャンペーンに関する最適化提案の情報を表します。</div> <div lang=\"en\">RecommendationServiceMaximizeVideoViews object describes recommendation information about the campaign that is suitable for using autobidding (Maximize video views).</div> ")
@JsonPropertyOrder({
