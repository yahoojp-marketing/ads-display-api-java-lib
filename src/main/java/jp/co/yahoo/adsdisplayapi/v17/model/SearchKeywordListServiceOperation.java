...
public class SearchKeywordListServiceOperation {
  ...
  public SearchKeywordListServiceOperation accountId(@jakarta.annotation.Nonnull Long accountId) {
  ...
  public SearchKeywordListServiceOperation operand(@jakarta.annotation.Nonnull List<SearchKeywordList> operand) {
  ...
  @JsonProperty(value = JSON_PROPERTY_OPERAND, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setOperand(@jakarta.annotation.Nonnull List<SearchKeywordList> operand) {
    this.operand = operand;
  }
