...
import jp.co.yahoo.adsdisplayapi.v17.model.OfflineConversionServiceSort;
...
public class OfflineConversionServiceSelector {
  ...
  public OfflineConversionServiceSelector sorts(@jakarta.annotation.Nullable List<OfflineConversionServiceSort> sorts) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_SORTS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_SORTS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSorts(@jakarta.annotation.Nullable List<OfflineConversionServiceSort> sorts) {
    this.sorts = sorts;
  }
