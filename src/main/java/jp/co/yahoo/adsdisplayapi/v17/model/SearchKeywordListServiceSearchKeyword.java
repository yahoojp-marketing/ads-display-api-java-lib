 ...
 */
@ApiModel(description = "<div lang=\"ja\"> SearchKeywordListServiceSearchKeywordオブジェクトは、サーチキーワードを表します。<br> </div> <div lang=\"en\"> SearchKeywordListServiceSearchKeyword is an object to display the search keyword.<br> </div> ")
@JsonPropertyOrder({
...
public class SearchKeywordListServiceSearchKeyword {
  ...
  **/
  ...
  @ApiModelProperty(value = "<div lang=\"ja\"> サーチキーワードIDです。<br> </div> <div lang=\"en\"> Search keyword ID.<br> </div> ")
