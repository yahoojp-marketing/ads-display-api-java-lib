 ...
 */
@ApiModel(description = "<div lang=\"ja\">RecommendationServiceInsufficientClicksオブジェクトは、クリック数が少ないキャンペーンに関する最適化提案の情報を表します。</div> <div lang=\"en\">RecommendationServiceInsufficientClicks object describes recommendation information about the campaign that need to increase clicks.</div> ")
@JsonPropertyOrder({
