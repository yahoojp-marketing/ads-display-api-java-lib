...
public class SearchKeywordList {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<div lang=\"ja\"> サーチキーワードリストの説明文です。<br> </div> <div lang=\"en\"> Description of Search keyword list.<br> </div> ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<div lang=\"ja\"> サーチキーワードリストIDです。<br> このフィールドは、REMOVE時に必須となります。 </div> <div lang=\"en\"> Search keyword list ID.<br> This field is required in REMOVE operation. </div> ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<div lang=\"ja\"> サーチキーワードリスト名です。<br> </div> <div lang=\"en\"> Name of Search keyword list.<br> </div> ")
