 ...
 */
@ApiModel(description = "<div lang=\"ja\">StatsServicePeriodDatetimeオブジェクトは、統計情報の処理を開始/完了した日です。</div> <div lang=\"en\">StatsServicePeriodDatetime object describes date when stats information processing started or completed.</div> ")
@JsonPropertyOrder({
