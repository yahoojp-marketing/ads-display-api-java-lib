...
import jp.co.yahoo.adsdisplayapi.v17.model.SearchKeywordIdea;
...
public class SearchKeywordIdeaServiceValue {
  ...
  public SearchKeywordIdeaServiceValue errors(@jakarta.annotation.Nullable List<Error> errors) {
  ...
  public SearchKeywordIdeaServiceValue operationSucceeded(@jakarta.annotation.Nullable Boolean operationSucceeded) {
  ...
  public SearchKeywordIdeaServiceValue searchKeywordIdea(@jakarta.annotation.Nullable SearchKeywordIdea searchKeywordIdea) {
  ...
  @JsonProperty(value = JSON_PROPERTY_SEARCH_KEYWORD_IDEA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSearchKeywordIdea(@jakarta.annotation.Nullable SearchKeywordIdea searchKeywordIdea) {
    this.searchKeywordIdea = searchKeywordIdea;
  }
