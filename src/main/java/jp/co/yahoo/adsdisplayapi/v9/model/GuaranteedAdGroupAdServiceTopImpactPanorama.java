...
public class GuaranteedAdGroupAdServiceTopImpactPanorama {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(displayUrl, customParameters, displayUrlLevel, finalUrl, isRemoveTrackingUrl, trackingUrl, adLeftSideMediaId, adRightSideMediaId, adShrinkMainMediaId);
  }
