...
import jp.co.yahoo.adsdisplayapi.v9.auth.Authentication;
import jp.co.yahoo.adsdisplayapi.v9.auth.OAuth;

@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
@Component("jp.co.yahoo.adsdisplayapi.v9.ApiClient")
public class ApiClient extends JavaTimeFormatter {
    ...
    private String basePath = "https://ads-display.yahooapis.jp/api/v9";
