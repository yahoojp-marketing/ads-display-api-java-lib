...
public class AdGroupAdServiceResponsiveImageAd {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<div lang=\"ja\"> 説明文です。<br> このフィールドは、ADD時は必須となり、SET時は省略可能となります。<br> ※レスポンシブディスプレイ広告を利用する場合は指定できません。 </div> <div lang=\"en\"> Description.<br> This field is required in ADD operation, and will be optional in SET operation.<br> *Cannot be specified when using responsive display ads. ")
