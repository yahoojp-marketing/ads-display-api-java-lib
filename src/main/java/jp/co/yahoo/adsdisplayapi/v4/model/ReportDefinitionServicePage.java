 ...
 */
@ApiModel(description = "<div lang=\"ja\">ReportDefinitionServicePageオブジェクトは、レポートのエントリーを表します。</div> <div lang=\"en\">ReportDefinitionServicePage object serves the entry of report definition.</div> ")
