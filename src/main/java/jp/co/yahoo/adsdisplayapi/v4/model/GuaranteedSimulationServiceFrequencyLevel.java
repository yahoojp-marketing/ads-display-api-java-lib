 ...
 */
public enum GuaranteedSimulationServiceFrequencyLevel {
  ...
  GuaranteedSimulationServiceFrequencyLevel(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static GuaranteedSimulationServiceFrequencyLevel fromValue(String value) {
    for (GuaranteedSimulationServiceFrequencyLevel b : GuaranteedSimulationServiceFrequencyLevel.values()) {
