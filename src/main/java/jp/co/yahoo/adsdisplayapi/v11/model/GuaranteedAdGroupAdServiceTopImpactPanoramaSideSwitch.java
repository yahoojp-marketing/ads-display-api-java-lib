 ...
 */
@ApiModel(description = "<div lang=\"ja\"> GuaranteedAdGroupAdServiceTopImpactPanoramaSideSwitchオブジェクトは、トップインパクト パノラマ サイドスイッチ広告の情報を表します。<br> このフィールドは、レスポンスの際に返却されますが、リクエストの際には無視されます。<br> </div> <div lang=\"en\"> GuaranteedAdGroupAdServiceTopImpactPanoramaSideSwitch object describes information of Top Impact Panorama Side Switch ad.<br> This field will be returned in the response, it will be ignored on input.<br> </div> ")
@JsonPropertyOrder({
...
@JsonTypeName("GuaranteedAdGroupAdServiceTopImpactPanoramaSideSwitch")
