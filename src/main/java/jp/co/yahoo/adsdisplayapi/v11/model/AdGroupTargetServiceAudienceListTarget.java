...
import jp.co.yahoo.adsdisplayapi.v11.model.AdGroupTargetServiceAudienceListType;
import jp.co.yahoo.adsdisplayapi.v11.model.AdGroupTargetServiceDeliverType;
...
public class AdGroupTargetServiceAudienceListTarget {
  ...
  **/
  ...
  public AdGroupTargetServiceAudienceListTarget audienceListNameEn(String audienceListNameEn) {
   ...
   /**
   * &lt;div lang&#x3D;\&quot;ja\&quot;&gt; オーディエンスリスト名(英語)です。&lt;br&gt; 共通オーディエンスリストの場合のみ返却されます。&lt;br&gt; このフィールドは、レスポンスの際に返却されますが、リクエストの際には無視されます。 &lt;/div&gt; &lt;div lang&#x3D;\&quot;en\&quot;&gt;Audience list name (Eng).&lt;br&gt; This field is returned when the audience list is shared audience list.&lt;br&gt; Although this field will be returned in the response, it will be ignored on input. &lt;/div&gt; 
   * @return audienceListNameEn
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<div lang=\"ja\"> オーディエンスリスト名(英語)です。<br> 共通オーディエンスリストの場合のみ返却されます。<br> このフィールドは、レスポンスの際に返却されますが、リクエストの際には無視されます。 </div> <div lang=\"en\">Audience list name (Eng).<br> This field is returned when the audience list is shared audience list.<br> Although this field will be returned in the response, it will be ignored on input. </div> ")
