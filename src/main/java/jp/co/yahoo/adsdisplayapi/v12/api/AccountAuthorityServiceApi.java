...
import jp.co.yahoo.adsdisplayapi.v12.model.AccountAuthorityServiceGetResponse;
import jp.co.yahoo.adsdisplayapi.v12.model.AccountAuthorityServiceSelector;
...
@Component("jp.co.yahoo.adsdisplayapi.v12.api.AccountAuthorityServiceApi")
public class AccountAuthorityServiceApi {
     ...
     */
    public AccountAuthorityServiceGetResponse accountAuthorityServiceGetPost(Long xZBaseAccountId, AccountAuthorityServiceSelector accountAuthorityServiceSelector) throws RestClientException {
        return accountAuthorityServiceGetPostWithHttpInfo(xZBaseAccountId, accountAuthorityServiceSelector).getBody();
    }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<AccountAuthorityServiceGetResponse> accountAuthorityServiceGetPostWithHttpInfo(Long xZBaseAccountId, AccountAuthorityServiceSelector accountAuthorityServiceSelector) throws RestClientException {
        Object postBody = accountAuthorityServiceSelector;
        
        // verify the required parameter 'xZBaseAccountId' is set
        if (xZBaseAccountId == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'xZBaseAccountId' when calling accountAuthorityServiceGetPost");
        }
        ...
        ParameterizedTypeReference<AccountAuthorityServiceGetResponse> returnType = new ParameterizedTypeReference<AccountAuthorityServiceGetResponse>() {};
        return apiClient.invokeAPI("/AccountAuthorityService/get", HttpMethod.POST, Collections.<String, Object>emptyMap(), queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, authNames, returnType);
    }
}
