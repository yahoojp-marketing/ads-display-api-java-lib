 ...
 */
@ApiModel(description = "<div lang=\"ja\">RecommendationServiceCreateResponsiveDisplayAdsListオブジェクトは、レスポンシブディスプレイ広告に関する最適化提案の詳細情報を表します。</div> <div lang=\"en\">RecommendationServiceCreateResponsiveDisplayAdsList object describes detailed information about a recommendation for Responsive Ads for Display.</div> ")
@JsonPropertyOrder({
  RecommendationServiceCreateResponsiveDisplayAdsList.JSON_PROPERTY_RECOMMENDATION_ID,
  RecommendationServiceCreateResponsiveDisplayAdsList.JSON_PROPERTY_CAMPAIGN_ID,
  RecommendationServiceCreateResponsiveDisplayAdsList.JSON_PROPERTY_CAMPAIGN_NAME,
...
@JsonTypeName("RecommendationServiceCreateResponsiveDisplayAdsList")
...
public class RecommendationServiceCreateResponsiveDisplayAdsList {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<div lang=\"ja\"> レスポンシブディスプレイ広告の利用を推奨するキャンペーンのキャンペーンIDです。<br> </div> <div lang=\"en\"> IDs of campaigns recommended for using Responsive Ads for Display.<br> </div> ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<div lang=\"ja\"> レスポンシブディスプレイ広告の利用を推奨するキャンペーンのキャンペーン名です。<br> </div> <div lang=\"en\"> Names of campaigns recommended for using Responsive Ads for Display.<br> </div> ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<div lang=\"ja\"> レスポンシブディスプレイ広告の利用を推奨する広告グループの広告グループIDです。<br> </div> <div lang=\"en\"> IDs of ad groups recommended for using Responsive Ads for Display.<br> </div> ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<div lang=\"ja\"> レスポンシブディスプレイ広告の利用を推奨する広告グループの広告グループ名です。<br> </div> <div lang=\"en\"> Names of ad groups recommended for using Responsive Ads for Display.<br> </div> ")
  ...
  public boolean equals(Object o) {
    ...
    RecommendationServiceCreateResponsiveDisplayAdsList recommendationServiceCreateResponsiveDisplayAdsList = (RecommendationServiceCreateResponsiveDisplayAdsList) o;
    return Objects.equals(this.recommendationId, recommendationServiceCreateResponsiveDisplayAdsList.recommendationId) &&
        Objects.equals(this.campaignId, recommendationServiceCreateResponsiveDisplayAdsList.campaignId) &&
        Objects.equals(this.campaignName, recommendationServiceCreateResponsiveDisplayAdsList.campaignName) &&
        Objects.equals(this.adGroupId, recommendationServiceCreateResponsiveDisplayAdsList.adGroupId) &&
        Objects.equals(this.adGroupName, recommendationServiceCreateResponsiveDisplayAdsList.adGroupName);
  }
  ...
  public String toString() {
    ...
    sb.append("class RecommendationServiceCreateResponsiveDisplayAdsList {\n");
