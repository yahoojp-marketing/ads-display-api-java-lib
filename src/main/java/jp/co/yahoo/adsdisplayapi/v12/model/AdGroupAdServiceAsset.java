...
import jp.co.yahoo.adsdisplayapi.v12.model.AdGroupAdServiceDescriptionAsset;
import jp.co.yahoo.adsdisplayapi.v12.model.AdGroupAdServiceHeadlineAsset;
import jp.co.yahoo.adsdisplayapi.v12.model.AdGroupAdServiceMediaAsset;
 ...
 */
@ApiModel(description = "<div lang=\"ja\"> AdGroupAdServiceAssetオブジェクトは、レスポンシブディスプレイ広告の情報を表します。<br> 詳細は<a href=\"https://ads-help.yahoo-net.jp/s/article/H000044228?language=ja\" target=\"_blank\">レスポンシブ（画像）</a>を参照してください。<br> このフィールドは、省略可能となります。<br> ※mainMediaFormatがIMAGEの場合にのみ指定できます。 </div> <div lang=\"en\"> AdGroupAdServiceAsset object describes the responsive display ad information.<br> More details are described on <a href=\"https://ads-help.yahoo-net.jp/s/article/H000044228?language=en_US\">Responsive（Image）</a>.<br> This field is optional.<br> *If mainMediaFormat is IMAGE, this field can be specified. </div> ")
@JsonPropertyOrder({
