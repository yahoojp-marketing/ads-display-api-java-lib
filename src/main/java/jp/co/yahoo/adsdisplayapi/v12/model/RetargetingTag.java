...
import jp.co.yahoo.adsdisplayapi.v12.model.RetargetingTagServiceApprovalStatus;
 ...
 */
@ApiModel(description = "<div lang=\"ja\">RetargetingTagオブジェクトは、サイトリターゲティングのタグ情報を表します。</div> <div lang=\"en\">RetargetingTag object displays tag information for site retargeting.</div> ")
@JsonPropertyOrder({
