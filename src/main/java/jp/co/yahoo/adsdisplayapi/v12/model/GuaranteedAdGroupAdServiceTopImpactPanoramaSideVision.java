 ...
 */
@ApiModel(description = "<div lang=\"ja\"> GuaranteedAdGroupAdServiceTopImpactPanoramaSideVisionオブジェクトは、トップインパクト パノラマ サイドビジョン広告の情報を表します。<br> このフィールドは、レスポンスの際に返却されますが、リクエストの際には無視されます。<br> </div> <div lang=\"en\"> GuaranteedAdGroupAdServiceTopImpactPanoramaSideVision object describes information of Top Impact Panorama Side Vision ad.<br> This field will be returned in the response, it will be ignored on input.<br> </div> ")
@JsonPropertyOrder({
...
@JsonTypeName("GuaranteedAdGroupAdServiceTopImpactPanoramaSideVision")
...
public class GuaranteedAdGroupAdServiceTopImpactPanoramaSideVision {
  ...
  public GuaranteedAdGroupAdServiceTopImpactPanoramaSideVision displayUrl(String displayUrl) {
  ...
  **/
  ...
  public GuaranteedAdGroupAdServiceTopImpactPanoramaSideVision thumbnailMediaId(Long thumbnailMediaId) {
  ...
  **/
  ...
  public GuaranteedAdGroupAdServiceTopImpactPanoramaSideVision customParameters(GuaranteedAdGroupAdServiceCustomParameters customParameters) {
  ...
  **/
  ...
  public GuaranteedAdGroupAdServiceTopImpactPanoramaSideVision displayUrlLevel(GuaranteedAdGroupAdServiceDisplayUrlLevel displayUrlLevel) {
  ...
  **/
  ...
  public GuaranteedAdGroupAdServiceTopImpactPanoramaSideVision finalUrl(String finalUrl) {
  ...
  **/
  ...
  public GuaranteedAdGroupAdServiceTopImpactPanoramaSideVision trackingUrl(String trackingUrl) {
  ...
  **/
  ...
  public GuaranteedAdGroupAdServiceTopImpactPanoramaSideVision video3SecBeaconUrls(List<String> video3SecBeaconUrls) {
  ...
  **/
  ...
  public GuaranteedAdGroupAdServiceTopImpactPanoramaSideVision video25PercentBeaconUrls(List<String> video25PercentBeaconUrls) {
  ...
  **/
  ...
  public GuaranteedAdGroupAdServiceTopImpactPanoramaSideVision video50PercentBeaconUrls(List<String> video50PercentBeaconUrls) {
  ...
  **/
  ...
  public GuaranteedAdGroupAdServiceTopImpactPanoramaSideVision video75PercentBeaconUrls(List<String> video75PercentBeaconUrls) {
  ...
  **/
  ...
  public GuaranteedAdGroupAdServiceTopImpactPanoramaSideVision video10SecBeaconUrls(List<String> video10SecBeaconUrls) {
  ...
  **/
  ...
  public GuaranteedAdGroupAdServiceTopImpactPanoramaSideVision videoCompleteBeaconUrls(List<String> videoCompleteBeaconUrls) {
  ...
  **/
  ...
  public GuaranteedAdGroupAdServiceTopImpactPanoramaSideVision videoStartBeaconUrls(List<String> videoStartBeaconUrls) {
  ...
  **/
  ...
  public GuaranteedAdGroupAdServiceTopImpactPanoramaSideVision adShrinkMainMediaId(Long adShrinkMainMediaId) {
