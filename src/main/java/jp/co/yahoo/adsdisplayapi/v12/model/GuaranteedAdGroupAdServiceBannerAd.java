 ...
 */
@ApiModel(description = "<div lang=\"ja\"> GuaranteedAdGroupAdServiceBannerAdオブジェクトは、バナー広告の情報を表します。<br> このフィールドは、レスポンスの際に返却されますが、リクエストの際には無視されます。<br> </div> <div lang=\"en\"> GuaranteedAdGroupAdServiceBannerAd object describes information of Banner ad.<br> This field will be returned in the response, it will be ignored on input.<br> </div> ")
@JsonPropertyOrder({
...
@JsonTypeName("GuaranteedAdGroupAdServiceBannerAd")
...
public class GuaranteedAdGroupAdServiceBannerAd {
  ...
  public GuaranteedAdGroupAdServiceBannerAd displayUrl(String displayUrl) {
  ...
  **/
  ...
  public GuaranteedAdGroupAdServiceBannerAd thumbnailMediaId(Long thumbnailMediaId) {
  ...
  **/
  ...
  public GuaranteedAdGroupAdServiceBannerAd customParameters(GuaranteedAdGroupAdServiceCustomParameters customParameters) {
  ...
  **/
  ...
  public GuaranteedAdGroupAdServiceBannerAd displayUrlLevel(GuaranteedAdGroupAdServiceDisplayUrlLevel displayUrlLevel) {
  ...
  **/
  ...
  public GuaranteedAdGroupAdServiceBannerAd finalUrl(String finalUrl) {
  ...
  **/
  ...
  public GuaranteedAdGroupAdServiceBannerAd smartphoneFinalUrl(String smartphoneFinalUrl) {
  ...
  **/
  ...
  public GuaranteedAdGroupAdServiceBannerAd trackingUrl(String trackingUrl) {
  ...
  **/
  ...
  public GuaranteedAdGroupAdServiceBannerAd video10SecBeaconUrls(List<String> video10SecBeaconUrls) {
  ...
  **/
  ...
  public GuaranteedAdGroupAdServiceBannerAd video25PercentBeaconUrls(List<String> video25PercentBeaconUrls) {
  ...
  **/
  ...
  public GuaranteedAdGroupAdServiceBannerAd video3SecBeaconUrls(List<String> video3SecBeaconUrls) {
  ...
  **/
  ...
  public GuaranteedAdGroupAdServiceBannerAd video50PercentBeaconUrls(List<String> video50PercentBeaconUrls) {
  ...
  **/
  ...
  public GuaranteedAdGroupAdServiceBannerAd video75PercentBeaconUrls(List<String> video75PercentBeaconUrls) {
  ...
  **/
  ...
  public GuaranteedAdGroupAdServiceBannerAd videoCompleteBeaconUrls(List<String> videoCompleteBeaconUrls) {
  ...
  **/
  ...
  public GuaranteedAdGroupAdServiceBannerAd videoStartBeaconUrls(List<String> videoStartBeaconUrls) {
