...
import jp.co.yahoo.adsdisplayapi.v5.model.VideoServiceUploadReturnValue;
...
public class VideoServiceUploadResponse   {
  ...
  @JsonProperty("rval")
  private JsonNullable<VideoServiceUploadReturnValue> rval = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<VideoServiceUploadReturnValue> getRval() {
    return rval;
  }

  public void setRval(JsonNullable<VideoServiceUploadReturnValue> rval) {
    this.rval = rval;
  }
