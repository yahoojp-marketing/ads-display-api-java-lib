...
@JsonPropertyOrder({
  ...
  Recommendation.JSON_PROPERTY_MIGRATE_TO_YDA,
...
public class Recommendation {
  ...
  public static final String JSON_PROPERTY_MIGRATE_TO_YDA = "migrateToYda";
  private RecommendationServiceMigrateToYda migrateToYda;
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")
  @JsonProperty(JSON_PROPERTY_MIGRATE_TO_YDA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
