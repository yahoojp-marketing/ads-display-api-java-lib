...
import jp.co.yahoo.adsdisplayapi.v5.model.DictionaryServiceMediaAdFormatPage;
...
public class DictionaryServiceGetMediaAdFormatResponse   {
  ...
  @JsonProperty("rval")
  private JsonNullable<DictionaryServiceMediaAdFormatPage> rval = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<DictionaryServiceMediaAdFormatPage> getRval() {
    return rval;
  }

  public void setRval(JsonNullable<DictionaryServiceMediaAdFormatPage> rval) {
    this.rval = rval;
  }
