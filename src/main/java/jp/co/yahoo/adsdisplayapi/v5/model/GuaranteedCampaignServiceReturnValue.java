...
public class GuaranteedCampaignServiceReturnValue   {
  @JsonProperty("values")
  @Valid
  private JsonNullable<List<GuaranteedCampaignServiceValue>> values = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<List<GuaranteedCampaignServiceValue>> getValues() {
    return values;
  }

  public void setValues(JsonNullable<List<GuaranteedCampaignServiceValue>> values) {
    this.values = values;
  }
