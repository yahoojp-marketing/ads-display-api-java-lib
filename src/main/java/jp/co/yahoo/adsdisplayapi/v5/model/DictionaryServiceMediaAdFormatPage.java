...
import jp.co.yahoo.adsdisplayapi.v5.model.DictionaryServiceMediaAdFormatValue;
...
public class DictionaryServiceMediaAdFormatPage   {
  ...
  @JsonProperty("values")
  @Valid
  private JsonNullable<List<DictionaryServiceMediaAdFormatValue>> values = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<List<DictionaryServiceMediaAdFormatValue>> getValues() {
    return values;
  }

  public void setValues(JsonNullable<List<DictionaryServiceMediaAdFormatValue>> values) {
    this.values = values;
  }
