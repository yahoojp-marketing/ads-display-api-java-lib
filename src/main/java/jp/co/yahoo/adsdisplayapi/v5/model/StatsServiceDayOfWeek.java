 ...
 */
public enum StatsServiceDayOfWeek {
  ...
  StatsServiceDayOfWeek(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static StatsServiceDayOfWeek fromValue(String value) {
    for (StatsServiceDayOfWeek b : StatsServiceDayOfWeek.values()) {
