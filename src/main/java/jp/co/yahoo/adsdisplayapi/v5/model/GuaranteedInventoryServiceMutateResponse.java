...
public class GuaranteedInventoryServiceMutateResponse   {
  ...
  @JsonProperty("rval")
  private JsonNullable<GuaranteedInventoryServiceReturnValue> rval = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<GuaranteedInventoryServiceReturnValue> getRval() {
    return rval;
  }

  public void setRval(JsonNullable<GuaranteedInventoryServiceReturnValue> rval) {
    this.rval = rval;
  }
