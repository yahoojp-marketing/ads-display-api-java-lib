...
public class GuaranteedSimulationServiceSingleTermBuyingTerm   {
  ...
  private JsonNullable<String> buyingSingleTermStartDate = JsonNullable.undefined();

  @JsonProperty("buyingSingleTermEndDate")
  private JsonNullable<String> buyingSingleTermEndDate = JsonNullable.undefined();

  public GuaranteedSimulationServiceSingleTermBuyingTerm buyingSingleTermStartDate(String buyingSingleTermStartDate) {
    this.buyingSingleTermStartDate = JsonNullable.of(buyingSingleTermStartDate);
    return this;
  }
  ...
  */
  ...
  public JsonNullable<String> getBuyingSingleTermStartDate() {
    return buyingSingleTermStartDate;
  }

  public void setBuyingSingleTermStartDate(JsonNullable<String> buyingSingleTermStartDate) {
  ...
  public GuaranteedSimulationServiceSingleTermBuyingTerm buyingSingleTermEndDate(String buyingSingleTermEndDate) {
    this.buyingSingleTermEndDate = JsonNullable.of(buyingSingleTermEndDate);
    return this;
  }
  ...
  */
  ...
  public JsonNullable<String> getBuyingSingleTermEndDate() {
    return buyingSingleTermEndDate;
  }

  public void setBuyingSingleTermEndDate(JsonNullable<String> buyingSingleTermEndDate) {
