...
import jp.co.yahoo.adsdisplayapi.v5.model.DictionaryServiceThirdPartyTrackingDomainPage;
...
public class DictionaryServiceGetThirdPartyTrackingDomainResponse   {
  ...
  @JsonProperty("rval")
  private JsonNullable<DictionaryServiceThirdPartyTrackingDomainPage> rval = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<DictionaryServiceThirdPartyTrackingDomainPage> getRval() {
    return rval;
  }

  public void setRval(JsonNullable<DictionaryServiceThirdPartyTrackingDomainPage> rval) {
    this.rval = rval;
  }
