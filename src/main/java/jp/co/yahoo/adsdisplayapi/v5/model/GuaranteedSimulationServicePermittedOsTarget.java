...
import jp.co.yahoo.adsdisplayapi.v5.model.GuaranteedSimulationServiceDeviceOsType;
...
public class GuaranteedSimulationServicePermittedOsTarget   {
  ...
  @JsonProperty("osType")
  private JsonNullable<GuaranteedSimulationServiceDeviceOsType> osType = JsonNullable.undefined();
  ...
  */
  ...
  public GuaranteedSimulationServicePermittedOsTarget osType(GuaranteedSimulationServiceDeviceOsType osType) {
    this.osType = JsonNullable.of(osType);
    return this;
  }
  ...
  */
  ...
  public JsonNullable<GuaranteedSimulationServiceDeviceOsType> getOsType() {
    return osType;
  }

  public void setOsType(JsonNullable<GuaranteedSimulationServiceDeviceOsType> osType) {
    this.osType = osType;
  }
