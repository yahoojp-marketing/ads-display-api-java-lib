...
@JsonPropertyOrder({
  ...
  ReportDefinitionServiceReportTypeCondition.JSON_PROPERTY_FREQUENCY_REPORT_CONDITION,
...
public class ReportDefinitionServiceReportTypeCondition {
  ...
  public static final String JSON_PROPERTY_FREQUENCY_REPORT_CONDITION = "frequencyReportCondition";
  private ReportDefinitionServiceFrequencyReportCondition frequencyReportCondition;
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")
  @JsonProperty(JSON_PROPERTY_FREQUENCY_REPORT_CONDITION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
