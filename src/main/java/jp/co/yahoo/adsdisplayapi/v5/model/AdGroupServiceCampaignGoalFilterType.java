 ...
 */
public enum AdGroupServiceCampaignGoalFilterType {
  ...
  AdGroupServiceCampaignGoalFilterType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static AdGroupServiceCampaignGoalFilterType fromValue(String value) {
    for (AdGroupServiceCampaignGoalFilterType b : AdGroupServiceCampaignGoalFilterType.values()) {
