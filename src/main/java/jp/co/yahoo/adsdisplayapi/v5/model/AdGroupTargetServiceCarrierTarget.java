...
public class AdGroupTargetServiceCarrierTarget   {
  ...
  private JsonNullable<AdGroupTargetServiceCarrierType> carrierType = JsonNullable.undefined();

  public AdGroupTargetServiceCarrierTarget carrierType(AdGroupTargetServiceCarrierType carrierType) {
    this.carrierType = JsonNullable.of(carrierType);
    return this;
  }
  ...
  */
  ...
  public JsonNullable<AdGroupTargetServiceCarrierType> getCarrierType() {
    return carrierType;
  }

  public void setCarrierType(JsonNullable<AdGroupTargetServiceCarrierType> carrierType) {
