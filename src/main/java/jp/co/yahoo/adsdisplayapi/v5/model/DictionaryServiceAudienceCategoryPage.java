...
public class DictionaryServiceAudienceCategoryPage   {
  ...
  @JsonProperty("values")
  @Valid
  private JsonNullable<List<DictionaryServiceAudienceCategoryValue>> values = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<List<DictionaryServiceAudienceCategoryValue>> getValues() {
    return values;
  }

  public void setValues(JsonNullable<List<DictionaryServiceAudienceCategoryValue>> values) {
    this.values = values;
  }
