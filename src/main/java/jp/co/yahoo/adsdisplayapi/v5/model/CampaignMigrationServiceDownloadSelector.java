...
@JsonPropertyOrder({
  CampaignMigrationServiceDownloadSelector.JSON_PROPERTY_ACCOUNT_ID,
  CampaignMigrationServiceDownloadSelector.JSON_PROPERTY_LANG
})
@JsonTypeName("CampaignMigrationServiceDownloadSelector")
...
public class CampaignMigrationServiceDownloadSelector {
  ...
  private CampaignMigrationServiceLang lang;

  public CampaignMigrationServiceDownloadSelector() { 
  }
