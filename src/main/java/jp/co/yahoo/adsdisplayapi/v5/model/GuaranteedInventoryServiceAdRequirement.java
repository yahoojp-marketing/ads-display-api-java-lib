...
public class GuaranteedInventoryServiceAdRequirement   {
  @JsonProperty("adType")
  private JsonNullable<GuaranteedInventoryServiceAdType> adType = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<GuaranteedInventoryServiceAdType> getAdType() {
    return adType;
  }

  public void setAdType(JsonNullable<GuaranteedInventoryServiceAdType> adType) {
    this.adType = adType;
  }
