...
public class FeedSetServiceGetResponse   {
  ...
  @JsonProperty("rval")
  private JsonNullable<FeedSetServicePage> rval = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<FeedSetServicePage> getRval() {
    return rval;
  }

  public void setRval(JsonNullable<FeedSetServicePage> rval) {
    this.rval = rval;
  }
