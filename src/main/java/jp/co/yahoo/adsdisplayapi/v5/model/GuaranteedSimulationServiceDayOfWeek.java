 ...
 */
public enum GuaranteedSimulationServiceDayOfWeek {
  ...
  GuaranteedSimulationServiceDayOfWeek(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static GuaranteedSimulationServiceDayOfWeek fromValue(String value) {
    for (GuaranteedSimulationServiceDayOfWeek b : GuaranteedSimulationServiceDayOfWeek.values()) {
