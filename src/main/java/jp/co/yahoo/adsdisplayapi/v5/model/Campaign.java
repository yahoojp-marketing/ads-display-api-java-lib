...
@JsonPropertyOrder({
  ...
  Campaign.JSON_PROPERTY_AD_PRODUCT_TYPE,
  Campaign.JSON_PROPERTY_APP_ID,
  Campaign.JSON_PROPERTY_APP_NAME,
  Campaign.JSON_PROPERTY_BIDDING_STRATEGY,
  ...
  Campaign.JSON_PROPERTY_FREQUENCY_CAP,
...
public class Campaign {
  ...
  public static final String JSON_PROPERTY_AD_PRODUCT_TYPE = "adProductType";
  ...
  private CampaignServiceBiddingStrategy biddingStrategy;
  ...
  private CampaignServiceFrequencyCap frequencyCap;
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_AD_PRODUCT_TYPE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
