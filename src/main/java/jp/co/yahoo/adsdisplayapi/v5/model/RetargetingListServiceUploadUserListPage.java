...
@JsonPropertyOrder({
  RetargetingListServiceUploadUserListPage.JSON_PROPERTY_TOTAL_NUM_ENTRIES,
  RetargetingListServiceUploadUserListPage.JSON_PROPERTY_VALUES
})
@JsonTypeName("RetargetingListServiceUploadUserListPage")
...
public class RetargetingListServiceUploadUserListPage {
  ...
  public RetargetingListServiceUploadUserListPage() { 
  }
