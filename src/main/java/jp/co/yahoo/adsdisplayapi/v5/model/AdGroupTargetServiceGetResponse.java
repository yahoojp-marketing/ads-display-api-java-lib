...
import jp.co.yahoo.adsdisplayapi.v5.model.AdGroupTargetServicePage;
...
public class AdGroupTargetServiceGetResponse   {
  ...
  @JsonProperty("rval")
  private JsonNullable<AdGroupTargetServicePage> rval = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<AdGroupTargetServicePage> getRval() {
    return rval;
  }

  public void setRval(JsonNullable<AdGroupTargetServicePage> rval) {
    this.rval = rval;
  }
