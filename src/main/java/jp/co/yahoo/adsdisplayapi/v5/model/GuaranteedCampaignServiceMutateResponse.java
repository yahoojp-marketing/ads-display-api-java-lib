...
import jp.co.yahoo.adsdisplayapi.v5.model.GuaranteedCampaignServiceReturnValue;
...
public class GuaranteedCampaignServiceMutateResponse   {
  ...
  @JsonProperty("rval")
  private JsonNullable<GuaranteedCampaignServiceReturnValue> rval = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<GuaranteedCampaignServiceReturnValue> getRval() {
    return rval;
  }

  public void setRval(JsonNullable<GuaranteedCampaignServiceReturnValue> rval) {
    this.rval = rval;
  }
