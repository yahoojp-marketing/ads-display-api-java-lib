...
public class RecommendationServiceCampaignBiddingStrategyToTargetCpaCampaign   {
  ...
  private JsonNullable<String> currentCampaignBiddingStrategyType = JsonNullable.undefined();

  @JsonProperty("currentMaxCpcBidValue")
  private JsonNullable<Long> currentMaxCpcBidValue = JsonNullable.undefined();

  @JsonProperty("recommendedCampaignBiddingStrategyType")
  private JsonNullable<String> recommendedCampaignBiddingStrategyType = JsonNullable.undefined();

  @JsonProperty("recommendedTargetCpaBidValue")
  private JsonNullable<Long> recommendedTargetCpaBidValue = JsonNullable.undefined();
  ...
  */
  ...
  public RecommendationServiceCampaignBiddingStrategyToTargetCpaCampaign currentCampaignBiddingStrategyType(String currentCampaignBiddingStrategyType) {
    this.currentCampaignBiddingStrategyType = JsonNullable.of(currentCampaignBiddingStrategyType);
    return this;
  }
  ...
  */
  ...
  public JsonNullable<String> getCurrentCampaignBiddingStrategyType() {
    return currentCampaignBiddingStrategyType;
  }

  public void setCurrentCampaignBiddingStrategyType(JsonNullable<String> currentCampaignBiddingStrategyType) {
  ...
  public RecommendationServiceCampaignBiddingStrategyToTargetCpaCampaign currentMaxCpcBidValue(Long currentMaxCpcBidValue) {
    this.currentMaxCpcBidValue = JsonNullable.of(currentMaxCpcBidValue);
    return this;
  }
  ...
  */
  ...
  public JsonNullable<Long> getCurrentMaxCpcBidValue() {
    return currentMaxCpcBidValue;
  }

  public void setCurrentMaxCpcBidValue(JsonNullable<Long> currentMaxCpcBidValue) {
  ...
  public RecommendationServiceCampaignBiddingStrategyToTargetCpaCampaign recommendedCampaignBiddingStrategyType(String recommendedCampaignBiddingStrategyType) {
    this.recommendedCampaignBiddingStrategyType = JsonNullable.of(recommendedCampaignBiddingStrategyType);
    return this;
  }
  ...
  */
  ...
  public JsonNullable<String> getRecommendedCampaignBiddingStrategyType() {
    return recommendedCampaignBiddingStrategyType;
  }

  public void setRecommendedCampaignBiddingStrategyType(JsonNullable<String> recommendedCampaignBiddingStrategyType) {
  ...
  public RecommendationServiceCampaignBiddingStrategyToTargetCpaCampaign recommendedTargetCpaBidValue(Long recommendedTargetCpaBidValue) {
    this.recommendedTargetCpaBidValue = JsonNullable.of(recommendedTargetCpaBidValue);
    return this;
  }
  ...
  */
  ...
  public JsonNullable<Long> getRecommendedTargetCpaBidValue() {
    return recommendedTargetCpaBidValue;
  }

  public void setRecommendedTargetCpaBidValue(JsonNullable<Long> recommendedTargetCpaBidValue) {
