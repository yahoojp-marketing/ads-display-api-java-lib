...
@JsonPropertyOrder({
  ...
  RecommendationServiceCampaignBiddingStrategyToTargetCpaCampaign.JSON_PROPERTY_CURRENT_MAX_CPC_BID_VALUE,
...
public class RecommendationServiceCampaignBiddingStrategyToTargetCpaCampaign {
  ...
  public static final String JSON_PROPERTY_CURRENT_MAX_CPC_BID_VALUE = "currentMaxCpcBidValue";
  private Long currentMaxCpcBidValue;
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_CURRENT_MAX_CPC_BID_VALUE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
