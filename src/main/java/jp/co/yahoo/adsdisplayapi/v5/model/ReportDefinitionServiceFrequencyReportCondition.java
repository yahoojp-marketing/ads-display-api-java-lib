...
@JsonPropertyOrder({
  ReportDefinitionServiceFrequencyReportCondition.JSON_PROPERTY_FREQUENCY_RANGE
})
@JsonTypeName("ReportDefinitionServiceFrequencyReportCondition")
...
public class ReportDefinitionServiceFrequencyReportCondition {
  ...
  public ReportDefinitionServiceFrequencyReportCondition() { 
  }
