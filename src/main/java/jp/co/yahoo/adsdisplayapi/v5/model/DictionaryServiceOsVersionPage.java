...
import jp.co.yahoo.adsdisplayapi.v5.model.DictionaryServiceOsVersionValue;
...
public class DictionaryServiceOsVersionPage   {
  ...
  @JsonProperty("values")
  @Valid
  private JsonNullable<List<DictionaryServiceOsVersionValue>> values = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<List<DictionaryServiceOsVersionValue>> getValues() {
    return values;
  }

  public void setValues(JsonNullable<List<DictionaryServiceOsVersionValue>> values) {
    this.values = values;
  }
