...
import jp.co.yahoo.adsdisplayapi.v5.model.FeedFtpServicePage;
...
public class FeedFtpServiceGetResponse   {
  ...
  @JsonProperty("rval")
  private JsonNullable<FeedFtpServicePage> rval = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<FeedFtpServicePage> getRval() {
    return rval;
  }

  public void setRval(JsonNullable<FeedFtpServicePage> rval) {
    this.rval = rval;
  }
