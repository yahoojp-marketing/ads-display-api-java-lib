...
import jp.co.yahoo.adsdisplayapi.v5.model.GuaranteedPreviewServicePage;
...
public class GuaranteedPreviewServiceGetResponse   {
  ...
  @JsonProperty("rval")
  private JsonNullable<GuaranteedPreviewServicePage> rval = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<GuaranteedPreviewServicePage> getRval() {
    return rval;
  }

  public void setRval(JsonNullable<GuaranteedPreviewServicePage> rval) {
    this.rval = rval;
  }
