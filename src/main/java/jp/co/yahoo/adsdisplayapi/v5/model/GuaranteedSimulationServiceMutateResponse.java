...
import jp.co.yahoo.adsdisplayapi.v5.model.GuaranteedSimulationServiceReturnValue;
...
public class GuaranteedSimulationServiceMutateResponse   {
  ...
  @JsonProperty("rval")
  private JsonNullable<GuaranteedSimulationServiceReturnValue> rval = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<GuaranteedSimulationServiceReturnValue> getRval() {
    return rval;
  }

  public void setRval(JsonNullable<GuaranteedSimulationServiceReturnValue> rval) {
    this.rval = rval;
  }
