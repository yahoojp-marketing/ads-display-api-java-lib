...
import jp.co.yahoo.adsdisplayapi.v5.model.DictionaryServicePlacementCategoryPage;
...
public class DictionaryServiceGetPlacementCategoryResponse   {
  ...
  @JsonProperty("rval")
  private JsonNullable<DictionaryServicePlacementCategoryPage> rval = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<DictionaryServicePlacementCategoryPage> getRval() {
    return rval;
  }

  public void setRval(JsonNullable<DictionaryServicePlacementCategoryPage> rval) {
    this.rval = rval;
  }
