 ...
 */
public enum GuaranteedAdGroupAdServiceUserStatus {
  ...
  GuaranteedAdGroupAdServiceUserStatus(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static GuaranteedAdGroupAdServiceUserStatus fromValue(String value) {
    for (GuaranteedAdGroupAdServiceUserStatus b : GuaranteedAdGroupAdServiceUserStatus.values()) {
