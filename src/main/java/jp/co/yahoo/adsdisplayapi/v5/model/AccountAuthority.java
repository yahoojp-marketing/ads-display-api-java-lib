...
public class AccountAuthority   {
  ...
  @Valid
  private JsonNullable<List<String>> authorities = JsonNullable.undefined();
  ...
  */
  ...
  public AccountAuthority authorities(List<String> authorities) {
    this.authorities = JsonNullable.of(authorities);
    return this;
  }

  public AccountAuthority addAuthoritiesItem(String authoritiesItem) {
    if (this.authorities == null || !this.authorities.isPresent()) {
      this.authorities = JsonNullable.of(new ArrayList<>());
    }
    this.authorities.get().add(authoritiesItem);
    return this;
  }
  ...
  */
  ...
  public JsonNullable<List<String>> getAuthorities() {
    return authorities;
  }

  public void setAuthorities(JsonNullable<List<String>> authorities) {
