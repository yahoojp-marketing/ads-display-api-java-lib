...
public class StatsServiceCarrierTarget   {
  ...
  private JsonNullable<StatsServiceCarrierType> carrierType = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<StatsServiceCarrierType> getCarrierType() {
    return carrierType;
  }

  public void setCarrierType(JsonNullable<StatsServiceCarrierType> carrierType) {
