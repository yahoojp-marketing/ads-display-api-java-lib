 ...
 */
@JsonPropertyOrder({
  CampaignMigrationServiceUploadReturnValue.JSON_PROPERTY_VALUES
})
@JsonTypeName("CampaignMigrationServiceUploadReturnValue")
...
public class CampaignMigrationServiceUploadReturnValue {
  ...
  public CampaignMigrationServiceUploadReturnValue() { 
  }
