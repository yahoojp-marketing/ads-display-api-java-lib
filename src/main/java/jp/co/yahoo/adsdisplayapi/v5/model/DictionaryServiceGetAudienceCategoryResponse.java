...
import jp.co.yahoo.adsdisplayapi.v5.model.DictionaryServiceAudienceCategoryPage;
...
public class DictionaryServiceGetAudienceCategoryResponse   {
  ...
  @JsonProperty("rval")
  private JsonNullable<DictionaryServiceAudienceCategoryPage> rval = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<DictionaryServiceAudienceCategoryPage> getRval() {
    return rval;
  }

  public void setRval(JsonNullable<DictionaryServiceAudienceCategoryPage> rval) {
    this.rval = rval;
  }
