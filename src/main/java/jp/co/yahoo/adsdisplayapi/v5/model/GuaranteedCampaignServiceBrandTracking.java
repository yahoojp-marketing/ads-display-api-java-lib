...
public class GuaranteedCampaignServiceBrandTracking   {
  ...
  @Valid
  private JsonNullable<List<String>> audienceCategoryIds1 = JsonNullable.undefined();

  @JsonProperty("audienceCategoryIds2")
  @Valid
  private JsonNullable<List<String>> audienceCategoryIds2 = JsonNullable.undefined();

  @JsonProperty("businessCategoryIds")
  @Valid
  private JsonNullable<List<String>> businessCategoryIds = JsonNullable.undefined();

  public GuaranteedCampaignServiceBrandTracking audienceCategoryIds1(List<String> audienceCategoryIds1) {
    this.audienceCategoryIds1 = JsonNullable.of(audienceCategoryIds1);
    return this;
  }

  public GuaranteedCampaignServiceBrandTracking addAudienceCategoryIds1Item(String audienceCategoryIds1Item) {
    if (this.audienceCategoryIds1 == null || !this.audienceCategoryIds1.isPresent()) {
      this.audienceCategoryIds1 = JsonNullable.of(new ArrayList<>());
    }
    this.audienceCategoryIds1.get().add(audienceCategoryIds1Item);
    return this;
  }
...
@Size(max=100) 
  public JsonNullable<List<String>> getAudienceCategoryIds1() {
    return audienceCategoryIds1;
  }

  public void setAudienceCategoryIds1(JsonNullable<List<String>> audienceCategoryIds1) {
  ...
  public GuaranteedCampaignServiceBrandTracking audienceCategoryIds2(List<String> audienceCategoryIds2) {
    this.audienceCategoryIds2 = JsonNullable.of(audienceCategoryIds2);
    return this;
  }

  public GuaranteedCampaignServiceBrandTracking addAudienceCategoryIds2Item(String audienceCategoryIds2Item) {
    if (this.audienceCategoryIds2 == null || !this.audienceCategoryIds2.isPresent()) {
      this.audienceCategoryIds2 = JsonNullable.of(new ArrayList<>());
    }
    this.audienceCategoryIds2.get().add(audienceCategoryIds2Item);
    return this;
  }
...
@Size(max=100) 
  public JsonNullable<List<String>> getAudienceCategoryIds2() {
    return audienceCategoryIds2;
  }

  public void setAudienceCategoryIds2(JsonNullable<List<String>> audienceCategoryIds2) {
  ...
  public GuaranteedCampaignServiceBrandTracking businessCategoryIds(List<String> businessCategoryIds) {
    this.businessCategoryIds = JsonNullable.of(businessCategoryIds);
    return this;
  }

  public GuaranteedCampaignServiceBrandTracking addBusinessCategoryIdsItem(String businessCategoryIdsItem) {
    if (this.businessCategoryIds == null || !this.businessCategoryIds.isPresent()) {
      this.businessCategoryIds = JsonNullable.of(new ArrayList<>());
    }
    this.businessCategoryIds.get().add(businessCategoryIdsItem);
    return this;
  }
  ...
  */
  ...
  public JsonNullable<List<String>> getBusinessCategoryIds() {
    return businessCategoryIds;
  }

  public void setBusinessCategoryIds(JsonNullable<List<String>> businessCategoryIds) {
