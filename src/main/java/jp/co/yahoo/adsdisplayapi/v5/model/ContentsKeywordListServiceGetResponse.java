...
import jp.co.yahoo.adsdisplayapi.v5.model.ContentsKeywordListServicePage;
...
public class ContentsKeywordListServiceGetResponse   {
  ...
  @JsonProperty("rval")
  private JsonNullable<ContentsKeywordListServicePage> rval = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<ContentsKeywordListServicePage> getRval() {
    return rval;
  }

  public void setRval(JsonNullable<ContentsKeywordListServicePage> rval) {
    this.rval = rval;
  }
