...
@JsonPropertyOrder({
  AccountAdProductServicePage.JSON_PROPERTY_TOTAL_NUM_ENTRIES,
  AccountAdProductServicePage.JSON_PROPERTY_VALUES
})
@JsonTypeName("AccountAdProductServicePage")
...
public class AccountAdProductServicePage {
  ...
  public AccountAdProductServicePage() { 
  }
