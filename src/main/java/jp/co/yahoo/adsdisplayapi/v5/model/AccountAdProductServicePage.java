...
public class AccountAdProductServicePage   {
  ...
  @JsonProperty("values")
  @Valid
  private JsonNullable<List<AccountAdProductServiceValue>> values = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<List<AccountAdProductServiceValue>> getValues() {
    return values;
  }

  public void setValues(JsonNullable<List<AccountAdProductServiceValue>> values) {
    this.values = values;
  }
