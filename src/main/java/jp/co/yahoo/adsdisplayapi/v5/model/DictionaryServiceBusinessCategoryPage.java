...
public class DictionaryServiceBusinessCategoryPage   {
  ...
  @JsonProperty("values")
  @Valid
  private JsonNullable<List<DictionaryServiceBusinessCategoryValue>> values = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<List<DictionaryServiceBusinessCategoryValue>> getValues() {
    return values;
  }

  public void setValues(JsonNullable<List<DictionaryServiceBusinessCategoryValue>> values) {
    this.values = values;
  }
