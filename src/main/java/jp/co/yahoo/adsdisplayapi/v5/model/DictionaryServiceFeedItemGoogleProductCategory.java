...
public class DictionaryServiceFeedItemGoogleProductCategory   {
  @JsonProperty("child")
  @Valid
  private JsonNullable<List<DictionaryServiceFeedItemGoogleProductCategory>> child = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<List<DictionaryServiceFeedItemGoogleProductCategory>> getChild() {
    return child;
  }

  public void setChild(JsonNullable<List<DictionaryServiceFeedItemGoogleProductCategory>> child) {
    this.child = child;
  }
