...
public class GuaranteedInventoryServiceDeviceTarget   {
  ...
  private JsonNullable<GuaranteedInventoryServiceDeviceType> deviceType = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<GuaranteedInventoryServiceDeviceType> getDeviceType() {
    return deviceType;
  }

  public void setDeviceType(JsonNullable<GuaranteedInventoryServiceDeviceType> deviceType) {
