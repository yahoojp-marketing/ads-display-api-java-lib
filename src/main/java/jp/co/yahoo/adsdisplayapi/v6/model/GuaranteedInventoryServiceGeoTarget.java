...
@JsonPropertyOrder({
  GuaranteedInventoryServiceGeoTarget.JSON_PROPERTY_GEO_NAME_EN,
  GuaranteedInventoryServiceGeoTarget.JSON_PROPERTY_GEO_NAME_JA
})
@JsonTypeName("GuaranteedInventoryServiceGeoTarget")
...
public class GuaranteedInventoryServiceGeoTarget {
  ...
  public GuaranteedInventoryServiceGeoTarget() { 
  }
