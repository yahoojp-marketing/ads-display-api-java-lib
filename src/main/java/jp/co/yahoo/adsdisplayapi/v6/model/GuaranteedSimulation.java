...
@JsonPropertyOrder({
  ...
  GuaranteedSimulation.JSON_PROPERTY_AD_PLACE_TYPE,
...
public class GuaranteedSimulation {
  ...
  public static final String JSON_PROPERTY_AD_PLACE_TYPE = "adPlaceType";
  private GuaranteedSimulationServiceAdPlaceType adPlaceType;
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")
  @JsonProperty(JSON_PROPERTY_AD_PLACE_TYPE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
