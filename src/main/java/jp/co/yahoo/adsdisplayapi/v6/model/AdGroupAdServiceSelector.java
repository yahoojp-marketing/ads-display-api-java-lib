...
import jp.co.yahoo.adsdisplayapi.v6.model.AdGroupAdServiceCreatedDateRange;
...
@Size(max=2) 
  ...
  */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, adGroupIds, adIds, approvalStatuses, campaignIds, containsLabelIdFlg, labelIds, mediaIds, numberResults, startIndex, userStatuses, createdDateRange);
  }
