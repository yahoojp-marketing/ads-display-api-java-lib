...
import jp.co.yahoo.adsdisplayapi.v6.model.SearchKeywordIdeaServicePage;
...
public class SearchKeywordIdeaServiceGetResponse   {
  ...
  @JsonProperty("rval")
  private SearchKeywordIdeaServicePage rval = null;
  ...
  */
  ...
  public SearchKeywordIdeaServicePage getRval() {
    return rval;
  }

  public void setRval(SearchKeywordIdeaServicePage rval) {
    this.rval = rval;
  }
