...
import jp.co.yahoo.adsdisplayapi.v6.model.GuaranteedSimulationServicePage;
...
public class GuaranteedSimulationServiceGetResponse   {
  ...
  @JsonProperty("rval")
  private GuaranteedSimulationServicePage rval = null;
  ...
  */
  ...
  public GuaranteedSimulationServicePage getRval() {
    return rval;
  }

  public void setRval(GuaranteedSimulationServicePage rval) {
    this.rval = rval;
  }
