...
@JsonPropertyOrder({
  ...
  RetargetingListServiceValue.JSON_PROPERTY_RETARGETING_LIST
})
...
public class RetargetingListServiceValue {
  ...
  public static final String JSON_PROPERTY_RETARGETING_LIST = "retargetingList";
  private RetargetingList retargetingList;
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")
  @JsonProperty(JSON_PROPERTY_RETARGETING_LIST)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
