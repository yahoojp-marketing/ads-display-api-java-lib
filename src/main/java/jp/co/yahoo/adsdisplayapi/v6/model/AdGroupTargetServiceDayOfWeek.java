 ...
 */
public enum AdGroupTargetServiceDayOfWeek {
  ...
  AdGroupTargetServiceDayOfWeek(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static AdGroupTargetServiceDayOfWeek fromValue(String value) {
    for (AdGroupTargetServiceDayOfWeek b : AdGroupTargetServiceDayOfWeek.values()) {
