...
import jp.co.yahoo.adsdisplayapi.v13.model.RecommendationServiceDuplicateTargetingSettingsAdGroup;
 ...
 */
@ApiModel(description = "<div lang=\"ja\">RecommendationServiceDuplicateTargetingSettingsオブジェクトは、ターゲティング設定が重複している広告グループに関する最適化提案の情報を表します。</div> <div lang=\"en\">RecommendationServiceDuplicateTargetingSettings object describes recommendation information about the ad group with duplicate targeting settings.</div> ")
@JsonPropertyOrder({
