 ...
 */
@ApiModel(description = "<div lang=\"ja\"> MediaServiceCreatedDateRangeは、作成日による検索対象期間を表します。 </div> <div lang=\"en\"> MediaServiceCreatedDateRange represents the search target period by the creation date. </div> ")
@JsonPropertyOrder({
