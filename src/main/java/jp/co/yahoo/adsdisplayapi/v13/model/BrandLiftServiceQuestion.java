...
import jp.co.yahoo.adsdisplayapi.v13.model.BrandLiftServiceGoal;
 ...
 */
@ApiModel(description = "<div lang=\"ja\">BrandLiftServiceQuestionオブジェクトは、ブランドリフト調査項目を表します。</div> <div lang=\"en\">BrandLiftServiceQuestion object describes the brand lift survey contents.</div> ")
@JsonPropertyOrder({
