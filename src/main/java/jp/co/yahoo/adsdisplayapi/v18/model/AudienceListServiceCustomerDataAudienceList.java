...
public class AudienceListServiceCustomerDataAudienceList {
  ...
  public AudienceListServiceCustomerDataAudienceList dataDuration(Integer dataDuration) {
   ...
   /**
   * &lt;div lang&#x3D;\&quot;ja\&quot;&gt; 行動履歴の保持期間です（1日～60日）。&lt;br&gt; このフィールドは、ADD時に必須となります。 &lt;/div&gt; &lt;div lang&#x3D;\&quot;en\&quot;&gt; Data duration for the connected user data, in days (1–60). &lt;br&gt; This field is required in ADD operation. &lt;/div&gt; 
   * @return dataDuration
  **/
